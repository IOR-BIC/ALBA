...
// .NAME albaICPUtility - Implementation of the ICP algorithm utility.
// .SECTION Description

#ifndef __albaICPUtility_h
#define __albaICPUtility_h
...
*/
class ALBA_EXPORT albaICPUtility : public vtkObject
{
public:
...
protected:
  albaICPUtility():KnownMinLocalFlag(false),RotationFixedFlag(false){};
  ~albaICPUtility() {};
};
...
//----------------------------------------------------------------------------
inline void albaICPUtility::Vtk2Vnl(vtkPolyData* Shape, double* MatrixData)
//----------------------------------------------------------------------------
{
	double coord[3];
...
//----------------------------------------------------------------------------
inline albaICPUtility::RegResult albaICPUtility::SVD_Registration(vnl_matrix<double>& MS, vnl_matrix<double>& DS)
//----------------------------------------------------------------------------
{
	////vcl_cout << DS << '\n';
	...
	albaICPUtility::RegResult registrazione_S_V_D;
...
//----------------------------------------------------------------------------
inline void albaICPUtility::Vnl2PolyDataFilter(vnl_matrix<double> M, vtkPolyData* Shape)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline void albaICPUtility::Rows_randperm(vnl_matrix<double>& M)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline vnl_matrix_fixed<double,3,3> albaICPUtility::Theta2R(const vnl_vector_fixed<double,3>& th)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline vnl_matrix_fixed<double,4,4> albaICPUtility::R_t_2_Tr(const vnl_matrix_fixed<double,3,3>& R,const vnl_vector_fixed<double,3>& t)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline void albaICPUtility::FindPointLocator(vtkPoints *MS_vtkpoints, vtkPointLocator *pointLocator, double* DS_data, int DScols, vnl_matrix<double> &closest_pts)
//----------------------------------------------------------------------------
{
	//NB: DS è una 3 x n
	vtkIdType ptId;
...
//----------------------------------------------------------------------------
inline albaICPUtility::RegResult albaICPUtility::ICP_vtkPointLocator(vnl_matrix<double>& MS, vnl_matrix<double> & DS, int cycle_lim)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline vnl_matrix_fixed<double,3,3> albaICPUtility::Rpy2R(const vnl_vector_fixed<double,3> v)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline vnl_matrix_fixed<double,3,3> albaICPUtility::Rpy2R(const double* row)
//----------------------------------------------------------------------------
{
	double pi=3.14159265358979323846;
...
//----------------------------------------------------------------------------
inline vnl_matrix<double> albaICPUtility::RpyOnShape(const vnl_matrix<double>& Shape, const double* row)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline albaICPUtility::RegResult albaICPUtility::ICP_vtkPointLocator(vnl_matrix<double>& MS, vnl_matrix<double> & DS, vcl_ifstream& ml_read_file, float var_threshold, int cycle_lim)
//----------------------------------------------------------------------------
{
	//-----------Contruzione Point Locator----------------------
	vtkPoints *MS_vtkpoints = vtkPoints::New();
	...
	if(Min.cols() != 3 && Min.rows() < 1) 
	{
		...
		MS_poly->Delete();
		p_locator->Delete();
		albaICPUtility::RegResult dummy_result;
...
//----------------------------------------------------------------------------
inline vnl_vector_fixed<double,3> albaICPUtility::Centroid(const vnl_matrix<double> & S)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline vnl_vector<double> albaICPUtility::Center(const vnl_matrix<double>& S)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline void albaICPUtility::Neg_translation(vnl_matrix<double>& S, const vnl_vector<double> c)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline void albaICPUtility::Pos_translation(vnl_matrix<double>& S, const vnl_vector<double> c)
//----------------------------------------------------------------------------
{
	vnl_matrix<double> aux(S.rows(),S.columns());
	for(int i=0; i<aux.rows(); i++){
...
//----------------------------------------------------------------------------
inline void albaICPUtility::Rotation_classif(vcl_multimap<double,int>& mm,const vnl_matrix<double>& DS, vnl_matrix<double>& MS)
//----------------------------------------------------------------------------
{
	//-----------Contruzione Point Locator----------------------
		vtkPoints *MS_vtkpoints = vtkPoints::New();
...
//----------------------------------------------------------------------------
inline albaICPUtility::RegResult albaICPUtility::ICP_vtkPointLocator(vnl_matrix<double>& MS, vnl_matrix<double> & DS, vcl_multimap<double,int>& mm, const char* ml_filepath, float var_threshold, int cycle_lim)
//----------------------------------------------------------------------------
{
	//-----------Contruzione Point Locator----------------------
	vtkPoints *MS_vtkpoints = vtkPoints::New();
...
//----------------------------------------------------------------------------
inline albaICPUtility::RegResult albaICPUtility::FFRegistration( vnl_matrix<double>& MS, vnl_matrix<double>& DS, const char* knownMinLocalFile, float VarianceThrshold, int MaximumNumberOfIterations)
//----------------------------------------------------------------------------
{
	...
	albaICPUtility::RegResult res=ICP_vtkPointLocator(MS, DS, MaximumNumberOfIterations);	//Copy by reference; finally DS is the registered one
...
//----------------------------------------------------------------------------
inline albaICPUtility::RegResult albaICPUtility::StandardRegistration( vnl_matrix<double>& MS, vnl_matrix<double>& DS, float Convergence)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
inline void albaICPUtility::Target_on_Source(vnl_matrix_fixed<double,3,3>& R, vnl_vector_fixed<double,3>& p)
//----------------------------------------------------------------------------
{
