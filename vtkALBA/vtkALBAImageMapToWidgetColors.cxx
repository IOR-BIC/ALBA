/*=========================================================================
  ...
  Module:    $RCSfile: vtkALBAImageMapToWidgetColors.cxx,v $
  Language:  C++
...
vtkCxxRevisionMacro(vtkALBAImageMapToWidgetColors, "$Revision: 1.2 $");
vtkStandardNewMacro(vtkALBAImageMapToWidgetColors);
...
vtkALBAImageMapToWidgetColors::vtkALBAImageMapToWidgetColors() 
{
...
//----------------------------------------------------------------------------
void vtkALBAImageMapToWidgetColors::ExecuteData(vtkDataObject *output) 
{
...
//----------------------------------------------------------------------------
template<class T> void vtkALBAImageMapToWidgetColors::UpdateGradientCache(T *dataPointer) 
{
...
//----------------------------------------------------------------------------
unsigned long vtkALBAImageMapToWidgetColors::GetMTime() 
{
...
//----------------------------------------------------------------------------
void vtkALBAImageMapToWidgetColors::ExecuteInformation(vtkImageData *inData, vtkImageData *outData) 
{
...
void vtkALBAImageMapToWidgetColors::ThreadedExecute(vtkImageData *inData, vtkImageData *outData, int outExt[6], int id) 
{
...
template<class T> void vtkALBAImageMapToWidgetColors::Execute(vtkImageData *inData,  T *inPtr, vtkImageData *outData, unsigned char *outPtr, int outExt[6]) 
{
  // color mapping
