/*=========================================================================
  ...
  Module:    $RCSfile: vtkALBAExtendedGlyph3D.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkALBAExtendedGlyph3D - copy oriented and scaled glyph geometry to every input point
// .SECTION Description
// vtkALBAExtendedGlyph3D is an extended version of vtkGlyph3D supporting visibility by scalar, 
...
public:
  ...
  static vtkALBAExtendedGlyph3D *New();
...
private:
  vtkALBAExtendedGlyph3D(const vtkALBAExtendedGlyph3D&);  // Not implemented.
  void operator=(const vtkALBAExtendedGlyph3D&);  // Not implemented.
};

/**
Return the method of scaling as a descriptive character string.*/
inline const char *vtkALBAExtendedGlyph3D::GetScaleModeAsString(void)
{
...
inline const char *vtkALBAExtendedGlyph3D::GetColorModeAsString(void)
{
...
inline const char *vtkALBAExtendedGlyph3D::GetVectorModeAsString(void)
{
...
inline const char *vtkALBAExtendedGlyph3D::GetIndexModeAsString(void)
{
