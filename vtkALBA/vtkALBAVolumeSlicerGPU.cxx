...
vtkCxxRevisionMacro(vtkALBAVolumeSlicer, "$Revision: 1.1 $");
...
void vtkALBAVolumeSlicer::CreateImageGPU(const void* input, void* output, vtkImageData *outputObject)
//----------------------------------------------------------------------------
{
  // prepare data for sampling  
  const int xs = outputObject->GetDimensions()[0], ys = outputObject->GetDimensions()[1];
