/*========================================================================= 
  ...
  Module: $RCSfile: vtkALBAPolyDataDeformation_M2.h,v $ 
  Language: C++ 
  ...
  =========================================================================
  vtkALBAPolyDataDeformation_M2 performs a skeleton based deformation
...
*/
#ifndef vtkALBAPolyDataDeformation_M2_h__
#define vtkALBAPolyDataDeformation_M2_h__
...
//#define DEBUG_vtkALBAPolyDataDeformation_M2
...
protected:
  vtkALBAPolyDataDeformation_M2();           
  virtual ~vtkALBAPolyDataDeformation_M2();
...
#pragma region //Nested Classes
  ...
  class ALBA_EXPORT CSuperSkeleton
  {
  public:
...
private:
  vtkALBAPolyDataDeformation_M2(const vtkALBAPolyDataDeformation_M2&);  // Not implemented.
  void operator = (const vtkALBAPolyDataDeformation_M2&);  // Not implemented.  
...
#endif // vtkALBAPolyDataDeformation_M2_h__
