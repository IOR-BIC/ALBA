...
//------------------------------------------------------------------------------
// Constructor
vtkALBAContourVolumeMapperAdv::vtkALBAContourVolumeMapperAdv()
//------------------------------------------------------------------------------
{
  Alpha=1.0;
...
//------------------------------------------------------------------------------
void vtkALBAContourVolumeMapperAdv::PrepareContours(const int slice, const void *imageData, ListOfPolyline2DAdv& polylines) {
...
//------------------------------------------------------------------------------
template<typename DataType> void vtkALBAContourVolumeMapperAdv::PrepareContoursTemplate(const int slice, const DataType *imageData) {
