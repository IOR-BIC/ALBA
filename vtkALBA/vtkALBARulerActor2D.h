...
=========================================================================*//*=========================================================================
  ...
  Module:    $RCSfile: vtkALBARulerActor2D.h,v $
  Language:  C++
...
#ifndef __vtkALBARulerActor2D_h
#define __vtkALBARulerActor2D_h
...
//-----------------------------------------------------------------------------
class ALBA_EXPORT vtkALBARulerActor2D : public vtkActor2D
//-----------------------------------------------------------------------------
{
 public:
...
private:
  vtkALBARulerActor2D(const vtkALBARulerActor2D&);  	// Not implemented.
  void operator=(const vtkALBARulerActor2D&);  // Not implemented.
};
#endif
