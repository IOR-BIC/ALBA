...
//{
  ...
  vtkCxxRevisionMacro(vtkALBAContourVolumeMapperGPU, "$Revision: 1.1.2.3 $");
  vtkStandardNewMacro(vtkALBAContourVolumeMapperGPU);
...
#define __func__ __FUNCTION__
  ...
  void vtkALBAContourVolumeMapperGPU::DeleteTexture()
  {
    if(m_tex_function>0)
    {	
  ...
  template <typename DataType> void vtkALBAContourVolumeMapperGPU::PaddingMem( DataType *dataPointer)
  {
  ...
  //------------------------------------------------------------------------------
  /*virtual*/ void vtkALBAContourVolumeMapperGPU::SetGPUEnabled(int newMode)
    //------------------------------------------------------------------------------
  {
  ...
  int  vtkALBAContourVolumeMapperGPU::CreateTexturesForIsosurface(const void *dataPointer)
  {	
  ...
  int vtkALBAContourVolumeMapperGPU::BuildHistopyramidSliceSorting()
  {
...
#pragma endregion //Baoquan's GPU Misc
  ...
  //------------------------------------------------------------------------------
  // Constructor
  vtkALBAContourVolumeMapperGPU::vtkALBAContourVolumeMapperGPU()
    //------------------------------------------------------------------------------
  {
    m_tex_function=0;
    m_hp_tex=0;
  ...
  void vtkALBAContourVolumeMapperGPU::ReleaseData()
    //------------------------------------------------------------------------------
  {
  ...
  void vtkALBAContourVolumeMapperGPU::ClearCachesAndStats()
    //------------------------------------------------------------------------------
  {
    for (int lod = 0 ;  lod < NumberOfLods ;  lod++){
      // delete triangle caches
  ...
  void vtkALBAContourVolumeMapperGPU::SetInput(vtkDataSet *input)
    //------------------------------------------------------------------------------
  {
    this->ReleaseData();
    double b[2];
  ...
  float vtkALBAContourVolumeMapperGPU::EstimateRelevantVolume(const double contourValue)
    //------------------------------------------------------------------------------
  {
    switch (this->GetDataType()) {
    case VTK_CHAR:
  ...
  template <typename DataType> float vtkALBAContourVolumeMapperGPU::EstimateRelevantVolumeTemplate(const DataType ContourValue)
    //------------------------------------------------------------------------------
  {
...
#pragma region //Baoquan's GPU renderer
  ...
  void vtkALBAContourVolumeMapperGPU::InitializeIsosurfaceRender(bool setup, vtkRenderer *renderer, vtkVolume *volume)
    //------------------------------------------------------------------------------
  {
  ...
  int  vtkALBAContourVolumeMapperGPU::InitOpenGL()
  {
#ifndef _WIN32
    m_bGPU_isosurfaceSupported=0;
#else
  ...
  template<typename DataType> void vtkALBAContourVolumeMapperGPU::RenderIsoSurfaceOnGPU(vtkRenderer *renderer, vtkVolume *volume, const DataType *dataPointer)
    //------------------------------------------------------------------------------
  {
  ...
  //              RenderMCubes()
  void vtkALBAContourVolumeMapperGPU::Render(vtkRenderer *renderer, vtkVolume *volume)
    //------------------------------------------------------------------------------
  {
    if (this->GetInput() == NULL || this->GetInput()->GetPointData() == NULL || this->GetInput()->GetPointData()->GetScalars() == NULL) {
  ...
  template <typename DataType> bool vtkALBAContourVolumeMapperGPU::PrepareAccelerationDataTemplate(const DataType *dataPointer)
    //------------------------------------------------------------------------------
  {
    int lod ;
  ...
  //------------------------------------------------------------------------------
  void vtkALBAContourVolumeMapperGPU::EnableClipPlanes(bool enable)
    //------------------------------------------------------------------------------
  {
    if (enable) {
  ...
  //------------------------------------------------------------------------------
  bool vtkALBAContourVolumeMapperGPU::IsDataValid(bool warnings)
    //------------------------------------------------------------------------------
  {
  ...
  int vtkALBAContourVolumeMapperGPU::GetDataType()
    //------------------------------------------------------------------------------
  {
  ...
  vtkPolyData *vtkALBAContourVolumeMapperGPU::GetOutput(int level, vtkPolyData *data)
    //------------------------------------------------------------------------------
  {
...
#pragma region CPU based Marching Cube
  ...
  void vtkALBAContourVolumeMapperGPU::InitializeRender(bool setup, vtkRenderer *renderer, vtkVolume *volume)
    //------------------------------------------------------------------------------
  {
    glGetError(); // reset error flag
    if (setup) {
  ...
  void vtkALBAContourVolumeMapperGPU::DrawCache(vtkRenderer *renderer, vtkVolume *volume, int lod)
    //------------------------------------------------------------------------------
  {
  ...
  template<typename DataType> void vtkALBAContourVolumeMapperGPU::RenderMCubes(vtkRenderer *renderer, vtkVolume *volume, const DataType *dataPointer)
    //------------------------------------------------------------------------------
  {
    int lod ;
  ...
  template<typename DataType> void vtkALBAContourVolumeMapperGPU::CreateMCubes(int LODLevel, vtkPolyData *polydata, const DataType *dataPointer)
    //------------------------------------------------------------------------------
  {
    // select LOD
  ...
  // Called by GetOutput()
  template<typename DataType> void vtkALBAContourVolumeMapperGPU::CreateMCubes_old(int level, vtkPolyData *polydata, const DataType *dataPointer) {
    //------------------------------------------------------------------------------
  ...
  void vtkALBAContourVolumeMapperGPU::CalculateLodIncrements(int lod, int *lodxy, int *lodz) const
    //------------------------------------------------------------------------------
  {
  ...
  void vtkALBAContourVolumeMapperGPU::CalculateVoxelVertIndicesOffsets(int lod, int *offset) const
    //------------------------------------------------------------------------------
  {
    int lodxy, lodz ;
    CalculateLodIncrements(lod, &lodxy, &lodz) ;
  ...
  int vtkALBAContourVolumeMapperGPU::VoxelVolume(int lod) const
    //------------------------------------------------------------------------------
  {
    int lodxy, lodz ;
    CalculateLodIncrements(lod, &lodxy, &lodz) ;
  ...
  int vtkALBAContourVolumeMapperGPU::EstimateTrianglesFromRelevantVolume(int lod)
    //------------------------------------------------------------------------------
  {
  ...
  int vtkALBAContourVolumeMapperGPU::EstimateNumberOfTriangles(int lod)
    //------------------------------------------------------------------------------
  {
  ...
  // Only use this to help decide whether to render at this LOD or not.
  float vtkALBAContourVolumeMapperGPU::EstimateTimeToDrawDC(int lod) const
    //------------------------------------------------------------------------------
  {
  ...
  // Only use this to help decide whether to render at this LOD or not.
  float vtkALBAContourVolumeMapperGPU::EstimateTimeToDrawRMC(int lod)
    //------------------------------------------------------------------------------
  {
    // Note: Rendering is performed either by DrawCache() or RenderMCubes().
  ...
  int vtkALBAContourVolumeMapperGPU::BestLODForDrawCache(vtkRenderer *renderer)
    //------------------------------------------------------------------------------
  {
  ...
  int vtkALBAContourVolumeMapperGPU::BestLODForRenderMCubes(vtkRenderer *renderer)
    //------------------------------------------------------------------------------
  {
    // return level zero if auto lod not enabled
    if (!this->AutoLODRender)
  ...
  int vtkALBAContourVolumeMapperGPU::BestLODForCreateMCubes()
    //------------------------------------------------------------------------------
  {
    // return level zero if auto lod not enabled
    if (!this->AutoLODCreate)
  ...
  void vtkALBAContourVolumeMapperGPU::PrepareContours(const int slice, const void *imageData, ListOfPolyline2DGPU& polylines)
    //------------------------------------------------------------------------------
  {
  ...
  //------------------------------------------------------------------------------
  // Prepare contours
  template<typename DataType> void vtkALBAContourVolumeMapperGPU::PrepareContoursTemplate(const int slice, const DataType *imageData) 
    //------------------------------------------------------------------------------
  {
  ...
  void vtkALBAContourVolumeMapperGPU::CalculateDepthMatrix(double *PM) const
    //------------------------------------------------------------------------------
  {
  ...
  float vtkALBAContourVolumeMapperGPU::DepthOfVertex(double *PM, float *v) const
    //------------------------------------------------------------------------------
  {
    float zhomo, whomo, z ;
  ...
  void vtkALBAContourVolumeMapperGPU::SortTriangles(int lod, bool sortall)
    //------------------------------------------------------------------------------
  {
  ...
  template<typename DataType> const DataType* vtkALBAContourVolumeMapperGPU::PointerFromIndices(const DataType* dataPointer, int x, int y, int z)
    //------------------------------------------------------------------------------
  {
  ...
  // dataPointer is the pointer to (0,0,0) in the volume
  // Useful in debugging to check correspondence between pointer and (x,y,z)
  template<typename DataType> void vtkALBAContourVolumeMapperGPU::IndicesFromPointer(const DataType* dataPointer, const DataType* p, int *x, int *y, int *z)
    //------------------------------------------------------------------------------
  {
    int rowSize = this->DataDimensions[0] ;
    int sliceSize = this->DataDimensions[0] * this->DataDimensions[1] ;
