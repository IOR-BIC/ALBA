...
Module: $RCSfile: vtkALBAVolumeRayCastMapper.cxx,v $ 
Language: C++ 
...
vtkCxxRevisionMacro(vtkALBAVolumeRayCastMapper, "$Revision: 1.1.2.3 $");
vtkStandardNewMacro(vtkALBAVolumeRayCastMapper);
...
/*virtual*/ void vtkALBAVolumeRayCastMapper::Render( vtkRenderer *ren, vtkVolume *vol )
//------------------------------------------------------------------------
{
