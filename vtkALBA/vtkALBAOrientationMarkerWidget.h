/*=========================================================================
  ...
  Module:    $RCSfile: vtkALBAOrientationMarkerWidget.h,v $
...
#ifndef __vtkALBAOrientationMarkerWidget_h
#define __vtkALBAOrientationMarkerWidget_h
...
class vtkPolyData;
class vtkProp;
class vtkALBAOrientationMarkerWidgetObserver;
class vtkRenderer;
...
This class is used along with vtkALBAAnnotatedCubeActor to build a render window superimposed rotating cube with
anatomical markers and it's working in a two layer alba render window ie the following render window should be created: 
m_Rwi = new albaRWI(albaGetFrame(), TWO_LAYER , ...);
...
*/
class ALBA_EXPORT vtkALBAOrientationMarkerWidget : public vtkInteractorObserver
{
public:
...
protected:
  vtkALBAOrientationMarkerWidget();
  ~vtkALBAOrientationMarkerWidget();
  ...
  vtkALBAOrientationMarkerWidgetObserver *Observer;
...
private:
  vtkALBAOrientationMarkerWidget(const vtkALBAOrientationMarkerWidget&);  // Not implemented
  void operator=(const vtkALBAOrientationMarkerWidget&);  // Not implemented
};
