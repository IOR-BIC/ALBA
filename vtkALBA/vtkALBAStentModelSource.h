...
#ifndef __albaVMEStentModelSource_h 
#define __albaVMEStentModelSource_h
...
*---------------------------------------
*/
class ALBA_EXPORT vtkALBAStentModelSource
{
...
public:
  ...
  vtkALBAStentModelSource(void); ///< Constructor
  ~vtkALBAStentModelSource(void); ///< Destructor
