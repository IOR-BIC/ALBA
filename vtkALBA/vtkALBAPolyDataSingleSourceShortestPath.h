/*=========================================================================
  ...
  Module:    $RCSfile: vtkALBAPolyDataSingleSourceShortestPath.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkALBAPolyDataSingleSourceShortestPath - Single source shortest path on a polygonal mesh
// .SECTION Description
//
// vtkALBAPolyDataSingleSourceShortestPath is a filter that takes as input
...
protected:
	vtkALBAPolyDataSingleSourceShortestPath();
	~vtkALBAPolyDataSingleSourceShortestPath();
	vtkALBAPolyDataSingleSourceShortestPath(const vtkALBAPolyDataSingleSourceShortestPath&);
