/*=========================================================================
  ...
  Module:    $RCSfile: vtkALBATransferFunction2D.cxx,v $
  Language:  C++
...
//-----------------------------------------------------------------
vtkALBATransferFunction2D::vtkALBATransferFunction2D() 
//-----------------------------------------------------------------
{
  this->Initialize();
}
...
//-----------------------------------------------------------------
void vtkALBATransferFunction2D::ShallowCopy(vtkDataObject *o)
//-----------------------------------------------------------------
{
  vtkALBATransferFunction2D *f = vtkALBATransferFunction2D::SafeDownCast(o);
...
//-----------------------------------------------------------------
void vtkALBATransferFunction2D::Initialize() 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
void vtkALBATransferFunction2D::Modified(double from, double to) 
//-----------------------------------------------------------------
{
  this->RangeValid = false;
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::CheckWidget(const tfWidget &widget) 
//-----------------------------------------------------------------
{
  // check the widget
...
//-----------------------------------------------------------------
int vtkALBATransferFunction2D::AddWidget(const tfWidget &widget) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::RemoveWidget(int index) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidget(int index, const tfWidget &widget) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetVisibility(int index, bool visible) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetOpacity(int index, double opacity) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetColor(int index, double color[3]) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetDiffuse(int index, double diffuse) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetValueRatio(int index, double ratio) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetValueRange(int index, double range[3]) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetGradientRange(int index, double range[3]) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::SetWidgetGradientInterpolation(int index, int order) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
void vtkALBATransferFunction2D::UpdateRanges() 
//-----------------------------------------------------------------
{
  if (this->RangeValid)
    return;
...
//-----------------------------------------------------------------
double vtkALBATransferFunction2D::GetValue(const double val, const double gradient, double &opacity, double color[3], double &diffuse) 
//-----------------------------------------------------------------
{
  opacity = 0;
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::GetTable(int vsize, const double *vTable, int gsize, const double *gTable, double *opacityTable, unsigned char *rgbdTable, bool useOpacity) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
{
  ...
  if (prop && prop != this) 
  {
    if (prop->TransferFunction2D != this->TransferFunction2D) 
    {
      if (this->TransferFunction2D != NULL)
        this->TransferFunction2D->Delete();
      this->TransferFunction2D = vtkALBATransferFunction2D::New();
...
//-----------------------------------------------------------------
void vtkVolumeProperty2::SetTransferFunction2D(vtkALBATransferFunction2D *function) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
char *vtkALBATransferFunction2D::SaveToString() 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkALBATransferFunction2D::LoadFromString(const char *string) 
//-----------------------------------------------------------------
{
