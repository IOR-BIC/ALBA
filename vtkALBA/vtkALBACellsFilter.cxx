/*=========================================================================
  ...
  Module:    vtkALBACellsFilter.cxx
  Language:  C++
  Version:   $Id: vtkALBACellsFilter.cxx,v 1.1.2.1 2009-01-08 11:42:44 ior01 Exp $
...
vtkALBACellsFilter::vtkALBACellsFilter()
{
...
void vtkALBACellsFilter::SetMarkedColor(double r, double g, double b)
{
...
void vtkALBACellsFilter::SetUnmarkedColor(double r, double g, double b)
{
...
void vtkALBACellsFilter::SetMarkedOpacity(double opacity)
{
  double rgba[4];
...
void vtkALBACellsFilter::InitializeScalars()
{
...
void vtkALBACellsFilter::ToggleCell(vtkIdType cellid_at_output)
{
...
void vtkALBACellsFilter::UnmarkCell(vtkIdType cellid_at_output)
{
  vtkIdType cellid_at_input;
...
void vtkALBACellsFilter::MarkCell(vtkIdType cellid_at_output)
{
  vtkIdType cellid_at_input;
...
void vtkALBACellsFilter::PrintSelf(ostream& os, vtkIndent indent)
{
