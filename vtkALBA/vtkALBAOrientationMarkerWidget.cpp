/*=========================================================================
  ...
  Module:    $RCSfile: vtkALBAOrientationMarkerWidget.cpp,v $
...
class vtkALBAOrientationMarkerWidgetObserver : public vtkCommand
{
public:
  static vtkALBAOrientationMarkerWidgetObserver *New()
    {return new vtkALBAOrientationMarkerWidgetObserver;};

  vtkALBAOrientationMarkerWidgetObserver()
    {
  ...
  vtkALBAOrientationMarkerWidget *OrientationMarkerWidget;
};

//-------------------------------------------------------------------------
vtkALBAOrientationMarkerWidget::vtkALBAOrientationMarkerWidget()
{
  this->StartEventObserverId = 0;
  this->EventCallbackCommand->SetCallback( vtkALBAOrientationMarkerWidget::ProcessEvents );

  this->Observer = vtkALBAOrientationMarkerWidgetObserver::New();
  ...
  this->State = vtkALBAOrientationMarkerWidget::Outside;
  this->Interactive = 1;
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::SetEnabled(int enabling)
{
  if (!this->Interactor)
    {
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::ExecuteCameraUpdateEvent(vtkObject *vtkNotUsed(o),
...
//-------------------------------------------------------------------------
int vtkALBAOrientationMarkerWidget::ComputeStateBasedOnPosition(int X, int Y,
                                                    int *pos1, int *pos2)
{
  if ( X < (pos1[0]-this->Tolerance) || (pos2[0]+this->Tolerance) < X ||
       Y < (pos1[1]-this->Tolerance) || (pos2[1]+this->Tolerance) < Y )
    {
    return vtkALBAOrientationMarkerWidget::Outside;
    }

  // if we are not outside and the left mouse button wasn't clicked,
  // then we are inside, otherwise we are moving

  int result = this->Moving ? vtkALBAOrientationMarkerWidget::Translating :
      vtkALBAOrientationMarkerWidget::Inside;
  ...
  if (e1)
    ...
    if (e2)
      {
      result = vtkALBAOrientationMarkerWidget::AdjustingP1; // lower left
      }
    if (e4)
      {
      result = vtkALBAOrientationMarkerWidget::AdjustingP4; // upper left
      }
    }
  if (e3)
    {
    if (e2)
      {
      result = vtkALBAOrientationMarkerWidget::AdjustingP2; // lower right
      }
    if (e4)
      {
      result = vtkALBAOrientationMarkerWidget::AdjustingP3;  // upper right
      }
    }
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::SetCursor(int state)
{
  switch (state)
    {
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::ProcessEvents(vtkObject* vtkNotUsed(object),
                                    unsigned long event,
                                    void *clientdata,
                                    void* vtkNotUsed(calldata))
{
  vtkALBAOrientationMarkerWidget *self =
    reinterpret_cast<vtkALBAOrientationMarkerWidget*>( clientdata );
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::OnLeftButtonDown()
{
  ...
  if (this->State == vtkALBAOrientationMarkerWidget::Outside)
    {
    this->Moving = 0;
    return;
    }
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::OnLeftButtonUp()
{
  if (this->State == vtkALBAOrientationMarkerWidget::Outside)
    {
    return;
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::SquareRenderer()
{
  ...
  if (dx != dy)
    ...
    switch (this->State)
      {
      case vtkALBAOrientationMarkerWidget::AdjustingP1:
        vp[2] = vp[0] + delta;
        vp[3] = vp[1] + delta;
        break;
      case vtkALBAOrientationMarkerWidget::AdjustingP2:
        vp[0] = vp[2] - delta;
        vp[3] = vp[1] + delta;
        break;
      case vtkALBAOrientationMarkerWidget::AdjustingP3:
        vp[0] = vp[2] - delta;
        vp[1] = vp[3] - delta;
        break;
      case vtkALBAOrientationMarkerWidget::AdjustingP4:
        vp[2] = vp[0] + delta;
        vp[1] = vp[3] - delta;
        break;
      case vtkALBAOrientationMarkerWidget::Translating:
        delta = (dx + dy)*0.5;
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::UpdateOutline()
{
  double vp[4];
  this->Renderer->GetViewport( vp );
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::SetInteractive(int interact)
{
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::OnMouseMove()
{
  ...
  if (this->State == vtkALBAOrientationMarkerWidget::Outside || !this->Moving)
    {
    this->Interactor->Render();
    return;
    }
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::MoveWidget(int X, int Y)
{
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::ResizeTopLeft(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::ResizeTopRight(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
  int delta = (abs(dx) + abs(dy))/2;
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::ResizeBottomRight(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
  int delta = (abs(dx) + abs(dy))/2;
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::ResizeBottomLeft(int X, int Y)
{
  int dx = X - this->StartPosition[0];
  int dy = Y - this->StartPosition[1];
  int delta = (abs(dx) + abs(dy))/2;
...
//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::SetOutlineColor(double r, double g, double b)
{
...
//-------------------------------------------------------------------------
double* vtkALBAOrientationMarkerWidget::GetOutlineColor()
{
  return this->OutlineActor->GetProperty()->GetColor();
}

//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::SetViewport(double minX, double minY,
...
//-------------------------------------------------------------------------
double* vtkALBAOrientationMarkerWidget::GetViewport()
{
  return this->Renderer->GetViewport();
}

//-------------------------------------------------------------------------
void vtkALBAOrientationMarkerWidget::PrintSelf(ostream& os, vtkIndent indent)
{
