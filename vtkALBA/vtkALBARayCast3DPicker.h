...
#ifndef __vtkALBARayCast3DPicker_h
#define __vtkALBARayCast3DPicker_h
...
*/
class ALBA_EXPORT vtkALBARayCast3DPicker : public vtkAbstractPropPicker
{
public:
...
private:
  vtkALBARayCast3DPicker(const vtkALBARayCast3DPicker&);  // Not implemented.
  void operator=(const vtkALBARayCast3DPicker&);  // Not implemented.
};
