...
IF (EXISTS "${CRYPTO_SOURCE_DIR}/Packages")   
  ...
  IF (NOT EXISTS "${CRYPTO_SOURCE_PATH}")
		IF(WIN32)
			IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 10 Win64" OR ${CMAKE_GENERATOR} STREQUAL "Visual Studio 11 Win64")
				FIND_AND_UNPACK_PACKAGE (CRYPTO54 ${CRYPTO_PACKAGE_PATH} "${CRYPTO_BINARY_DIR}/Sources" ${CRYPTO_SOURCE_PATH})
				FIND_AND_APPLAY_PATCHES (CRYPTO54 ${CRYPTO_PATCH_PATH} "${CRYPTO_SOURCE_PATH}")
			ELSE(${CMAKE_GENERATOR} STREQUAL "Visual Studio 10 Win64" OR ${CMAKE_GENERATOR} STREQUAL "Visual Studio 11 Win64")
				FIND_AND_UNPACK_PACKAGE (CRYPTO562 ${CRYPTO_PACKAGE_PATH} "${CRYPTO_BINARY_DIR}/Sources" ${CRYPTO_SOURCE_PATH})
			ENDIF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 10 Win64" OR ${CMAKE_GENERATOR} STREQUAL "Visual Studio 11 Win64")
		ELSE(WIN32)
