...
IF (EXISTS "${CRYPTO_SOURCE_DIR}/Packages")   
  ...
  IF (NOT EXISTS "${CRYPTO_SOURCE_PATH}")
		IF(WIN32)
	  	   	FIND_AND_UNPACK_PACKAGE (CRYPTO562 ${CRYPTO_PACKAGE_PATH} "${CRYPTO_BINARY_DIR}/Sources" ${CRYPTO_SOURCE_PATH})
		ELSE(WIN32)
			FIND_AND_UNPACK_PACKAGE (CRYPTO552 ${CRYPTO_PACKAGE_PATH} "${CRYPTO_BINARY_DIR}/Sources" ${CRYPTO_SOURCE_PATH})
		ENDIF(WIN32)
