  ...
  IF (NOT EXISTS "${CRYPTO_SOURCE_PATH}")
		IF(WIN32)
		  ...
		  ELSE(${CMAKE_GENERATOR} STREQUAL "Visual Studio 9 2008")	  	  
				IF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 10" OR ${CMAKE_GENERATOR} STREQUAL "Visual Studio 11")

		    	FIND_AND_UNPACK_PACKAGE (CRYPTO561 ${CRYPTO_PACKAGE_PATH} "${CRYPTO_BINARY_DIR}/Sources" ${CRYPTO_SOURCE_PATH})

		   	ELSE(${CMAKE_GENERATOR} STREQUAL "Visual Studio 10" OR ${CMAKE_GENERATOR} STREQUAL "Visual Studio 11")
		    	FIND_AND_UNPACK_PACKAGE (CRYPTO54 ${CRYPTO_PACKAGE_PATH} "${CRYPTO_BINARY_DIR}/Sources" ${CRYPTO_SOURCE_PATH})
		  	ENDIF(${CMAKE_GENERATOR} STREQUAL "Visual Studio 10" OR ${CMAKE_GENERATOR} STREQUAL "Visual Studio 11")
