#
# Program:   MULTIMOD APPLICATION FRAMEWORK (ALBA)
...
IF (VTK_SOURCE_PATH)
  ...
  IF (VTK_FORCE_CONFIGURE OR NOT EXISTS ${VTK_BINARY_DIR}/build.cmake)
    ...
    -DVTK_USE_HYBRID:BOOL=${VTK_USE_HYBRID} -DVTK_USE_ANSI_STDLIB:BOOL=${VTK_USE_ANSI_STDLIB} -DBUILD_TESTING:BOOL=OFF -DBUILD_EXAMPLES:BOOL=OFF -DVTK_RENDERING_BACKEND:STRING="${VTK_RENDERING_BACKEND}"
