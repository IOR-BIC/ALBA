...
IF (VTK_SOURCE_PATH)
  ...
  IF(NOT VTK_BUILD_SHARED_LIBS EQUAL ${BUILD_SHARED_LIBS})
  	SET(VTK_FORCE_CONFIGURE TRUE)
  ELSE(NOT VTK_BUILD_SHARED_LIBS EQUAL ${BUILD_SHARED_LIBS})
  	SET(VTK_FORCE_CONFIGURE FALSE)
  ENDIF(NOT VTK_BUILD_SHARED_LIBS EQUAL ${BUILD_SHARED_LIBS})
