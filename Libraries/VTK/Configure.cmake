...
IF (VTK_SOURCE_PATH)
  ...
  IF (VTK_FORCE_CONFIGURE OR NOT EXISTS ${VTK_BINARY_DIR}/build.cmake)
    ...
    -DVTK_USE_HYBRID:BOOL=${VTK_USE_HYBRID} -DVTK_USE_ANSI_STDLIB:BOOL=${VTK_USE_ANSI_STDLIB} -DVTK_USE_64BIT_IDS:BOOL=TRUE -DBUILD_TESTING:BOOL=OFF -DBUILD_EXAMPLES:BOOL=OFF
