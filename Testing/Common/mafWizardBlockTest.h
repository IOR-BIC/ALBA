...
#ifndef __CPP_UNIT_mafWizardBlockTest_H__
#define __CPP_UNIT_mafWizardBlockTest_H__
...
/** 
class name: mafWizardBlockTest
  Test class for mafWizardBlock
*/
class mafWizardBlockTest : public CPPUNIT_NS::TestFixture
{
public:

  /** Start test suite macro */
	CPPUNIT_TEST_SUITE( mafWizardBlockTest );
