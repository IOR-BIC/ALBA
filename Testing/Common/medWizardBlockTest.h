...
#ifndef __CPP_UNIT_medWizardBlockTest_H__
#define __CPP_UNIT_medWizardBlockTest_H__
...
/** 
class name: medWizardBlockTest
  Test class for medWizardBlock
*/
class medWizardBlockTest : public CPPUNIT_NS::TestFixture
{
public:

  /** Start test suite macro */
	CPPUNIT_TEST_SUITE( medWizardBlockTest );
...
main( int argc, char* argv[] )
{
	...
	runner.addTest( medWizardBlockTest::suite());
