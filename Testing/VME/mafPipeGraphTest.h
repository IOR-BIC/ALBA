...
#ifndef __CPP_UNIT_mafPipeGraphTest_H__
#define __CPP_UNIT_mafPipeGraphTest_H__
...
class mafPipeGraphTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( mafPipeGraphTest );
