...
Module:    $RCSfile: mafPipeScalarTest.h,v $
Language:  C++
Date:      $Date: 2008-11-03 14:00:02 $
...
#ifndef __CPP_UNIT_mafPipeScalarTest_H__
#define __CPP_UNIT_mafPipeScalarTest_H__
...
class mafPipeScalarTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeScalarTest );
