...
Module:    $RCSfile: mafPipeMeshTest.h,v $
Language:  C++
Date:      $Date: 2007-06-18 13:07:51 $
...
#ifndef __CPP_UNIT_mafPipeMeshTest_H__
#define __CPP_UNIT_mafPipeMeshTest_H__
...
class mafPipeMeshTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeMeshTest );
