...
Module:    $RCSfile: medPipeCompoundVolumeMIPTest.h,v $
Language:  C++
Date:      $Date: 2010-11-29 13:19:57 $
...
class medPipeCompoundVolumeMIPTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medPipeCompoundVolumeMIPTest );
...
int main( int argc, char* argv[] )
{
  ...
  runner.addTest( medPipeCompoundVolumeMIPTest::suite());
