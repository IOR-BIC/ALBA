...
#ifndef __CPP_UNIT_mafPipeSurfaceTest_H__
#define __CPP_UNIT_mafPipeSurfaceTest_H__
...
class mafPipeSurfaceTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeSurfaceTest );
