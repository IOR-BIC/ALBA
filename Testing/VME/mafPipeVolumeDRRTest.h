...
#ifndef __CPP_UNIT_mafPipeVolumeDRRTest_H__
#define __CPP_UNIT_mafPipeVolumeDRRTest_H__
...
class mafPipeVolumeDRRTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeVolumeDRRTest );
