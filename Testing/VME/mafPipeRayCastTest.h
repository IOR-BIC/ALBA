...
#ifndef __CPP_UNIT_mafPipeRayCastTest_H__
#define __CPP_UNIT_mafPipeRayCastTest_H__
...
class mafPipeRayCastTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeRayCastTest );
