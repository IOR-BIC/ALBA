...
#ifndef __CPP_UNIT_mafPipeTrajectoriesTest_H__
#define __CPP_UNIT_mafPipeTrajectoriesTest_H__
...
class mafPipeTrajectoriesTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeTrajectoriesTest );
