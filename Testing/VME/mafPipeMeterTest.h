...
Module:    $RCSfile: mafPipeMeterTest.h,v $
Language:  C++
Date:      $Date: 2009-10-08 07:19:07 $
...
#ifndef __CPP_UNIT_mafPipeMeterTest_H__
#define __CPP_UNIT_mafPipeMeterTest_H__
...
class mafPipeMeterTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeMeterTest );
