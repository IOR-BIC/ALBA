...
#ifndef __CPP_UNIT_mafPipeGizmoTest_H__
#define __CPP_UNIT_mafPipeGizmoTest_H__
...
class mafPipeGizmoTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeGizmoTest );
