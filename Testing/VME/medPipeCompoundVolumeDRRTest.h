...
Module:    $RCSfile: medPipeCompoundVolumeDRRTest.h,v $
Language:  C++
...
class medPipeCompoundVolumeDRRTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medPipeCompoundVolumeDRRTest );
...
int main( int argc, char* argv[] )
{
  ...
  runner.addTest( medPipeCompoundVolumeDRRTest::suite());
