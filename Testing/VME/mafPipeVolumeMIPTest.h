...
#ifndef __CPP_UNIT_mafPipeVolumeMIPTest_H__
#define __CPP_UNIT_mafPipeVolumeMIPTest_H__
...
class mafPipeVolumeMIPTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeVolumeMIPTest );
