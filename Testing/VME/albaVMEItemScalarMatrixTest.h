...
#ifndef __CPP_UNIT_albaVMEItemScalarMatrixTest_H__
#define __CPP_UNIT_albaVMEItemScalarMatrixTest_H__

#include "albaTest.h"

/** Test for albaVMEItemScalarMatrixTest; Use this suite to trace memory problems */
class albaVMEItemScalarMatrixTest : public albaTest
{
public: 
  // CPPUNIT test suite
  CPPUNIT_TEST_SUITE( albaVMEItemScalarMatrixTest );
