...
//----------------------------------------------------------------------------
void albaVMEPolylineGraphTest::BeforeTest()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaVMEPolylineGraphTest::AfterTest()
//----------------------------------------------------------------------------
{
  m_Polydata->Delete() ;
  m_Polydata = NULL ;
...
//---------------------------------------------------------
void albaVMEPolylineGraphTest::TestDynamicAllocation()
//---------------------------------------------------------
{
  albaVMEPolylineGraph *graph = NULL;
  albaNEW(graph);
  albaDEL(graph);
}

//---------------------------------------------------------
void albaVMEPolylineGraphTest::TestSetData()
//---------------------------------------------------------
{
  albaVMEPolylineGraph *graph = NULL;
  albaNEW(graph);
...
//------------------------------------------------------------------------------
void albaVMEPolylineGraphTest::CreateExamplePolydata()
//------------------------------------------------------------------------------
{
