...
Module:    $RCSfile: medPipeWrappedMeterTest.h,v $
Language:  C++
...
#ifndef __CPP_UNIT_medPipeWrappedMeterTest_H__
#define __CPP_UNIT_medPipeWrappedMeterTest_H__
...
class medPipeWrappedMeterTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( medPipeWrappedMeterTest );
...
int main( int argc, char* argv[] )
{
	...
	runner.addTest( medPipeWrappedMeterTest::suite());
