...
#ifndef __CPP_UNIT_albaVMEOutputMeshTest_H__
#define __CPP_UNIT_albaVMEOutputMeshTest_H__

#include "albaTest.h"

/** Test for albaMatrix; Use this suite to trace memory problems */
class albaVMEOutputMeshTest : public albaTest
{
public: 

  // CPPUNIT test suite
  CPPUNIT_TEST_SUITE( albaVMEOutputMeshTest );
