...
Module:    $RCSfile: medPipeVolumeDRRTest.h,v $
Language:  C++
...
#ifndef __CPP_UNIT_medPipeVolumeDRRTest_H__
#define __CPP_UNIT_medPipeVolumeDRRTest_H__
...
class medPipeVolumeDRRTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( medPipeVolumeDRRTest );
...
int main( int argc, char* argv[] )
{
	...
	runner.addTest( medPipeVolumeDRRTest::suite());
