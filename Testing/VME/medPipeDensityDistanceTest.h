...
Module:    $RCSfile: medPipeDensityDistanceTest.h,v $
Language:  C++
...
#ifndef __CPP_UNIT_medPipeDensityDistanceTest_H__
#define __CPP_UNIT_medPipeDensityDistanceTest_H__
...
class medPipeDensityDistanceTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( medPipeDensityDistanceTest );
...
int main( int argc, char* argv[] )
{
	...
	runner.addTest( medPipeDensityDistanceTest::suite());
