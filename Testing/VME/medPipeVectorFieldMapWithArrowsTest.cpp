...
Module:    $RCSfile: medPipeVectorFieldMapWithArrowsTest.cpp,v $
Language:  C++
Date:      $Date: 2010-12-13 13:55:47 $
...
#include "medPipeVectorFieldMapWithArrowsTest.h"
...
//----------------------------------------------------------------------------
void medPipeVectorFieldMapWithArrowsTest::TestFixture()
//----------------------------------------------------------------------------
{
}

//----------------------------------------------------------------------------
void medPipeVectorFieldMapWithArrowsTest::setUp()
//----------------------------------------------------------------------------
{
}

//----------------------------------------------------------------------------
void medPipeVectorFieldMapWithArrowsTest::tearDown()
//----------------------------------------------------------------------------
{
}

//----------------------------------------------------------------------------
void medPipeVectorFieldMapWithArrowsTest::TestCreate()
//----------------------------------------------------------------------------
{
  ...
  medPipeVectorFieldMapWithArrows *pipe = new medPipeVectorFieldMapWithArrows();
...
//----------------------------------------------------------------------------
void medPipeVectorFieldMapWithArrowsTest::CompareImage()
//----------------------------------------------------------------------------
{
  char *file = __FILE__;
  ...
  controlOriginFile<<"/Test_PipeVectorFieldMapWithArrows/";
  ...
  if(!controlStream)
  {
    imageFile<<"/Test_PipeVectorFieldMapWithArrows/";
  ...
  imageFileOrig<<"/Test_PipeVectorFieldMapWithArrows/";
