...
Module:    $RCSfile: medPipeCompoundVolumeIsosurfaceTest.h,v $
Language:  C++
...
class medPipeCompoundVolumeIsosurfaceTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medPipeCompoundVolumeIsosurfaceTest );
...
int main( int argc, char* argv[] )
{
  ...
  runner.addTest( medPipeCompoundVolumeIsosurfaceTest::suite());
