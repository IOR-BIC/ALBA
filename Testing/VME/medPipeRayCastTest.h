...
Module:    $RCSfile: medPipeRayCastTest.h,v $
Language:  C++
...
#ifndef __CPP_UNIT_medPipeRayCastTest_H__
#define __CPP_UNIT_medPipeRayCastTest_H__
...
class medPipeRayCastTest : public CPPUNIT_NS::TestFixture
{
  public: 
...
int main( int argc, char* argv[] )
{
	...
	runner.addTest( medPipeRayCastTest::suite());
