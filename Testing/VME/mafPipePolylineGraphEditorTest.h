...
#ifndef __CPP_UNIT_mafPipePolylineGraphEditorTest_H__
#define __CPP_UNIT_mafPipePolylineGraphEditorTest_H__
...
class mafPipePolylineGraphEditorTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( mafPipePolylineGraphEditorTest );
