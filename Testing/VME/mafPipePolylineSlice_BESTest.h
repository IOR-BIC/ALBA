...
Module:    $RCSfile: mafPipePolylineSlice_BESTest.h,v $
Language:  C++
Date:      $Date: 2010-01-26 09:38:04 $
...
#ifndef __CPP_UNIT_mafPipePolylineSlice_BESTest_H__
#define __CPP_UNIT_mafPipePolylineSlice_BESTest_H__
...
class mafPipePolylineSlice_BESTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( mafPipePolylineSlice_BESTest );
