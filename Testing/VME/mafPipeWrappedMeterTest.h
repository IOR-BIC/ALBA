...
#ifndef __CPP_UNIT_mafPipeWrappedMeterTest_H__
#define __CPP_UNIT_mafPipeWrappedMeterTest_H__
...
class mafPipeWrappedMeterTest : public CPPUNIT_NS::TestFixture
{
  public: 
  ...
  void tearDown();
	...
	CPPUNIT_TEST_SUITE( mafPipeWrappedMeterTest );
