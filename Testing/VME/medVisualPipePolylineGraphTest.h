...
Module:    $RCSfile: medVisualPipePolylineGraphTest.h,v $
Language:  C++
...
class medVisualPipePolylineGraphTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medVisualPipePolylineGraphTest );
...
int main( int argc, char* argv[] )
{
  ...
  runner.addTest( medVisualPipePolylineGraphTest::suite());
