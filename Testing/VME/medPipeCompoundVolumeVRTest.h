...
Module:    $RCSfile: medPipeCompoundVolumeVRTest.h,v $
Language:  C++
...
class medPipeCompoundVolumeVRTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medPipeCompoundVolumeVRTest );
...
int main( int argc, char* argv[] )
{
  ...
  runner.addTest( medPipeCompoundVolumeVRTest::suite());
