...
Module:    $RCSfile: medPipePolylineGraphEditorTest.h,v $
Language:  C++
...
#ifndef __CPP_UNIT_medPipePolylineGraphEditorTest_H__
#define __CPP_UNIT_medPipePolylineGraphEditorTest_H__
...
class medPipePolylineGraphEditorTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medPipePolylineGraphEditorTest );
...
int main( int argc, char* argv[] )
{
  ...
  runner.addTest( medPipePolylineGraphEditorTest::suite());
