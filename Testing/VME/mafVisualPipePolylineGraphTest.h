...
#ifndef __CPP_UNIT_mafVisualPipePolylineGraphTest_H__
#define __CPP_UNIT_mafVisualPipePolylineGraphTest_H__
...
class mafVisualPipePolylineGraphTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( mafVisualPipePolylineGraphTest );
