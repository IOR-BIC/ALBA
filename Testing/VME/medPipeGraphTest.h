...
#define __CPP_UNIT_medPipeGraphTest_H__
...
class medPipeGraphTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medPipeGraphTest );
...
int main( int argc, char* argv[] )
{
  ...
  runner.addTest( medPipeGraphTest::suite());
