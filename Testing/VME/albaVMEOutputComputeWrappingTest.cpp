...
//----------------------------------------------------------------------------
void albaVMEOutputComputeWrappingTest::TestFixture()
//----------------------------------------------------------------------------
{
}
//----------------------------------------------------------------------------
void albaVMEOutputComputeWrappingTest::TestStaticAllocation()
//----------------------------------------------------------------------------
{
  albaVMEOutputComputeWrapping outputWrappedMeter;
}
//----------------------------------------------------------------------------
void albaVMEOutputComputeWrappingTest::TestDynamicAllocation()
//----------------------------------------------------------------------------
{
  albaVMEOutputComputeWrapping *outputWrappedMeter = new albaVMEOutputComputeWrapping();
  cppDEL(outputWrappedMeter);
}
//----------------------------------------------------------------------------
void albaVMEOutputComputeWrappingTest::TestGetPolylineData_Update()
//----------------------------------------------------------------------------
{
  //create a wrapped meter
  albaVMEComputeWrapping *vmeWrappedMeter;
  ...
  albaVMEOutputComputeWrapping *outputWrappedMeter = NULL;
  outputWrappedMeter = albaVMEOutputComputeWrapping::SafeDownCast(vmeWrappedMeter->GetOutput());
