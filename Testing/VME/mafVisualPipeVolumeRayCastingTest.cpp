...
Module:    $RCSfile: mafVisualPipeVolumeRayCastingTest.cpp,v $
Language:  C++
...
//----------------------------------------------------------------------------
void mafVisualPipeVolumeRayCastingTest::CompareImages(int scalarIndex)
//----------------------------------------------------------------------------
{
  char *file = __FILE__;
  ...
  controlOriginFile<<"/Test_VisualPipeVolumeRayCasting/";
  ...
  if(!controlStream)
  {
    imageFile<<"/Test_VisualPipeVolumeRayCasting/";
  ...
  imageFileOrig<<"/Test_VisualPipeVolumeRayCasting/";
