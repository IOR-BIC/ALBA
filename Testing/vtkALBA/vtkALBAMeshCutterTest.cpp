...
bool vtkALBAMeshCutterTest::ColinearVectors(double *v, double *v0, double *v1, double lambda, double ftol)
//------------------------------------------------------------------------------
{
  int i ;
  double dv[3], dist ;
...
bool vtkALBAMeshCutterTest::PointInPlane(double *v, double *origin, double *norm, double ftol)
//------------------------------------------------------------------------------
{
  int i ;
  double dotprod ;
...
bool vtkALBAMeshCutterTest::PointsEqual(double *v0, double *v1, double ftol)
//------------------------------------------------------------------------------
{
  int i ;
  double dist ;
...
void vtkALBAMeshCutterTest::RenderPointScalars(vtkUnstructuredGrid *UG, vtkPolyData *polydata)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// render the input and output data
void vtkALBAMeshCutterTest::RenderCellScalars(vtkUnstructuredGrid *UG, vtkPolyData *polydata)
//------------------------------------------------------------------------------
{
  // Create a Renderer, a RenderWindow and a RenderWindowInteractor
...
void vtkALBAMeshCutterTest::ScalarTest(vtkALBAMeshCutter *MeshCutter, vtkUnstructuredGrid *UG, vtkPolyData *polydata) 
//------------------------------------------------------------------------------
{
  int i, j, k ;
  vtkIdType id0, id1 ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
  fname << ALBA_DATA_ROOT << "/FEM/vtk/hex8" << ".vtk" << std::ends ;
  ...
  vtkALBAMeshCutter *MeshCutter = vtkALBAMeshCutter::New();
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_VerticalCut1() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_VerticalCut2() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_FaceInPlane() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_IncludesEdge1() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_IncludesEdge2() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_IncludesCorner() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_EdgeOnly() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputHex8_CornerOnly() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
...
void vtkALBAMeshCutterTest::TestGetOutputTet4() 
//------------------------------------------------------------------------------
{
  // set filename
  std::ostrstream fname ;
  fname << ALBA_DATA_ROOT << "/FEM/vtk/tet4" << ".vtk" << std::ends ;
...
void vtkALBAMeshCutterTest::TestUpdateChangeCutFunction() 
//------------------------------------------------------------------------------
{
  //----------------------------------------------------------------------------
...
void vtkALBAMeshCutterTest::TestUpdateChangeInput() 
//------------------------------------------------------------------------------
{
  //----------------------------------------------------------------------------
  // Run Hex8
  ...
  fname1 << ALBA_DATA_ROOT << "/FEM/vtk/hex8" << ".vtk" << std::ends ;
  ...
  fname2 << ALBA_DATA_ROOT << "/FEM/vtk/tet4" << ".vtk" << std::ends ;
