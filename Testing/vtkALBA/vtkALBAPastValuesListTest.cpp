...
void vtkALBAPastValuesListTest::TestFixture()
{
}
...
//------------------------------------------------------------------------------
// Test with 20 values
void vtkALBAPastValuesListTest::TestPastValues() 
//------------------------------------------------------------------------------
{
  int i ;
  ...
  vtkALBAPastValuesList *PastVals3 = new vtkALBAPastValuesList(3) ;
  for (i = 0 ;  i < 22 ;  i++){
  ...
  // At each step we check that the stats are correct.
  vtkALBAPastValuesList *PastVals4 = new vtkALBAPastValuesList(4) ;
  for (i = 0 ;  i < 22 ;  i++){
