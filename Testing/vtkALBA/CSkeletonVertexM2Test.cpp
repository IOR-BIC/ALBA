...
//-------------------------------------------------------------------------
{
  vtkALBAPolyDataDeformation_M2::CSkeletonVertex *v1, *v2;
  double coords[3];
  coords[0] = coords[1] = coords[2] = 0.0;

  v1 = new vtkALBAPolyDataDeformation_M2::CSkeletonVertex();
  v2 = new vtkALBAPolyDataDeformation_M2::CSkeletonVertex(coords);
...
//-------------------------------------------------------------------------
{
  ...
  vtkALBAPolyDataDeformation_M2::CSkeletonVertex *vertex1 = new vtkALBAPolyDataDeformation_M2::CSkeletonVertex(coords1);
  vtkALBAPolyDataDeformation_M2::CSkeletonVertex *vertex2 = new vtkALBAPolyDataDeformation_M2::CSkeletonVertex(coords2);

  CPPUNIT_ASSERT(vertex1->GetDegree() == 0);

  vtkALBAPolyDataDeformation_M2::CSkeletonEdge *e1;
  e1 = new vtkALBAPolyDataDeformation_M2::CSkeletonEdge(vertex1, vertex2);
