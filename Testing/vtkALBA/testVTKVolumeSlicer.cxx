...
int VolumeSlicerTest()
  //--------------------------------------------------------------------
{  
  vtkALBAVolumeSlicer         *slicer;
  vtkALBAVolumeSlicer         *pslicer;

  slicer = vtkALBAVolumeSlicer::New();
  pslicer = vtkALBAVolumeSlicer::New();
  ...
  vtkALBASmartPointer<vtkInteractorStyleSwitch> style;
  ...
  vtkALBASmartPointer<vtkImageData> idata;
  ...
  ALBA_TEST(slicer->GetWindow() == 800);
  ALBA_TEST(slicer->GetLevel() == -100);
