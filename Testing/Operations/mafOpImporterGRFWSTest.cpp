...
//-----------------------------------------------------------
void mafOpImporterGRFWSTest::TestDynamicAllocation() 
//-----------------------------------------------------------
{
  mafOpImporterGRFWS *importer = new mafOpImporterGRFWS();
  cppDEL(importer);
}
//-----------------------------------------------------------
void mafOpImporterGRFWSTest::TestStaticAllocation() 
//-----------------------------------------------------------
{
  mafOpImporterGRFWS importer; 
}

//-----------------------------------------------------------
void mafOpImporterGRFWSTest::TestRead() 
//-----------------------------------------------------------
{
	mafOpImporterGRFWS *importer=new mafOpImporterGRFWS("importer");
	importer->TestModeOn();
