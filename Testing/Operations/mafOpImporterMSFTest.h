...
Module:    $RCSfile: mafOpImporterMSFTest.h,v $
Language:  C++
Date:      $Date: 2008-05-07 10:19:42 $
...
class mafOpImporterMSFTest : public CPPUNIT_NS::TestFixture
{
public:
  ...
  CPPUNIT_TEST_SUITE( mafOpImporterMSFTest );
