...
*/  
//----------------------------------------------------------------------------
void mafGeometryEditorPolylineGraphTest::CreateExampleGraph()
//------------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafGeometryEditorPolylineGraphTest::TestDynamicAllocation()
//----------------------------------------------------------------------------
{
	mafGeometryEditorPolylineGraph *PolylineGraph = new mafGeometryEditorPolylineGraph(NULL,NULL,NULL,true);
	cppDEL(PolylineGraph);
}
//----------------------------------------------------------------------------
void mafGeometryEditorPolylineGraphTest::TestStaticAllocation()
//----------------------------------------------------------------------------
{
	
}
//----------------------------------------------------------------------------
void mafGeometryEditorPolylineGraphTest::TestAddNewVertex1()
//----------------------------------------------------------------------------
{
	mafGeometryEditorPolylineGraph *PolylineGraph = new mafGeometryEditorPolylineGraph(NULL,NULL,NULL,true);
...
//----------------------------------------------------------------------------
void mafGeometryEditorPolylineGraphTest::TestAddBranch()
//----------------------------------------------------------------------------
{
	mafGeometryEditorPolylineGraph *PolylineGraph = new mafGeometryEditorPolylineGraph(NULL,NULL,NULL,true);
