...
Module:    $RCSfile: mafOpExporterBMPTest.cpp,v $
Language:  C++
Date:      $Date: 2008-06-18 09:33:02 $
...
//-----------------------------------------------------------
{
  ...
  importerVTK->ImportVTK();
	...
	mafString filenameDir = MAF_DATA_ROOT;
  filenameDir << "/Test_ExporterBMP";
  ...
  filenameExporter << "/Test_ExporterBMP_1024x1024_0002.bmp";
  ...
  mafString filenameOriginal = filenameDir;
  filenameOriginal << "/Bn_2295_bc_0012.bmp"; ///
