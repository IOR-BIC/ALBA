...
//-----------------------------------------------------------
{
  ...
  importerVTK->ImportFile();
	...
	//delete the directory where the bmp files will be exported
  ...
  filenameExporter << "\\VolTestImages_1024x1024_0002.bmp";
  ...
  filenameOriginal << "/Test_ExporterImages/Image_02.bmp"; ///
