...
//-----------------------------------------------------------
void mafOpExporterGRFWSTest::TestDynamicAllocation() 
//-----------------------------------------------------------
{
...
//-----------------------------------------------------------
void mafOpExporterGRFWSTest::TestStaticAllocation() 
//-----------------------------------------------------------
{
  mafOpExporterGRFWS Exporter; 
}
//-----------------------------------------------------------
void mafOpExporterGRFWSTest::TestWrite() 
//-----------------------------------------------------------
{
	mafOpExporterGRFWS *Exporter = new mafOpExporterGRFWS("Exporter");
	Exporter->TestModeOn();
...
//-----------------------------------------------------------
void mafOpExporterGRFWSTest::TestWriteFast() 
//-----------------------------------------------------------
{
  mafOpExporterGRFWS *Exporter = new mafOpExporterGRFWS("Exporter");
  Exporter->TestModeOn();
...
//-----------------------------------------------------------
void mafOpExporterGRFWSTest::TestWriteSingleVector() 
//-----------------------------------------------------------
{
	mafOpExporterGRFWS *Exporter = new mafOpExporterGRFWS("Exporter");
	Exporter->TestModeOn();
...
//-----------------------------------------------------------
void mafOpExporterGRFWSTest::TestWriteSingleVectorFast() 
//-----------------------------------------------------------
{
  mafOpExporterGRFWS *Exporter = new mafOpExporterGRFWS("Exporter");
	Exporter->TestModeOn();
