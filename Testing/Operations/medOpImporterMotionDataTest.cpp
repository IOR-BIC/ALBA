/*=========================================================================
 ...
 Program: MAF2Medical
 Module: medOpImporterMotionDataTest
...
#include "medopImporterMotionDataTest.h"
...
//-----------------------------------------------------------
void medopImporterMotionDataTest::TestDynamicAllocation() 
//-----------------------------------------------------------
{
...
//-----------------------------------------------------------
void medopImporterMotionDataTest::TestCopy() 
//-----------------------------------------------------------
{
  medOpImporterMotionData<mafVMERawMotionData> *importer = new medOpImporterMotionData<mafVMERawMotionData>("Raw Motion Data", "RAW Motion Data (*.MAN)|*.MAN", "Dictionary (*.txt)|*.txt");
  medOpImporterMotionData<mafVMERawMotionData> *importer_copy = NULL;

  importer->TestModeOn();
  importer_copy = ((medOpImporterMotionData<mafVMERawMotionData>*)importer->Copy());
...
//-----------------------------------------------------------
void medopImporterMotionDataTest::TestOnRawMotionData() 
//-----------------------------------------------------------
{
  medOpImporterMotionData<mafVMERawMotionData> *importer = new medOpImporterMotionData<mafVMERawMotionData>("Raw Motion Data", "RAW Motion Data (*.MAN)|*.MAN", "Dictionary (*.txt)|*.txt");
  importer->TestModeOn();
