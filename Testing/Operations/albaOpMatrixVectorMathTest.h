...
#ifndef CPP_UNIT_albaOpMatrixVectorMathTest_H
#define CPP_UNIT_albaOpMatrixVectorMathTest_H

#include "albaTest.h"

class albaOpMatrixVectorMathTest : public albaTest
{
  CPPUNIT_TEST_SUITE( albaOpMatrixVectorMathTest );
