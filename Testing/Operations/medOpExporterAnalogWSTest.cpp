...
Module:    $RCSfile: medOpExporterAnalogWSTest.cpp,v $
Language:  C++
...
#include "medOpExporterAnalogWSTest.h"
...
//-----------------------------------------------------------
void medOpExporterAnalogWSTest::TestDynamicAllocation() 
//-----------------------------------------------------------
{
...
//-----------------------------------------------------------
void medOpExporterAnalogWSTest::TestStaticAllocation() 
//-----------------------------------------------------------
{
  medOpExporterAnalogWS Exporter; 
}

//-----------------------------------------------------------
void medOpExporterAnalogWSTest::TestWrite() 
//-----------------------------------------------------------
{
	medOpExporterAnalogWS *Exporter = new medOpExporterAnalogWS("Exporter");
	Exporter->TestModeOn();
