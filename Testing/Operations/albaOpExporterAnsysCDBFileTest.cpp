...
Program: ALBA
Module: albaOpExporterAnsysCDBFileTest.cpp
...
//----------------------------------------------------------------------------------------
void albaOpExporterAnsysCDBFileTest::TestAnsysCDBFile_FileExist()
{
  Check_CDBFile("mesh1.cdb");
}

//----------------------------------------------------------------------------------------
void albaOpExporterAnsysCDBFileTest::TestAnsysCDBFile_ReadData()
{
  CompareCDBFilesData("mesh2.cdb");
}

//----------------------------------------------------------------------------------------
void albaOpExporterAnsysCDBFileTest::TestAnsysCDBFile_AutoFillData()
{
  CompareCDBFilesData("mesh3.cdb");
}

//----------------------------------------------------------------------------------------
void albaOpExporterAnsysCDBFileTest::Check_CDBFile(albaString fileName)
{
	albaVMEStorage *storage = albaVMEStorage::New();
	albaVME *root = (albaVME *)storage->GetRoot();

  albaString filePath= ALBA_DATA_ROOT;
  filePath<<"/albaOpExporterAnsysCDBFileTest/";
  ...
  // Export
  albaOpExporterAnsysCDBFile *exporter = new albaOpExporterAnsysCDBFile();
  exporter->TestModeOn();
...
//----------------------------------------------------------------------------------------
void albaOpExporterAnsysCDBFileTest::CompareCDBFilesData(albaString fileName)
{
	albaVMEStorage *storage = albaVMEStorage::New();
	albaVME *root = (albaVME *)storage->GetRoot();
