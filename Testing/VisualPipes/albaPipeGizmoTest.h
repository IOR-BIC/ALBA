...
#ifndef __CPP_UNIT_albaPipeGizmoTest_H__
#define __CPP_UNIT_albaPipeGizmoTest_H__
...
class albaPipeGizmoTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeGizmoTest );
