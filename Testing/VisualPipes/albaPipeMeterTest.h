...
#ifndef __CPP_UNIT_albaPipeMeterTest_H__
#define __CPP_UNIT_albaPipeMeterTest_H__
...
class albaPipeMeterTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeMeterTest );
