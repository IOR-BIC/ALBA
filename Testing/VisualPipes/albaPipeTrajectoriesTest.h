...
#ifndef __CPP_UNIT_albaPipeTrajectoriesTest_H__
#define __CPP_UNIT_albaPipeTrajectoriesTest_H__
...
class albaPipeTrajectoriesTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeTrajectoriesTest );
