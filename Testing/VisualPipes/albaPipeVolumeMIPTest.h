...
#ifndef __CPP_UNIT_albaPipeVolumeMIPTest_H__
#define __CPP_UNIT_albaPipeVolumeMIPTest_H__
...
class albaPipeVolumeMIPTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeVolumeMIPTest );
