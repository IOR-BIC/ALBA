...
#ifndef __CPP_UNIT_albaPipeWrappedMeterTest_H__
#define __CPP_UNIT_albaPipeWrappedMeterTest_H__
...
class albaPipeWrappedMeterTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeWrappedMeterTest );
