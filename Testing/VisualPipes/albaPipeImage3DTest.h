...
#ifndef __CPP_UNIT_albaPipeImage3DTest_H__
#define __CPP_UNIT_albaPipeImage3DTest_H__
...
class albaPipeImage3DTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeImage3DTest );
