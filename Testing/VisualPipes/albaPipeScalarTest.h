...
#ifndef __CPP_UNIT_albaPipeScalarTest_H__
#define __CPP_UNIT_albaPipeScalarTest_H__
...
class albaPipeScalarTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeScalarTest );
