...
#ifndef __CPP_UNIT_albaPipeSurfaceEditorTest_H__
#define __CPP_UNIT_albaPipeSurfaceEditorTest_H__
...
class albaPipeSurfaceEditorTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeSurfaceEditorTest );
