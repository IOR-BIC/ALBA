...
#ifndef __CPP_UNIT_albaVisualPipePolylineGraphTest_H__
#define __CPP_UNIT_albaVisualPipePolylineGraphTest_H__
...
class albaVisualPipePolylineGraphTest : public albaTest
{
public: 
  ...
  CPPUNIT_TEST_SUITE( albaVisualPipePolylineGraphTest );
