...
//----------------------------------------------------------------------------
void albaPipeVolumeArbSliceTest::TestFixture()
//----------------------------------------------------------------------------
{
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
void albaPipeVolumeArbSliceTest::TestPipeExecution()
//----------------------------------------------------------------------------
{
  ...
  for (int direction = albaPipeVolumeArbSlice::SLICE_X ; direction<=albaPipeVolumeArbSlice::SLICE_Z;direction++)
  {
    /////////// Pipe Instance and Creation ///////////
    albaPipeVolumeArbSlice *pipeSlice = new albaPipeVolumeArbSlice;
    ...
    switch(direction)
    {
    case albaPipeVolumeArbSlice::SLICE_X:
      {
        //x=-1 ;y=0; z=0; vx=0; vy=0; vz=1;
        x=1 ;y=0; z=0; vx=0; vy=0; vz=1;
      }
      break;
    case albaPipeVolumeArbSlice::SLICE_Y:
      {
        x=0; y=-1; z=0; vx=0; vy=0; vz=1;
      }
      break;
    case albaPipeVolumeArbSlice::SLICE_Z:
      {
...
//----------------------------------------------------------------------------
void albaPipeVolumeArbSliceTest::TestPipeExecution_SetSliceOpacity()
//----------------------------------------------------------------------------
{
  ////// Create VME (import vtkData) ////////////////////
  vtkStructuredPointsReader *importer;
...
//----------------------------------------------------------------------------
void albaPipeVolumeArbSliceTest::TestPipeExecution_SetLutRange()
//----------------------------------------------------------------------------
{
  ////// Create VME (import vtkData) ////////////////////
  vtkStructuredPointsReader *importer;
...
//----------------------------------------------------------------------------
void albaPipeVolumeArbSliceTest::TestPipeExecution_SetColorLookupTable()
{
  ////// Create VME (import vtkData) ////////////////////
  vtkStructuredPointsReader *importer;
  vtkNEW(importer);
...
//----------------------------------------------------------------------------
void albaPipeVolumeArbSliceTest::TestPipeExecution_TicksOnOff()
//----------------------------------------------------------------------------
{
  ////// Create VME (import vtkData) ////////////////////
  vtkStructuredPointsReader *importer;
  ...
  int direction = albaPipeVolumeArbSlice::SLICE_X;
...
//----------------------------------------------------------------------------
void albaPipeVolumeArbSliceTest::TestPipeExecution_Arbitrary()
//----------------------------------------------------------------------------
{
	////// Create VME (import vtkData) ////////////////////
	vtkStructuredPointsReader *importer;
	...
	int direction = albaPipeVolumeArbSlice::SLICE_ARB;
