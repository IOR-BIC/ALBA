...
#ifndef __CPP_UNIT_albaPipeGraphTest_H__
#define __CPP_UNIT_albaPipeGraphTest_H__
...
class albaPipeGraphTest : public albaTest
{
public: 
  ...
  CPPUNIT_TEST_SUITE( albaPipeGraphTest );
