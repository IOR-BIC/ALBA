...
#ifndef __CPP_UNIT_albaPipeSurfaceTest_H__
#define __CPP_UNIT_albaPipeSurfaceTest_H__
...
class albaPipeSurfaceTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeSurfaceTest );
