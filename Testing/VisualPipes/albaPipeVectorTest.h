...
#ifndef __CPP_UNIT_albaPipeVectorTest_H__
#define __CPP_UNIT_albaPipeVectorTest_H__
...
class albaPipeVectorTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeVectorTest );
