...
#ifndef __CPP_UNIT_albaPipeRayCastTest_H__
#define __CPP_UNIT_albaPipeRayCastTest_H__
...
class albaPipeRayCastTest : public albaTest
{
  public: 
  ...
  void AfterTest();
	...
	CPPUNIT_TEST_SUITE( albaPipeRayCastTest );
