...
#ifndef __CPP_UNIT_albaPipePolylineSliceTest_H__
#define __CPP_UNIT_albaPipePolylineSliceTest_H__
...
class albaPipePolylineSliceTest : public albaTest
{
public: 
  ...
  CPPUNIT_TEST_SUITE( albaPipePolylineSliceTest );
