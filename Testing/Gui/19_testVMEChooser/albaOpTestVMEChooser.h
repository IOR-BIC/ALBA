...
=========================================================================*/
#ifndef __albaOpTestVMEChooser_H__
#define __albaOpTestVMEChooser_H__
//----------------------------------------------------------------------------
// Include:
//----------------------------------------------------------------------------
#include "albaOp.h"
...
// ============================================================================
class albaOpTestVMEChooser : public albaOp
// ============================================================================
{
public:
                albaOpTestVMEChooser(wxString label);
               ~albaOpTestVMEChooser();
...
#endif // __albaOpTestVMEChooser_H__
