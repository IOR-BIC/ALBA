...
#ifndef __CPP_UNIT_medGUIDicomSettingsTest_H__
#define __CPP_UNIT_medGUIDicomSettingsTest_H__
...
class medGUIDicomSettingsTest : public CPPUNIT_NS::TestFixture
{
public: 
  ...
  CPPUNIT_TEST_SUITE( medGUIDicomSettingsTest );
...
main( int argc, char* argv[] )
{
  ...
  runner.addTest( medGUIDicomSettingsTest::suite());
