...
#ifndef __CPP_UNIT_medGUIWizardTest_H__
#define __CPP_UNIT_medGUIWizardTest_H__
...
public: 
  ...
  CPPUNIT_TEST_SUITE( medGUIWizardTest );
...
main( int argc, char* argv[] )
{
  ...
  runner.addTest( medGUIWizardTest::suite());
