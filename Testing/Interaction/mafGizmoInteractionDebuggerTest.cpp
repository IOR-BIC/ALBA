...
void mafGizmoInteractionDebuggerTest::TestConstructorDestructor()
{
	mafGizmoInteractionDebugger *gizmoInteractioDebugger = NULL;
	gizmoInteractioDebugger = new mafGizmoInteractionDebugger(m_GizmoInputSurface, NULL, "dummy", true);
