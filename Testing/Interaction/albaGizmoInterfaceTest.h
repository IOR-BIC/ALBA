...
#ifndef __CPP_UNIT_albaGizmoInterfaceTest_H__
#define __CPP_UNIT_albaGizmoInterfaceTest_H__
...
class albaGizmoInterfaceTest : public albaTest
{
  public:
  ...
  CPPUNIT_TEST_SUITE( albaGizmoInterfaceTest );
