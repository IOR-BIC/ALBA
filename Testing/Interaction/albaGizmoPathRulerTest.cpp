...
void albaGizmoPathRulerTest::BeforeTest()
{
	CreateTestData();
}

void albaGizmoPathRulerTest::AfterTest()
{
  albaDEL(m_TestPolyline);
  albaDEL(m_Root);
}

void albaGizmoPathRulerTest::CreateTestData()
//----------------------------------------------------------------------------
{
  m_Root = NULL;
  m_TestPolyline = NULL;
...
void albaGizmoPathRulerTest::TestConstructor()
{
  albaGizmoPathRuler *gp = new albaGizmoPathRuler(m_Root, NULL);
  cppDEL(gp);
}

void albaGizmoPathRulerTest::TestSetCurvilinearAbscissa()
{
...
void albaGizmoPathRulerTest::TestFixture()
{
