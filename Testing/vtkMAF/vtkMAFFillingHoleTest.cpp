...
//-------------------------------------------------------------------------
void vtkMAFFillingHoleTest::TestDynamicAllocation()
//-------------------------------------------------------------------------
{
  vtkMAFSmartPointer<vtkMAFFillingHole> filter1;

  vtkMAFFillingHole *filter2;
  vtkNEW(filter2);

  vtkDEL(filter2);
}
//-------------------------------------------------------------------------
void vtkMAFFillingHoleTest::TestSetFillAHole()
//-------------------------------------------------------------------------
{
  vtkMAFSmartPointer<vtkPolyDataReader> r;
  mafString filename=MAF_DATA_ROOT;
  filename<<"/Test_vtkMAFFillingHole/SphereWithHoles.vtk";
  ...
  vtkMAFSmartPointer<vtkMAFFillingHole> filter;
...
//-------------------------------------------------------------------------
void vtkMAFFillingHoleTest::TestSetFillAllHole()
//-------------------------------------------------------------------------
{
  vtkMAFSmartPointer<vtkPolyDataReader> r;
  mafString filename=MAF_DATA_ROOT;
...
//-------------------------------------------------------------------------
void vtkMAFFillingHoleTest::TestGetLastPatch()
//-------------------------------------------------------------------------
{
  vtkMAFSmartPointer<vtkPolyDataReader> r;
  mafString filename=MAF_DATA_ROOT;
