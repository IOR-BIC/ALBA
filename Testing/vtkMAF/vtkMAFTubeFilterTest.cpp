...
//----------------------------------------------------------------------------
void vtkMAFTubeFilterTest::TestInput()
{  
	vtkMAFSmartPointer<vtkMAFTubeFilter> filter;
...
//----------------------------------------------------------------------------
void vtkMAFTubeFilterTest::TestCapping()
{
	vtkMAFSmartPointer<vtkMAFTubeFilter> filter;
...
//----------------------------------------------------------------------------
void vtkMAFTubeFilterTest::TestNormals()
{  
	vtkMAFSmartPointer<vtkMAFTubeFilter> filter;
...
//----------------------------------------------------------------------------
void vtkMAFTubeFilterTest::TestTCoords()
{
	vtkMAFSmartPointer<vtkMAFTubeFilter> filter;
...
//----------------------------------------------------------------------------
void vtkMAFTubeFilterTest::TestRadius()
{
	vtkMAFSmartPointer<vtkMAFTubeFilter> filter;
...
//----------------------------------------------------------------------------
void vtkMAFTubeFilterTest::TestSides()
{
	vtkMAFSmartPointer<vtkMAFTubeFilter> filter;
...
//----------------------------------------------------------------------------
void vtkMAFTubeFilterTest::TestOldVersion()
{
	vtkMAFSmartPointer<vtkMAFTubeFilter> newFilter;
	vtkMAFSmartPointer<vtkTubeFilter> oldFilter;

	vtkMAFSmartPointer<vtkMAFLineStripSource> newLineStrip;
	vtkMAFSmartPointer<vtkMAFLineStripSource> oldLineStrip;
