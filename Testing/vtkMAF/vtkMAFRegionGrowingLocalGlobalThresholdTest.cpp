...
//-------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThresholdTest::TestDynamicAllocation()
//-------------------------------------------------------------------------
{
  m_Filter = vtkMAFRegionGrowingLocalGlobalThreshold::New();
  m_Filter->Delete();
}
//-------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThresholdTest::TestExecute()
//-------------------------------------------------------------------------
{
...
//-------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThresholdTest::TestComputeStandardDeviation()
//-------------------------------------------------------------------------
{
  int error;
  int indexNearest[26];
...
//-------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThresholdTest::TestComputeMeanValue()
//-------------------------------------------------------------------------
{
  int error;
  int indexNearest[26];
...
//-------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThresholdTest::TestSetOutputScalarType()
//-------------------------------------------------------------------------
{
  m_Filter = vtkMAFRegionGrowingLocalGlobalThreshold::New();
  m_Filter->SetInput(m_Image);
...
//-------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThresholdTest::TestBorderCreate()
//-------------------------------------------------------------------------
{
  vtkImageData *imBordered = vtkImageData::New();
