...
//------------------------------------------------------------------------------
// Test with 20 values
void vtkMAFPastValuesListTest::TestPastValues() 
//------------------------------------------------------------------------------
{
  int i ;
  ...
  vtkMAFPastValuesList *PastVals3 = new vtkMAFPastValuesList(3) ;
  for (i = 0 ;  i < 22 ;  i++){
  ...
  // At each step we check that the stats are correct.
  vtkMAFPastValuesList *PastVals4 = new vtkMAFPastValuesList(4) ;
  for (i = 0 ;  i < 22 ;  i++){
