...
//----------------------------------------------------------------------------
void albaVect3dTest::TestSetGetVector()
//----------------------------------------------------------------------------
{
  double vector[3];
  albaVect3d vect3d;
...
//----------------------------------------------------------------------------
void albaVect3dTest::TestOperators()
//----------------------------------------------------------------------------
{
  double vector1[3];
  double vector2[3];
  ...
  albaVect3d vect3d1(vector1);
  albaVect3d vect3d2(vector2);
...
//----------------------------------------------------------------------------
void albaVect3dTest::TestOperation2Vector()
//----------------------------------------------------------------------------
{
  double vector1[3];
  double vector2[3];
