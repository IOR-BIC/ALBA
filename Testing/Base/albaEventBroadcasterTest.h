...
#ifndef __CPP_UNIT_albaEventBroadcasterTest_H__
#define __CPP_UNIT_albaEventBroadcasterTest_H__

#include "albaTest.h"

/** Test for albaEventBase; Use this suite to trace memory problems */
class albaEventBroadcasterTest : public albaTest
{
public: 

  // CPPUNIT test suite
  CPPUNIT_TEST_SUITE( albaEventBroadcasterTest );
