...
//----------------------------------------------------------------------------
void mafVect3dTest::TestSetGetVector()
//----------------------------------------------------------------------------
{
  double vector[3];
  mafVect3d vect3d;
...
//----------------------------------------------------------------------------
void mafVect3dTest::TestOperators()
//----------------------------------------------------------------------------
{
  double vector1[3];
  double vector2[3];
  ...
  mafVect3d vect3d1(vector1);
  mafVect3d vect3d2(vector2);
...
//----------------------------------------------------------------------------
void mafVect3dTest::TestOperation2Vector()
//----------------------------------------------------------------------------
{
  double vector1[3];
  double vector2[3];
