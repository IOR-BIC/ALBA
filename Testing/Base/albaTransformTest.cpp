...
//----------------------------------------------------------------------------
void albaTransformTest::TestFixture()
//----------------------------------------------------------------------------
{
}

//----------------------------------------------------------------------------
void albaTransformTest::TestTranslateRotateScale()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaTransformTest::TestPolarDecomposition()
//----------------------------------------------------------------------------
{
  albaMatrix M;
  albaMatrix Q;
  ...
  albaMatrix::Multiply4x4(Q, S, QxS);
  ...
  albaMatrix::Invert(M, invM);
  albaMatrix::Multiply4x4(invM, QxS, invMxQxS);
  ...
  albaSmartPointer<albaTransform> pose1;
  pose1->SetPosition(10,10,10);


  albaSmartPointer<albaTransform> pose_parent;
  pose_parent->SetPosition(-10,-10,-10);

  albaSmartPointer<albaTransform> pose2;
  pose2->SetPosition(20,20,20);
  
  albaTransformFrame change_frame;
...
// TO BE PARTED!
//-------------------------------------------------------------------------
void albaTransformTest::ChangeRefSys()
//-------------------------------------------------------------------------
{
