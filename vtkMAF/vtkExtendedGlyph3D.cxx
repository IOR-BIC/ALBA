/*=========================================================================
  ...
  Module:    $RCSfile: vtkExtendedGlyph3D.cxx,v $
  Language:  C++
...
vtkCxxRevisionMacro(vtkExtendedGlyph3D, "$Revision: 1.1 $");
vtkStandardNewMacro(vtkExtendedGlyph3D);

// Construct object with scaling on, scaling mode is by scalar value,
// scale factor = 1.0, the range is (0,1), orient geometry is on, and
// orientation is by vector. Clamping and indexing are turned off. No
// initial sources are defined.
vtkExtendedGlyph3D::vtkExtendedGlyph3D()
{
  this->Scaling = 0;
...
void vtkExtendedGlyph3D::Execute()
{
  vtkPointData *pd;
...
void vtkExtendedGlyph3D::ExecuteInformation()
{
...
void vtkExtendedGlyph3D::SetNumberOfSources(int num)
{
  // one more because input has index 0.
  this->SetNumberOfInputs(num+1);
}

int vtkExtendedGlyph3D::GetNumberOfSources()
{
...
void vtkExtendedGlyph3D::SetSource(int id, vtkPolyData *pd)
{
  if (id < 0)
    {
...
vtkPolyData *vtkExtendedGlyph3D::GetSource(int id)
{
...
void vtkExtendedGlyph3D::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkExtendedGlyph3D::ComputeInputUpdateExtents( vtkDataObject *output )
{
  vtkPolyData *outPd;
