...
vtkMAFTubeFilter::vtkMAFTubeFilter()
{
	this->Radius = 0.5;
...
//----------------------------------------------------------------------------
void vtkMAFTubeFilter::CleanLine(vtkPoints *inPts, vtkIdType npts, vtkIdType *pts, vtkIdType &cleanNpts, vtkIdType *&cleanPts)
{
...
int vtkMAFTubeFilter::GeneratePoints(vtkIdType offset,
...
void vtkMAFTubeFilter::GenerateStrips(vtkIdType offset, vtkIdType npts,
...
void vtkMAFTubeFilter::GenerateTextureCoords(vtkIdType offset,
	vtkIdType npts, vtkIdType *pts,
	vtkPoints *inPts,
...
vtkIdType vtkMAFTubeFilter::ComputeOffset(vtkIdType offset, vtkIdType npts)
{
	if (this->SidesShareVertices)
	{
...
const char *vtkMAFTubeFilter::GetVaryRadiusAsString(void)
{
...
const char *vtkMAFTubeFilter::GetGenerateTCoordsAsString(void)
{
...
void vtkMAFTubeFilter::PrintSelf(ostream& os, vtkIndent indent)
{
