...
// Constructor 
//------------------------------------------------------------------------------
vtkMAFAddScalarsFilter::vtkMAFAddScalarsFilter()
...
// Set the color
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColor(double r, double g, double b)
{
  m_Color[0] = r ;
  m_Color[1] = g ;
  m_Color[2] = b ;
...
// Set the color
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColor(double col[3])
{
...
// Set the color
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColor(double r, double g, double b, double alpha)
{
  m_Color[0] = r ;
  m_Color[1] = g ;
  m_Color[2] = b ;
...
// Set the color
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColor(double col[3], double alpha)
{
...
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfCell(int cellId, double r, double g, double b)
{
...
// set color of cell, range 0-255
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfCell(int cellId, double col[3])
{
...
// set color of cell, range 0-255
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfCell(int cellId, double r, double g, double b, double alpha)
{
...
// set color of cell, range 0-255
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfCell(int cellId, double col[3], double alpha)
{
...
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfPoint(int ptId, double r, double g, double b)
{
...
// set color of point, range 0-255
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfPoint(int ptId, double col[3])
{
...
// set color of point, range 0-255
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfPoint(int ptId, double r, double g, double b, double alpha)
{
...
// set color of point, range 0-255
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetColorOfPoint(int ptId, double col[3], double alpha)
{
...
// Set the name
//------------------------------------------------------------------------------
void vtkMAFAddScalarsFilter::SetName(char* name)
{
  bool istop = false ;
  for (int i = 0 ;  !istop && i < 256 ;   i++){
