...
Module:    $RCSfile: vtkMEDLandmarkCloudPolydataFilter.h,v $
Language:  C++
...
#ifndef __vtkMEDLandmarkCloudPolydataFilter_h
...
//------------------------------------------------------------------------------
class VTK_vtkMAF_EXPORT vtkMEDLandmarkCloudPolydataFilter : public vtkPolyDataToPolyDataFilter 
{
public:
...
protected:
  ...
  std::vector<vtkMEDAddScalarsFilter*> m_AddScalarsList ; // filters which add color
...
private:
  vtkMEDLandmarkCloudPolydataFilter( vtkMEDLandmarkCloudPolydataFilter&);  // Not implemented.
  void operator=( vtkMEDLandmarkCloudPolydataFilter&);  // Not implemented.
};
