...
#ifndef __vtkMAFDeformableSimplexMesh3DFilter_h 
#define __vtkMAFDeformableSimplexMesh3DFilter_h
...
//-----------------------------------------------------------------------------
/// vtkMAFDeformableSimplexMesh3DFilter \n
...
namespace itk
{
  ...
  class vtkMAFDeformableSimplexMeshFilter :
    public DeformableSimplexMesh3DFilter< TInputMesh, TOutputMesh >
  {
  public:
    /** Standard "Self" typedefs. */
    typedef vtkMAFDeformableSimplexMeshFilter Self;
    ...
    itkTypeMacro(vtkMAFDeformableSimplexMeshFilter, DeformableSimplexMesh3DFilter);
  ...
  protected:
    ...
    ~vtkMAFDeformableSimplexMeshFilter();
    vtkMAFDeformableSimplexMeshFilter(const Self &) {}
  ...
  //-----------------------------------------------------------------------------
  template< class TInputMesh, class TOutputMesh >
  class vtkMAFDeformableSimplexMeshFilter<TInputMesh, TOutputMesh > 
    ::CatheterCalculator
  {
  public:
    /// Constructor
  ...
  public:
    ...
    void SaveLengthsOfCells(int step, const vtkMAFStentModelSource::SimplexMeshType *mesh) ;
...
#include "vtkMAFDeformableSimplexMeshFilter_Impl.h"
