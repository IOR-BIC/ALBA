/*=========================================================================
 ...
 Program: MAF2
 Module: vtkMAFPoissonSurfaceReconstruction
 Authors: Fuli Wu
...
#ifndef __vtkMAFPoissonSurfaceReconstruction_h
#define __vtkMAFPoissonSurfaceReconstruction_h
...
/**
class name: vtkMAFPoissonSurfaceReconstruction
...
protected:
  /** constructor */
  vtkMAFPoissonSurfaceReconstruction();
  /** destructor */
  ~vtkMAFPoissonSurfaceReconstruction();
...
private:
  ...
  vtkMAFPoissonSurfaceReconstruction(const vtkMAFPoissonSurfaceReconstruction&);
  /** operator= non implemented */
  void operator=(const vtkMAFPoissonSurfaceReconstruction&);
};
