...
Module:    $RCSfile: vtkMAFRegionGrowingLocalGlobalThreshold.cxx,v $
...
//----------------------------------------------------------------------------
vtkMAFRegionGrowingLocalGlobalThreshold::vtkMAFRegionGrowingLocalGlobalThreshold()
//----------------------------------------------------------------------------
{
  UpperLabel = 1;
  LowerLabel = -1;
...
//----------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThreshold::PrintSelf(ostream& os, vtkIndent indent)
//----------------------------------------------------------------------------
{
  this->Superclass::PrintSelf(os, indent);
}
//----------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThreshold::ComputeIndexNearstPoints(int index, int indexNearest[26] , int &error, vtkImageData *imBordered)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
double vtkMAFRegionGrowingLocalGlobalThreshold::ComputeStandardDeviation(int index, int indexNearest[26] , double mean, int &error, vtkImageData *imBordered)
//----------------------------------------------------------------------------
{
  vtkImageData *image = NULL;
  if (imBordered != NULL)
...
//----------------------------------------------------------------------------
double vtkMAFRegionGrowingLocalGlobalThreshold::ComputeMeanValue(int index, int indexNearest[26] , int &error, vtkImageData *imBordered)
//----------------------------------------------------------------------------
{
  vtkImageData *image = NULL;
  if (imBordered != NULL)
...
//----------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThreshold::BorderCreate(vtkImageData *imToApplyBorder)
//----------------------------------------------------------------------------
{
  vtkImageData *inputIM = Input;
  inputIM->Update();
...
//----------------------------------------------------------------------------
void vtkMAFRegionGrowingLocalGlobalThreshold::Update()
//----------------------------------------------------------------------------
{
  vtkImageData *inputIM = Input;
  inputIM->Update();
