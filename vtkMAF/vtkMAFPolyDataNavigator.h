...
Module:    $RCSfile: vtkMAFPolyDataNavigator.h,v $
Language:  C++
...
#ifndef __vtkMAFPolyDataNavigator_h
#define __vtkMAFPolyDataNavigator_h
...
//------------------------------------------------------------------------------
class MAF_EXPORT vtkMAFPolyDataNavigator : public vtkObject
{
public:
...
protected:
  vtkMAFPolyDataNavigator() ; ///< constructor
  ~vtkMAFPolyDataNavigator() ; ///< deconstructor
...
//------------------------------------------------------------------------------
class vtkMAFPolyDataNavigator::Edge
{
public:
