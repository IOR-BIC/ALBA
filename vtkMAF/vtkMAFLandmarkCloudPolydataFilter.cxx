...
// Constructor 
//------------------------------------------------------------------------------
vtkMAFLandmarkCloudPolydataFilter::vtkMAFLandmarkCloudPolydataFilter()
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::Clear()
{
...
//------------------------------------------------------------------------------
int vtkMAFLandmarkCloudPolydataFilter::AddLandmark(int ptId)
{
  double x[3] = {0,0,0} ;
...
// Add single point from polydata
//------------------------------------------------------------------------------
int vtkMAFLandmarkCloudPolydataFilter::AddLandmark(int ptId, double col[3])
{
...
// Add single point from polydata
//------------------------------------------------------------------------------
int vtkMAFLandmarkCloudPolydataFilter::AddLandmark(int ptId, double r, double g, double b)
{
  int i = AddLandmark(ptId) ;
  SetColor(i,r,g,b); 
  return i ;
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::AddLandmarks(vtkIdList* ptIds)
{
...
// Add list of points from polydata
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::AddLandmarks(vtkIdList* ptIds, double col[3])
{
  for (int i = 0 ;  i < ptIds->GetNumberOfIds() ;  i++){
    int id = ptIds->GetId(i) ;
...
// Add list of points from polydata
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::AddLandmarks(vtkIdList* ptIds, double r, double g, double b)
{
  for (int i = 0 ;  i < ptIds->GetNumberOfIds() ;  i++){
    int id = ptIds->GetId(i) ;
    int j = AddLandmark(id) ;
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::DeleteLastLandmark()
{
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetThetaPhiResolution(int thetaRes, int phiRes)
{
  m_ThetaRes = thetaRes ;
  m_PhiRes = phiRes ;
...
// Set radius
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetRadius(double r)
{
  m_Radius = r ;
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::MultiplyRadius(double f)
{
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetRadiusAuto(vtkPolyData* polydata)
{
...
// Get radius
//------------------------------------------------------------------------------
double vtkMAFLandmarkCloudPolydataFilter::GetRadius() const
{
  return m_Radius ;
}
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetColor(double col[3])
{
  for (int i = 0  ;  i < GetNumberOfLandmarks() ;  i++)
    SetColor(i,col) ;
}
...
// Set color of all landmarks
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetColor(double r, double g, double b)
{
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetColor(int i, double r, double g, double b)
{    
...
// Set color of landmark i
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetColor(int i, double col[3])
{    
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetPosition(int i, double x[3])
{
...
// Set position of landmark i
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::SetPosition(int i, double x, double y, double z)
{
...
//------------------------------------------------------------------------------
void vtkMAFLandmarkCloudPolydataFilter::GetPosition(int i, double x[3]) const
{
...
// Get position of landmark i
//------------------------------------------------------------------------------
const double* vtkMAFLandmarkCloudPolydataFilter::GetPosition(int i) const
{
...
//------------------------------------------------------------------------------
bool vtkMAFLandmarkCloudPolydataFilter::GetBounds(double b[6]) const
{
  int n = GetNumberOfLandmarks() ;
  if (n == 0)
    return false ;
...
//------------------------------------------------------------------------------
bool vtkMAFLandmarkCloudPolydataFilter::GetCenter(double x[3]) const
{
  double b[6] ;
  bool ok = GetBounds(b) ;
  if (!ok)
...
//------------------------------------------------------------------------------
bool vtkMAFLandmarkCloudPolydataFilter::GetCentroid(double x[3]) const
{
  int n = GetNumberOfLandmarks() ;
  if (n == 0)
    return false ;
