...
//------------------------------------------------------------------------------
// Constructor
vtkMAFExtrudeToCircle::vtkMAFExtrudeToCircle() : m_DefinedLength(false), m_DefinedDirection(false), m_DefinedVector(false),
...
//------------------------------------------------------------------------------
// Destructor
vtkMAFExtrudeToCircle::~vtkMAFExtrudeToCircle()
//------------------------------------------------------------------------------
{  
  if (m_Mesh != NULL)
    delete m_Mesh ;
...
void vtkMAFExtrudeToCircle::Initialize()
//------------------------------------------------------------------------------
{
  if (m_Mesh != NULL){
    delete m_Mesh ;
...
void vtkMAFExtrudeToCircle::SetLength(double len)
//------------------------------------------------------------------------------
{
  // set the length
  m_Length = len ;
...
void vtkMAFExtrudeToCircle::SetDirection(const double *direc)       
//------------------------------------------------------------------------------
{
...
// Set the direction of extrusion.
// The direction does not have to be normalised.
void vtkMAFExtrudeToCircle::SetDirection(double x, double y, double z)       
//------------------------------------------------------------------------------
{
  // copy vector and normalize
  m_Direction[0] = x ;
...
void vtkMAFExtrudeToCircle::SetExtrusionPoint(const double *extrPoint)
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::SetExtrusionVector(const double *extrVector)
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::SetMinNumberofEndPoints(int minNumEndPoints)
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::SetDirectionToDefault(int directionSign)      
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::CalculateExtrusionVector()
//------------------------------------------------------------------------------
{
  if (m_DefinedVector){
...
void vtkMAFExtrudeToCircle::CalcHoleParameters(vtkPolyData *hole)
//------------------------------------------------------------------------------
{
  int i, j ;
  double sumsq, x[3] ;
  ...
  vtkIdType *ptlist ;
  double pt0[3], pt1[3] ;
  vtkMAFPastValuesList vecProd0(1000), vecProd1(1000), vecProd2(1000) ;
...
void vtkMAFExtrudeToCircle::CalcUpVector(vtkIdList *holepts)
//------------------------------------------------------------------------------
{
  double x[3] ;
  int ptId ;
...
void vtkMAFExtrudeToCircle::CalcExtrusionRings()
//------------------------------------------------------------------------------
{
  int i, k ;
...
void vtkMAFExtrudeToCircle::CalcExtrusionVertices()
//------------------------------------------------------------------------------
{
  int i, j ;
...
void vtkMAFExtrudeToCircle::VerticesToVtkPoints(vtkPoints *points) const
//------------------------------------------------------------------------------
{
  int i, j, k, totalpts ;
...
void vtkMAFExtrudeToCircle::VerticesToVtkTriangles(vtkCellArray *triangles) const
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::CalcCylinderCoords(const double *x, const double *centre, const double *cylAxis, const double *upVector, 
...
// cylAxis and upVector do not have to be normalised.
// upVector does not have to be exactly normal to cylAxis.
void vtkMAFExtrudeToCircle::CalcCartesianCoords(double r, double phi, double z, const double *centre, const double *cylAxis, const double *upVector, double *x) const 
//------------------------------------------------------------------------------
{
  // Get normalised central axis
  double u[3], v[3], w[3] ;
...
void vtkMAFExtrudeToCircle::GetMatRotArrowToAxis(vtkMatrix4x4 *mat, const double *u) const 
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::GetPointsAroundHole(vtkPolyData *hole, vtkIdList *pts) const 
//------------------------------------------------------------------------------
{
  int i ;
...
int vtkMAFExtrudeToCircle::CalcSenseOfPointsAroundHole(vtkIdList *holepts, const double *centre, const double *cylAxis, const double *upVector) const
//------------------------------------------------------------------------------
{
  int j ;
  double r, phi, z ;
...
void vtkMAFExtrudeToCircle::Remove2PiArtefactsFromFirstRing()
//------------------------------------------------------------------------------
{
  int j ;
...
//------------------------------------------------------------------------------
// Reverse id list
void vtkMAFExtrudeToCircle::ReverseIdList(vtkIdList *pts) const
//------------------------------------------------------------------------------
{
  int j, jj ;
...
void vtkMAFExtrudeToCircle::CircularShiftIdList(vtkIdList *pts, int shift) const
//------------------------------------------------------------------------------
{
  int j, jj ;
  int n = pts->GetNumberOfIds() ;
...
inline int vtkMAFExtrudeToCircle::Modulo(int n, int m) const
//------------------------------------------------------------------------------
{
  if (n >= 0)
    return n % m ;
...
//------------------------------------------------------------------------------
// Copy vector
void vtkMAFExtrudeToCircle::CopyVector(const double *a, double *b) const
//------------------------------------------------------------------------------
{
  b[0] = a[0] ;
  b[1] = a[1] ;
...
//------------------------------------------------------------------------------
// Set vector
void vtkMAFExtrudeToCircle::SetVector(double *vec, double x, double y, double z) const
//------------------------------------------------------------------------------
{
  vec[0] = x ;
  vec[1] = y ;
...
//------------------------------------------------------------------------------
// Add vector
void vtkMAFExtrudeToCircle::AddVector(const double *vin, const double *x, double *vout) const
//------------------------------------------------------------------------------
{
  vout[0] = vin[0] + x[0] ;
  vout[1] = vin[1] + x[1] ;
...
//------------------------------------------------------------------------------
// Subtract vector
void vtkMAFExtrudeToCircle::SubtractVector(const double *vin, const double *x, double *vout) const
//------------------------------------------------------------------------------
{
  vout[0] = vin[0] - x[0] ;
  vout[1] = vin[1] - x[1] ;
...
void vtkMAFExtrudeToCircle::MultVectorByScalar(double s, const double *vin, double *vout) const
//------------------------------------------------------------------------------
{
  vout[0] = s*vin[0] ;
  vout[1] = s*vin[1] ;
...
//------------------------------------------------------------------------------
// Get norm of vector
double vtkMAFExtrudeToCircle::GetNorm(const double *vec) const
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Normalize vector
void vtkMAFExtrudeToCircle::Normalize(const double *vin, double *vout) const
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::CrossProduct(const double *a, const double *b, double *c) const
//------------------------------------------------------------------------------
{
  c[0] =   a[1]*b[2] - a[2]*b[1] ;
  c[1] = -(a[0]*b[2] - a[2]*b[0]) ;
...
double vtkMAFExtrudeToCircle::DotProduct(const double *a, const double *b) const
//------------------------------------------------------------------------------
{
...
void vtkMAFExtrudeToCircle::InverseSolveTransform(const double *u, const double *v, const double *w, const double *y, double *x) const
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Print self
void vtkMAFExtrudeToCircle::PrintSelf(ostream& os, vtkIndent indent) const
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Print self
void vtkMAFExtrudeToCircle::MeshData::PrintSelf(ostream& os, vtkIndent indent) const
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Print self
void vtkMAFExtrudeToCircle::RingData::PrintSelf(ostream& os, vtkIndent indent) const
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Print self
void vtkMAFExtrudeToCircle::VertexData::PrintSelf(ostream& os, vtkIndent indent) const
//------------------------------------------------------------------------------
{
