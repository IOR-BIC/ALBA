/*=========================================================================
  ...
  Module:    $RCSfile: vtkMAFImageUnsharpFilter.cxx,v $
...
=========================================================================*/
#include "vtkMAFImageUnsharpFilter.h"
...
//----------------------------------------------------------------------------
vtkMAFImageUnsharpFilter::vtkMAFImageUnsharpFilter()
{
}
...
//----------------------------------------------------------------------------
void vtkMAFImageUnsharpFilter::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkMAFImageUnsharpFilter::ThreadedExecute(vtkImageData *inData, 
