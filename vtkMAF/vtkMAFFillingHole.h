...
#ifndef __vtkMAFFillingHole_h
#define __vtkMAFFillingHole_h
...
private:
  ...
  vtkMAFFillingHole(const vtkMAFFillingHole&); 
  /** operator= not implemented */
  void operator=(const vtkMAFFillingHole&);  
};
