...
vtkMAFDataArrayDescriptor::vtkMAFDataArrayDescriptor()
{
...
void vtkMAFDataArrayDescriptor::SetName(const char* name)
{
	delete[] this->Name;
	this->Name = 0;
	if (name)
...
const char* vtkMAFDataArrayDescriptor::GetName()
{
	return this->Name;
}

/*static*/ int vtkMAFDataArrayDescriptor::GetDataTypeSize(int dataType)
{	
	switch (dataType)
	{
...
void vtkMAFDataArrayDescriptor::GetDataTypeRange(double range[2])
{
	range[0] = this->GetDataTypeMin();
	range[1] = this->GetDataTypeMax();
}

double vtkMAFDataArrayDescriptor::GetDataTypeMin()
{
...
double vtkMAFDataArrayDescriptor::GetDataTypeMax()
{
	int dataType=this->GetDataType();
	switch (dataType)
	{
...
void vtkMAFDataArrayDescriptor::PrintSelf(ostream& os, vtkIndent indent)
{
