...
Module:    $RCSfile: vtkMAFImplicitPolyDataTest.cpp,v $
Language:  C++
Date:      $Date: 2009-06-03 12:29:56 $
...
void vtkMAFImplicitPolyDataTest::RenderData( vtkPolyData *data )
{
...
void vtkMAFImplicitPolyDataTest::TestEvaluateGradient()
{
  ...
  vtkMAFImplicitPolyData *ip = vtkMAFImplicitPolyData::New();
...
void vtkMAFImplicitPolyDataTest::TestEvaluateFunction()
{
...
void vtkMAFImplicitPolyDataTest::TestSetInput()
{
  vtkMAFImplicitPolyData *ip = vtkMAFImplicitPolyData::New();
...
void vtkMAFImplicitPolyDataTest::TestConstructorDestructor()
{
  vtkMAFImplicitPolyData *ip = vtkMAFImplicitPolyData::New();
...
void vtkMAFImplicitPolyDataTest::TestSetGetNoValue()
{
  vtkMAFImplicitPolyData *ip = vtkMAFImplicitPolyData::New();
  ip->SetNoValue(10);
...
void vtkMAFImplicitPolyDataTest::TestSetGetNoGradient()
{
  vtkMAFImplicitPolyData *ip = vtkMAFImplicitPolyData::New();
...
void vtkMAFImplicitPolyDataTest::TestGenerateOffsetSurfaceFromPolydata()
{
  vtkSphereSource *s = vtkSphereSource::New();
  s->SetThetaResolution( 6 );
  s->SetPhiResolution (  6 );
...
void vtkMAFImplicitPolyDataTest::TestUnionBetweenTwoPolydata()
{
