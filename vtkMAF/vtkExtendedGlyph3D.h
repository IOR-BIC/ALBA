/*=========================================================================
  ...
  Module:    $RCSfile: vtkExtendedGlyph3D.h,v $
  Language:  C++
  Date:      $Date: 2005-07-22 13:44:09 $
...
=========================================================================*/
// .NAME vtkExtendedGlyph3D - copy oriented and scaled glyph geometry to every input point
// .SECTION Description
// vtkExtendedGlyph3D is an extended version of vtkGlyph3D supporting visibility by scalar, 
...
#ifndef __vtkExtendedGlyph3D_h
#define __vtkExtendedGlyph3D_h
...
class VTK_vtkMAF_EXPORT vtkExtendedGlyph3D : public vtkDataSetToPolyDataFilter
{
public:
  vtkTypeRevisionMacro(vtkExtendedGlyph3D,vtkDataSetToPolyDataFilter);
...
private:
  vtkExtendedGlyph3D(const vtkExtendedGlyph3D&);  // Not implemented.
  void operator=(const vtkExtendedGlyph3D&);  // Not implemented.
};

/**
Return the method of scaling as a descriptive character string.*/
inline const char *vtkExtendedGlyph3D::GetScaleModeAsString(void)
{
...
inline const char *vtkExtendedGlyph3D::GetColorModeAsString(void)
{
...
inline const char *vtkExtendedGlyph3D::GetVectorModeAsString(void)
{
...
inline const char *vtkExtendedGlyph3D::GetIndexModeAsString(void)
{
