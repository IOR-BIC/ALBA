...
#include "vtkMAFHalfTubeRemoval.h"
...
// Constructor 
//------------------------------------------------------------------------------
vtkMAFHalfTubeRemoval::vtkMAFHalfTubeRemoval()
...
// Set the center line
//------------------------------------------------------------------------------
void vtkMAFHalfTubeRemoval::SetCenterLine(vtkPolyData* centerline)
{
...
//------------------------------------------------------------------------------
void vtkMAFHalfTubeRemoval::SetCameraPos(double camPos[3])
{
...
//------------------------------------------------------------------------------
void vtkMAFHalfTubeRemoval::SetRemovalModeOff()
{
...
//------------------------------------------------------------------------------
void vtkMAFHalfTubeRemoval::SetRemovalModeFront()
{
...
//------------------------------------------------------------------------------
void vtkMAFHalfTubeRemoval::SetRemovalModeBack()
{
...
void vtkMAFHalfTubeRemoval::SetViewingPositionAuto(double pos[3], double focus[3], double upVector[3])
{
  ...
  vtkMAFMatrixVectorMath* mvec = vtkMAFMatrixVectorMath::New() ;
...
//------------------------------------------------------------------------------
int vtkMAFHalfTubeRemoval::FindNearestPoint(const double p[3], double pnearest[3], double& rsq) const
{
  int n = m_CenterLine->GetPoints()->GetNumberOfPoints() ;
  assert(n > 0) ;
...
//------------------------------------------------------------------------------
double vtkMAFHalfTubeRemoval::DistSq(const double p[3], const double q[3]) const
{
...
//----------------------------------------------------------------------------
void vtkMAFHalfTubeRemoval::EigenVectors3x3(double A[3][3], double lambda[3], double V[3][3]) const
{
...
//------------------------------------------------------------------------------
void vtkMAFHalfTubeRemoval::PrincipalAxes(vtkPolyData* polydata, double u[3], double v[3], double w[3]) const
{
