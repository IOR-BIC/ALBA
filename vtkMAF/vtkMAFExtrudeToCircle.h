...
#ifndef __vtkMAFExtrudeToCircle_h
#define __vtkMAFExtrudeToCircle_h
...
protected:
  ...
  friend class vtkMAFExtrudeToCircleVertexDataTest;

} ;


//------------------------------------------------------------------------------
/// vtkMAFExtrudeToCircle::VertexData. \n
/// Private subclass for vertex position and index in polydata.
//------------------------------------------------------------------------------
class vtkMAFExtrudeToCircle::VertexData{
public:
...
//------------------------------------------------------------------------------
/// vtkMAFExtrudeToCircle::RingData.
/// Private subclass for ring of vertices.
//------------------------------------------------------------------------------
class vtkMAFExtrudeToCircle::RingData{
public:
...
//------------------------------------------------------------------------------
/// vtkMAFExtrudeToCircle::MeshData.
/// Private subclass for extrusion mesh
//------------------------------------------------------------------------------
class vtkMAFExtrudeToCircle::MeshData{
public:
