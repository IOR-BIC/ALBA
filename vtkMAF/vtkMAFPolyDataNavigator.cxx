...
Module:    $RCSfile: vtkMAFPolyDataNavigator.cxx,v $
Language:  C++
...
// Constructor
//------------------------------------------------------------------------------
vtkMAFPolyDataNavigator::vtkMAFPolyDataNavigator()
{
}
...
// Is id in set
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::InSet(int id,  const IdSet& idSet) const
{
...
// Is id not in set
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::NotInSet(int id,  const IdSet& idSet) const
{
  IdSet::const_iterator pos = idSet.find(id) ;
  return pos == idSet.end() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::InsertIdIntoList(int i, int id, vtkIdList *idList) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::DeleteLastId(vtkIdList *idList) const
{
  vtkIdList *tempList = vtkIdList::New() ;
  tempList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::ReverseIdList(vtkIdList *idList) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::AppendIdList(vtkIdList *idList,  vtkIdList *addList,  bool includeFirstId,  bool includeLastId) const
{
  int istart, ilast ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetIdsInBothLists(vtkIdList *idlist0,  vtkIdList *idlist1,  vtkIdList *idlist_out) const
{
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::FindIdInList(vtkIdList *idList,  int id,  int istart) const
{
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::FindAndReplaceIdInList(vtkIdList *idList,  int idold,  int idnew) const 
{
...
// Returns -1 if not found
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::FindIdPairFirstId(vtkIdList *idList,  int id0,  int id1) const
{
  int n = idList->GetNumberOfIds() ;
  for (int i = 0 ;  i < n ;  i++){
    int ii = (i+1)%n ;
...
// Returns -1 if not found
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::FindIdPairSecondId(vtkIdList *idList,  int id0,  int id1) const
{
  int n = idList->GetNumberOfIds() ;
  for (int i = 0 ;  i < n ;  i++){
    int ii = (i+1)%n ;
...
// Returns -1 if not found
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::InsertIdBetweenIds(vtkIdList *idList,  int id0,  int id1, int idNew) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPartOfIdList(vtkIdList *idList,  vtkIdList *idListOut,  int i0,  int i1,  bool forwards) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::InitListToTriangle(vtkIdList *list, int id0, int id1, int id2) const
{
  list->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyListToIdSet(vtkIdList *idList, IdSet& idSet) const
{
  idSet.clear() ;
...
// NB if an id appears twice in the id list, it will only copy once to the map.
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::AddListToIdSet(vtkIdList *idList, IdSet& idSet) const
{
  int n = idList->GetNumberOfIds() ;
  for (int i = 0 ;  i < n ;  i++){
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyIdSetToList(const IdSet& idSet, vtkIdList *idList) const
{
  idList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetIdsNotInList(vtkIdList* idsIn, vtkIdList* idsOut, int n)
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CyclicShiftIdList(vtkIdList *idList, int nsteps) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyVectorToList(const std::vector<int>& vlist, vtkIdList* idList, bool append) const
{
  if (!append)
    idList->Reset() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyListToVector(vtkIdList* idList, std::vector<int>& vlist, bool append) const
{
  if (!append)
    vlist.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SetIdListToAllPoints(vtkPolyData *polydata, vtkIdList *list) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SetIdListToAllCells(vtkPolyData *polydata, vtkIdList *list) const
{
...
// Get min id in list
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetMinIdInList(vtkIdList *list) const
{
...
// Get max id in list
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetMaxIdInList(vtkIdList *list) const
{
  int n = list->GetNumberOfIds() ;
  if (n == 0)
    return -1 ;
...
// Print id list
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintIdList(vtkIdList *idList, ostream& os) const
{
  for (int i = 0 ;  i < idList->GetNumberOfIds() ;  i++){
    os << idList->GetId(i) << " " ;
...
// Print id list
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintIdListCSV(vtkIdList *idList, ostream& os) const
{
  for (int i = 0 ;  i < idList->GetNumberOfIds() ;  i++){
    os << idList->GetId(i) << ", " ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::AddUniqueEdge(const Edge& edge, EdgeVector& edgeList) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::AddUniqueEdge(const Edge& edge, EdgeMultiMap& edgeMap) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyEdgeMapToVector(EdgeMultiMap& edgeMap, EdgeVector& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyVectorToEdgeMap(const EdgeVector& edges, EdgeMultiMap& edgeMap) const
{
  edgeMap.clear() ;
...
// Is edge in edge map
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::IsEdgeInMap(const EdgeMultiMap& edgeMap, const Edge& edge) const
{
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetNumberOfPointsOnCell(vtkPolyData *polydata, int cellId) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellPointsWithCoords(vtkPolyData *polydata, int cellId, vtkIdList* ptIds, double (*coords)[3])
{
...
// Get edges of cell
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellEdges(vtkPolyData *polydata, int cellId, EdgeVector& edges) const
{
  edges.clear() ;
...
//-----------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellNeighboursOfEdge(vtkPolyData *polydata, const Edge& edge, vtkIdList *idList) const
{
  idList->Initialize() ;
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetNumberOfCellsOnEdge(vtkPolyData *polydata, const Edge& edge) const
{
  // list cell neighbours of both endpoints of edge 
  vtkIdList *CellsOnPt0 = vtkIdList::New() ;
  vtkIdList *CellsOnPt1 = vtkIdList::New() ;
...
//-----------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetAdjacentPointsOnCell(vtkPolyData *polydata, int cellId, int ptId, int& ptId0, int& ptId1) const
{
...
//-----------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsOnCellNeighbours(vtkPolyData *polydata, int ptId, vtkIdList *idList) const
{
  idList->Initialize() ;
...
//-----------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointNeighboursOfPoint(vtkPolyData *polydata, int ptId, vtkIdList *idList) const
{
  idList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetEdgesAroundPointInclusive(vtkPolyData *polydata, int ptId, EdgeVector& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetEdgesAroundPointExclusive(vtkPolyData *polydata, int ptId, EdgeVector& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsAroundEdgeExclusive(vtkPolyData *polydata, const Edge& edge, vtkIdList *idList) const
{
  idList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetEdgesAroundEdge(vtkPolyData *polydata, const Edge& edge, EdgeVector& edges) const
{
  vtkIdList *cellIds = vtkIdList::New() ;
  EdgeVector edgesOnCellList ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetAllEdges(vtkPolyData *polydata, EdgeVector& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetAllEdges(vtkPolyData *polydata, EdgeMultiMap& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetEdgesOnListOfCells(vtkPolyData *polydata, vtkIdList *cellList, EdgeVector& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetEdgesOnListOfCells(vtkPolyData *polydata, vtkIdList *cellList, EdgeMultiMap& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsOnListOfEdges(vtkPolyData *polydata, const EdgeVector& edgeList, vtkIdList* ptList) const
{
  ptList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsOnListOfEdges(vtkPolyData *polydata, const EdgeVector& edgelist, IdSet& ptSet) const
{
  ptSet.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnListOfEdges(vtkPolyData *polydata, const EdgeVector& edgeList, vtkIdList* cellList) const
{
  cellList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnListOfEdges(vtkPolyData *polydata, const EdgeVector& edgelist, IdSet& cellSet) const
{
  cellSet.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnListOfPoints(vtkPolyData *polydata, vtkIdList *ptIds, vtkIdList* cellList) const
{
  cellList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnListOfPoints(vtkPolyData *polydata, vtkIdList *ptIds, IdSet& cellSet) const
{
  cellSet.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnCell_EdgeConnected(vtkPolyData *polydata, int cellId,  vtkIdList *idList) const
{
  idList->Initialize() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnListOfCells_EdgeConnected(vtkPolyData *polydata, vtkIdList* cellsIn, vtkIdList* cellsOut)
{
...
// Get edge connected neighbours of list of cells
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnListOfCells_EdgeConnected(vtkPolyData *polydata, IdSet& cellsIn, IdSet& cellsOut)
{
  cellsOut.clear() ;
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::FindEdgeInList(Edge& edge, EdgeVector& edgeList) const
{
  for (int i = 0 ;  i < (int)edgeList.size() ;  i++){
    if (edge == edgeList[i])
      return i ;
...
// Returns -1 if not found
int vtkMAFPolyDataNavigator::FindIndexOfPointOnCell(vtkPolyData *polydata, int cellId, int ptId) const
  //------------------------------------------------------------------------------
{
  vtkIdList *idlist = vtkIdList::New() ;
...
// Is point on a cell
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::IsPointOnCell(vtkPolyData *polydata, int cellId, int ptId) const
{
  vtkIdList *idlist = vtkIdList::New() ;
...
// Is edge on a cell
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::IsEdgeOnCell(vtkPolyData *polydata, int cellId, const Edge& edge) const
{
...
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::IsEdgeAcrossCell(vtkPolyData *polydata, int cellId, const Edge& edge) const
{
...
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::IsPointInEdgeList(int ptId, EdgeVector& edges)
{
  bool found = false ;
...
// Is point in list of edges
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::IsPointInEdgeList(int ptId, EdgeVector& edges, int& whichEdge)
{
  bool found = false ;
  whichEdge = -1 ;
  for (int i = 0 ;  i < (int)edges.size() && !found ;  i++){
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetPointOnCellOppositeToEdge(vtkPolyData *polydata, int cellId, const Edge& edge) const
{
  int id = -1 ;
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetCellWithTwoEdges(vtkPolyData *polydata, const Edge& edge0,  const Edge& edge1) const
{
  int id ;
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetCellWithEdgeAndPoint(vtkPolyData *polydata, const Edge& edge, int ptId) const
{
  int id ;
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::GetCellWithThreePoints(vtkPolyData *polydata, int ptId0, int ptId1, int ptId2) const
{
  int id ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsWithNumberOfPoints(vtkPolyData *polydata,  int n,  vtkIdList *cellIds) const
{
  cellIds->Initialize() ;
...
// Get center of cell
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCenterOfCell(vtkPolyData *polydata, int cellId, double x[3]) const
{
  vtkIdList *idsOnCell = vtkIdList::New() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsOnStraightSidesOfCell(vtkPolyData *polydata, int cellId, vtkIdList *ptIdsOnCell, double tol) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetEdgesOnBoundary(vtkPolyData *polydata, EdgeVector& edges) const
{
  edges.clear() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsOnBoundary(vtkPolyData *polydata, vtkIdList* ptIds) const
{
  EdgeVector edges ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsOnBoundary(vtkPolyData *polydata, vtkIdList* cellIds) const
{
  EdgeVector edges ;
  GetEdgesOnBoundary(polydata, edges) ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsWithScalarValue(vtkPolyData *polydata, char* scalarName, int component, double value, vtkIdList *pts)
{
  pts->Reset() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetCellsWithScalarValue(vtkPolyData *polydata, char* scalarName, int component, double value, vtkIdList *pts)
{
  pts->Reset() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SetPointsToScalarValue(vtkPolyData *polydata, char* scalarName, int component, double value, vtkIdList *pts)
{
  // find array with given name
  vtkDataArray *array = polydata->GetPointData()->GetScalars(scalarName) ;
  if (array == NULL)
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SetCellsToScalarValue(vtkPolyData *polydata, char* scalarName, int component, double value, vtkIdList* cells)
{
  // find array with given name
  vtkDataArray *array = polydata->GetCellData()->GetScalars(scalarName) ;
  if (array == NULL)
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::GetPointsWithNoCells(vtkPolyData *polydata, vtkIdList *pts) const
{
  pts->Initialize() ;
...
// Get length of edge
//------------------------------------------------------------------------------
double vtkMAFPolyDataNavigator::GetLengthOfEdge(vtkPolyData *polydata, const Edge edge) const
{
  int id0 = edge.GetId0() ;
  int id1 = edge.GetId1() ;
...
// NB Needs BuildCells().
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintCell(vtkPolyData *polydata, int cellId, ostream& os) const
{
  os << "cell " << cellId << ": " ;
...
// NB Needs BuildCells().
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintCellCSV(vtkPolyData *polydata, int cellId, ostream& os) const
{
  os << cellId << ", " ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintCells(vtkPolyData *polydata, ostream& os)  const
{
...
// Print all cells in polydata.
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintCellsCSV(vtkPolyData *polydata, ostream& os)  const
{
  os << "number of points, " << polydata->GetPoints()->GetNumberOfPoints() << "\n\n" ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintAttributeData(vtkPolyData *polydata, ostream& os,  bool printTuples)  const
{
  //----------------------------------------------------------------------------
  // Points and cells
  //----------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::PrintBounds(vtkPolyData *polydata, ostream& os) const
{
  double b[6] ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyPointData(vtkPolyData *polydata,  int id0) const
{
  vtkPointData *pd = polydata->GetPointData() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyPointData(vtkPolyData *polydata,  int id0, int id1, double lambda) const
{
  vtkPointData *pd = polydata->GetPointData() ;
  int numberOfPtArrays = pd->GetNumberOfArrays() ;
...
// increasing the no. of tuples by one.
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyCellData(vtkPolyData *polydata,  int cellId) const
{
  vtkCellData *cd = polydata->GetCellData() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::DeleteCellTuples(vtkPolyData *polydata, vtkIdList *cellIds)  const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::DeletePointTuples(vtkPolyData *polydata, vtkIdList *ptIds)  const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CreatePointDataArray(vtkPolyData *polydata, char* name, int numberOfComponents, int dataType) const
{
...
// Create new attribute array
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CreateCellDataArray(vtkPolyData *polydata, char* name, int numberOfComponents, int dataType) const
{
  //  vtkDataArray* scalars ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SetCellToEmpty(vtkPolyData *polydata, int cellId) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::DeleteCells(vtkPolyData *polydata, vtkIdList *idList) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::DeletePoints(vtkPolyData *polydata, vtkIdList *idList)  const
{
  int n = polydata->GetPoints()->GetNumberOfPoints() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SwapPointIds(vtkPolyData *polydata, int id0, int id1) const
{
  // swap the positions
  double x0[3], x1[3] ;
  polydata->GetPoint(id0, x0) ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::MovePointIdsToEnd(vtkPolyData *polydata, vtkIdList *idList)  const
{
  int n = polydata->GetPoints()->GetNumberOfPoints() ;
  int m = idList->GetNumberOfIds() ;
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::CreateNewPoint(vtkPolyData *polydata,  int id0) const
{
  // add new point
  double x0[3] ;
  polydata->GetPoint(id0, x0) ;
...
// This can be called successively, but you must delete or rebuild the cells and links when finished.
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::CreateNewPoint(vtkPolyData *polydata,  int id0, int id1, double lambda) const
{
  // add new point
...
// This can be called successively, but you must delete or rebuild the cells and links when finished.
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::CreateNewCell(vtkPolyData *polydata,  int copyScalarsCellId,  vtkIdList *ids) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::CopyCells(vtkPolyData *polydata,  vtkIdList *cellIds,  vtkIdList *newCellIds)  const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::AddPointsToEdges(vtkPolyData *polydata, const EdgeVector& edges, vtkIdList *newPtIds)  const
{
  //----------------------------------------------------------------------------
...
// This method does not change the id's of the cells.
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::AddPointsToEdges(
...
// This method does not change the id's of the cells.
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::AddPointsToEdges(vtkPolyData *polydata, const EdgeVector& edges, const std::vector<double>& lambda, vtkIdList *newPtIds)  const
{
  //----------------------------------------------------------------------------
  // Get all the cells and list the id's as editable vtkIdList's 
  //----------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::ChangePointIdInCell(vtkPolyData *polydata, int cellId,  int idold, int idnew) const
{
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SplitCells(vtkPolyData *polydata,  vtkIdList *cellIds,  const EdgeVector& edges) const
{
  vtkIdList *cellPts = vtkIdList::New() ;
...
// The cells must be quads or greater.
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SplitCells(vtkPolyData *polydata,  vtkIdList *cellIds,  vtkIdList *ptIds) const
{
  EdgeVector edges ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SplitCells(vtkPolyData *polydata,  vtkIdList *cellIds,  std::vector<EdgeVector>& edgeLists) const
{
...
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::FindSubCellsOfCell(
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SubdivideCells(vtkPolyData *polydata,  vtkIdList *cellIds) const
{
  //----------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::SubdivideAllCells(vtkPolyData *polydata) const
{
  vtkIdList *cellIds = vtkIdList::New() ;
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::MergePoints(vtkPolyData *polydata, vtkIdList *idsIn0,  vtkIdList *idsIn1,  
...
//------------------------------------------------------------------------------
void vtkMAFPolyDataNavigator::RemovePointsWithNoCells(vtkPolyData *polydata) const
{
  vtkIdList *ptsNoCells = vtkIdList::New() ;
  GetPointsWithNoCells(polydata, ptsNoCells) ;
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::Modulo(int i, int n) const
{
  if (i >= 0)
    return i % n ;
  else
...
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::Edge::IsJoined(const Edge& edge) const
{
  return (
...
// Equals operator
//------------------------------------------------------------------------------
bool vtkMAFPolyDataNavigator::Edge::operator==(const Edge& edge) const
{
  return (
    ((edge.m_Id0 == m_Id0) && (edge.m_Id1 == m_Id1)) || 
    ((edge.m_Id0 == m_Id1) && (edge.m_Id1 == m_Id0))
...
//------------------------------------------------------------------------------
int vtkMAFPolyDataNavigator::Edge::GenerateKey() const
{
