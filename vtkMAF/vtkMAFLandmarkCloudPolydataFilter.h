...
Module:    $RCSfile: vtkMAFLandmarkCloudPolydataFilter.h,v $
Language:  C++
...
#ifndef __vtkMAFLandmarkCloudPolydataFilter_h
...
//------------------------------------------------------------------------------
/// vtkMAFLandmarkCloudPolydataFilter. \n
...
protected:
  ...
  std::vector<vtkMAFAddScalarsFilter*> m_AddScalarsList ; // filters which add color
...
private:
  vtkMAFLandmarkCloudPolydataFilter( vtkMAFLandmarkCloudPolydataFilter&);  // Not implemented.
  void operator=( vtkMAFLandmarkCloudPolydataFilter&);  // Not implemented.
};
