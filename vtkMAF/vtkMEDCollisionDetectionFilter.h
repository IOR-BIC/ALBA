...
=========================================================================*/
// .NAME vtkMEDCollisionDetectionFilter - performs collision determination between two polyhedral surfaces
// .SECTION Description
// vtkMEDCollisionDetectionFilter performs collision determination between two polyhedral surfaces using
...
class VTK_vtkMAF_EXPORT vtkMEDCollisionDetectionFilter : public vtkPolyDataToPolyDataFilter
{
public:
...
//ETX
  ...
  static vtkMEDCollisionDetectionFilter *New();
...
private:  
  ...
  vtkMEDCollisionDetectionFilter(const vtkMEDCollisionDetectionFilter&);  // Not implemented.
  void operator=(const vtkMEDCollisionDetectionFilter&);  // Not implemented.
};

//BTX

inline const char *vtkMEDCollisionDetectionFilter::GetCollisionModeAsString(void)
{
