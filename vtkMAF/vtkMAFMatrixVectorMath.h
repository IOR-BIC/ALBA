...
#ifndef __vtkMAFMatrixVectorMath_h
#define __vtkMAFMatrixVectorMath_h
...
//------------------------------------------------------------------------------
class MAF_EXPORT vtkMAFMatrixVectorMath : public vtkObject
{
public:
...
protected:
  vtkMAFMatrixVectorMath() ;  ///< constructor
  ~vtkMAFMatrixVectorMath() ; ///< deconstructor
