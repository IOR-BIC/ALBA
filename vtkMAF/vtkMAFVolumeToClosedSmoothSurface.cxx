...
//----------------------------------------------------------------------------
vtkMAFVolumeToClosedSmoothSurface::vtkMAFVolumeToClosedSmoothSurface()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void vtkMAFVolumeToClosedSmoothSurface::GetTransformFactor( int toUnity,double *bounds, double *scale, double *traslation )
//----------------------------------------------------------------------------
{
  double size[3];
...
//----------------------------------------------------------------------------
vtkPolyData * vtkMAFVolumeToClosedSmoothSurface::GetOutput( int level /*= 0*/, vtkPolyData *data /*= NULL*/ )
//----------------------------------------------------------------------------
{
...
//-------------------------------------------------------------------
void vtkMAFVolumeToClosedSmoothSurface::Update()
//------------------------------------------------------------------------------
{
