...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CVertex::CVertex(double *pCoord)
//----------------------------------------------------------------------------
{
  DCoord[0] = pCoord[0];
  DCoord[1] = pCoord[1];
...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CVertex::~CVertex()
//----------------------------------------------------------------------------
{
  OneRingVertex.clear();
...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CTriangle::CTriangle()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CTriangle::CTriangle(int v0,int v1,int v2)
//----------------------------------------------------------------------------
{
  AVertex[0]=v0;
  AVertex[1]=v1;
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::CTriangle::SetEdge(int e0,int e1,int e2)
//----------------------------------------------------------------------------
{
  AEdge[0]=e0;
  AEdge[1]=e1;
...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CEdge::CEdge(int v0,int v1)
//----------------------------------------------------------------------------
{
  AVertex[0] = v0;
  AVertex[1] = v1;
...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CEdge::CEdge(int v0,int v1,int v2,int v3)
//----------------------------------------------------------------------------
{
  AVertex[0] = v0;
  AVertex[1] = v1;
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::CEdge::SetTriangle(int t0,int t1)
//----------------------------------------------------------------------------
{
  ATriangle[0]=t0;
  ATriangle[1]=t1;
...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CLaplacian::CLaplacian(int size)
//----------------------------------------------------------------------------
{
  DLaplacian = 0;
  DLaplacianCoord[0] = 0;
...
//----------------------------------------------------------------------------
vtkMAFFillingHole::CLaplacian::~CLaplacian()
//----------------------------------------------------------------------------
{
  delete ALaplacian;
}
...
void  vtkMAFFillingHole::ComputeNormal(const double *v1, const double *v2, 
...
double vtkMAFFillingHole::ComputeDihedralAngleF(const double* n1, const double* n2)
//------------------------------------------------------------------------
{
  double nn[3];
...
bool vtkMAFFillingHole::CircumCircleTest(double *v1,double *v2,double *v3, double *v4)
//------------------------------------------------------------------------
{   
...
double vtkMAFFillingHole::TriangleArea(double *pCoordv0,double *pCoordv1,double *pCoordv2)
//----------------------------------------------------------------------------
{
  double a[3],b[3],c[3];
...
//----------------------------------------------------------------------------
// vtkMAFFillingHole Constructor
vtkMAFFillingHole::vtkMAFFillingHole()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::PrintSelf(ostream& os, vtkIndent indent)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::ClearPatch()
//----------------------------------------------------------------------------
{
  int i, nCount;
...
void vtkMAFFillingHole::BuildPatch()
//----------------------------------------------------------------------------
{
  int i,j,t;
  int sv1,sv2;
  ...
  for( t=0,triangle=start; t<NumOfPatchTriangle; t++,triangle++)
  {
    ...
    for(i=0;i<3;i++)
    {
        ...
        pVertex1->OneRingVertex.end(),sv2))
      {
        ...
        vtkErrorMacro(<< "vtkMAFFillingHole::BuildPatch detected non-manifold");
#ifdef _MSC_VER
...
void vtkMAFFillingHole::Trace(int i,int k)
//----------------------------------------------------------------------------
{
  int j;
  CTriangle *pTriangle;
...
// Computer-Aided Geometric Design, 12(2):207-229, March 1995
void vtkMAFFillingHole::CreatePatch()
//----------------------------------------------------------------------------
{
  int i,j,k,m;
...
vtkMAFFillingHole::CVertex* vtkMAFFillingHole::AddOnePointToTriangle(double *pCoord,CTriangle*pTriangle)
//----------------------------------------------------------------------------
{
  CVertex		*pNewVertex;
...
bool vtkMAFFillingHole::RelaxOneEdge(CEdge *pEdge)
//----------------------------------------------------------------------------
{
...
#ifdef _FILLING_DBG
void vtkMAFFillingHole::CheckPatchEdges(int& nStartEdgeId)
{
  nStartEdgeId = 0;
...
void vtkMAFFillingHole::RefinePatch()
//----------------------------------------------------------------------------
{
  bool bFlag;
  int i,j;
...
void vtkMAFFillingHole::ExtendPatch()
//----------------------------------------------------------------------------
{
  int i,step;
  int start,end;
...
#ifdef _MSC_VER
      _RPT1(_CRT_WARN, "vtkMAFFillingHole::SmoothPatch - the maximum number of points "
        "for smoothing (%d) has been reached\n", end);
#endif

      vtkWarningMacro("vtkMAFFillingHole::SmoothPatch - the maximum number of points "
...
void vtkMAFFillingHole::BuildPatchLaplacian()
{
  int           i,j,nOneRingNum;  
...
void vtkMAFFillingHole::ComputeLTransposeLMatrix(double *A)
//----------------------------------------------------------------------------
{
  int i,j,index;
...
void vtkMAFFillingHole::LTransposeMatrixVector( double *source,double *result )
//------------------------------------------------------------------------
{
  int i,j;
  CVertex *pVertex;
...
void vtkMAFFillingHole::LTransposeLMatrixVector( double *A,double *xyz,double *result )
//------------------------------------------------------------------------
{
  int i,j,index;
  double	dValue;
...
void vtkMAFFillingHole::LTransposeLConjugateGradient(double *A,double *xyz,double *b)
//----------------------------------------------------------------------------
{
//Pseudocode:
//1.  r_0 = b - A*x_0;
...
//13.  the result is  x_k+1
  ...
  {
#ifdef _MSC_VER
    _RPT1(_CRT_WARN, "vtkMAFFillingHole::LTransposeLConjugateGradient - "
                     "the method does not converge, error: %.2f", r_r);
#endif

    vtkWarningMacro("vtkMAFFillingHole::LTransposeLConjugateGradient - the method does not converge, error:"  << r_r);    
  }
...
void vtkMAFFillingHole::SmoothPatch()
//----------------------------------------------------------------------------
{  
  if( FillingType == Flat )   
...
void vtkMAFFillingHole::MembraneSmoothing()
//------------------------------------------------------------------------
{
...
void vtkMAFFillingHole::ThinPlateSmoothing()
//------------------------------------------------------------------------
{
...
void vtkMAFFillingHole::MergePatch()
//----------------------------------------------------------------------------
{
  CVertex	*pVertex,*pNewVertex;
  CTriangle	*pNewTriangle;
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::ClearMesh()
//----------------------------------------------------------------------------
{
  int i;
...
void vtkMAFFillingHole::InitManifoldMesh()
//----------------------------------------------------------------------------
{
  //create initial mesh
  InitMesh();
...
void vtkMAFFillingHole::BuildMesh()
//----------------------------------------------------------------------------
{
  int i,j,t;
  int sv1,sv2;
...
void vtkMAFFillingHole::UpdateMesh(int id)
//----------------------------------------------------------------------------
{
  int i,j,t;
  int sv1,sv2;
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::SetFillAHole(int id)
//----------------------------------------------------------------------------
{
  //filling a hole
  FillingHoles = 1;  
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::SetFillAllHole()
//----------------------------------------------------------------------------
{
  //filling all holes
  FillingHoles = 0;  
...
//----------------------------------------------------------------------------
bool vtkMAFFillingHole::FindAHole()
//----------------------------------------------------------------------------
{
  int *pEdgeVertex;
  bool bFlag;
...
//----------------------------------------------------------------------------
bool vtkMAFFillingHole::FindNextHole()
//----------------------------------------------------------------------------
{
  int i;
  CVertex *pVertex;
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::InitMesh()
//----------------------------------------------------------------------------
{
  int i;
  int v0,v1,v2;
...
//----------------------------------------------------------------------------
void vtkMAFFillingHole::DoneMesh()
//----------------------------------------------------------------------------
{
  int i;
...
void vtkMAFFillingHole::BuildPatchOutput()
//----------------------------------------------------------------------------
{
  int i;
