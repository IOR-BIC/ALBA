...
#ifndef __vtkMAFDeformableSimplexMesh3DFilter_Impl_h
#define __vtkMAFDeformableSimplexMesh3DFilter_Impl_h
...
namespace itk
{
  ...
  vtkMAFDeformableSimplexMeshFilter< TInputMesh, TOutputMesh >
    ::vtkMAFDeformableSimplexMeshFilter()
  ...
  //----------------------------------------------------------------------------
  template< typename TInputMesh, typename TOutputMesh >
  void vtkMAFDeformableSimplexMeshFilter< TInputMesh, TOutputMesh >
  ...
  */
  ...
  //----------------------------------------------------------------------------
  template< typename TInputMesh, typename TOutputMesh >
  double vtkMAFDeformableSimplexMeshFilter< TInputMesh, TOutputMesh >
  ...
  //----------------------------------------------------------------------------
  template< typename TInputMesh, typename TOutputMesh >
  itk::Vector< double, 3 > vtkMAFDeformableSimplexMeshFilter< TInputMesh, TOutputMesh >
  ...
  //----------------------------------------------------------------------------
  template< typename TInputMesh, typename TOutputMesh >
  bool vtkMAFDeformableSimplexMeshFilter<TInputMesh, TOutputMesh >::
  ...
  //----------------------------------------------------------------------------
  template< typename TInputMesh, typename TOutputMesh >
  int vtkMAFDeformableSimplexMeshFilter<TInputMesh, TOutputMesh >::
  ...
  template< typename TInputMesh, typename TOutputMesh >
  void vtkMAFDeformableSimplexMeshFilter<TInputMesh, TOutputMesh >::
    DeformationHistory::SaveLengthsOfCells(int step, const vtkMAFStentModelSource::SimplexMeshType *mesh)
  {
    int n = mesh->GetNumberOfCells() ;

    for (int i = 0 ;  i < n ;  i++){
      vtkMAFStentModelSource::CellAutoPointer cellPtr ;
      mesh->GetCell(i, cellPtr) ;
      CellInterface<PixelType, vtkMAFStentModelSource::SimplexMeshType::CellTraits>::PointIdConstIterator ptIdIterator = cellPtr->GetPointIds() ;
