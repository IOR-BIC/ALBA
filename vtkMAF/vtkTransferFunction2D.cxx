...
vtkCxxRevisionMacro(vtkTransferFunction2D, "$Revision: 1.3 $");
vtkStandardNewMacro(vtkTransferFunction2D);
vtkCxxRevisionMacro(vtkVolumeProperty2, "$Revision: 1.3 $");
...
//-----------------------------------------------------------------
void vtkTransferFunction2D::Modified(double from, double to) 
//-----------------------------------------------------------------
{
  this->RangeValid = false;
...
//-----------------------------------------------------------------
bool vtkTransferFunction2D::SetWidgetOpacity(int index, double opacity) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkTransferFunction2D::SetWidgetColor(int index, double color[3]) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkTransferFunction2D::SetWidgetDiffuse(int index, double diffuse) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkTransferFunction2D::SetWidgetValueRatio(int index, double ratio) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkTransferFunction2D::SetWidgetValueRange(int index, double range[3]) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
bool vtkTransferFunction2D::SetWidgetGradientRange(int index, double range[3]) 
//-----------------------------------------------------------------
{
...
//-----------------------------------------------------------------
double vtkTransferFunction2D::GetValue(const double val, const double gradient, double &opacity, double color[3], double &diffuse) 
//-----------------------------------------------------------------
{
  opacity = 0;
...
//-----------------------------------------------------------------
bool vtkTransferFunction2D::GetTable(int vsize, const double *vTable, int gsize, const double *gTable, double *opacityTable, unsigned char *rgbdTable, bool useOpacity) 
//-----------------------------------------------------------------
{
