/*=========================================================================
  ...
  Module:    vtkMAFCollisionDetectionFilter.h
  Language:  C++
  RCS:   $Id: vtkMAFCollisionDetectionFilter.h,v 1.1.2.2 2012-02-22 12:53:16 ior02 Exp $
...
=========================================================================*/
// .NAME vtkMAFCollisionDetectionFilter - performs collision determination between two polyhedral surfaces
// .SECTION Description
// vtkMAFCollisionDetectionFilter performs collision determination between two polyhedral surfaces using
...
//ETX
  ...
  static vtkMAFCollisionDetectionFilter *New();
...
private:  
  ...
  void operator=(const vtkMAFCollisionDetectionFilter&);  // Not implemented.
};

//BTX

inline const char *vtkMAFCollisionDetectionFilter::GetCollisionModeAsString(void)
{
