/*========================================================================= 
  ...
  Module: $RCSfile: medPipeTensorFieldSlice.cpp,v $ 
  Language: C++ 
...
//----------------------------------------------------------------------------
mafCxxTypeMacro(medPipeTensorFieldSlice);
//----------------------------------------------------------------------------

//----------------------------------------------------------------------------
medPipeTensorFieldSlice::medPipeTensorFieldSlice() : medPipeTensorFieldSurface()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
medPipeTensorFieldSlice::~medPipeTensorFieldSlice()
//----------------------------------------------------------------------------
{  
  vtkDEL(m_CutPlane);
...
//----------------------------------------------------------------------------
mafGUI *medPipeTensorFieldSlice::CreateGui()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medPipeTensorFieldSlice::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{			
...
/*virtual*/ void medPipeTensorFieldSlice::UpdateSlicePosRange()
//------------------------------------------------------------------------
{
  double bounds[6]; 
...
/*virtual*/ void medPipeTensorFieldSlice::CreateVTKPipe()
//------------------------------------------------------------------------
{  
...
/*virtual*/ void medPipeTensorFieldSlice::UpdateVTKPipe()
//------------------------------------------------------------------------
{
  //update cutter  
  double bounds[6];
