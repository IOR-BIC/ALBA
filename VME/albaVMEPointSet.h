...
#ifndef __albaVMEPointSet_h
#define __albaVMEPointSet_h
...
//----------------------------------------------------------------------------
class vtkPolyData;
class albaVMEOutputPointSet;
class mmaMaterial;

/** albaVMEPointSet - this class stores a set of points as a VME
albaVMEPointSet is a concrete VME object storing a cloud of Points whose
...
class ALBA_EXPORT albaVMEPointSet : public albaVMEGeneric
{
public:
  //albaAbstractTypeMacro(albaVMEPointSet,albaVMEGeneric);
  albaTypeMacro(albaVMEPointSet,albaVMEGeneric);
  ...
  /** return the right type of output */  
  albaVMEOutputPointSet *GetPointSetOutput() {return (albaVMEOutputPointSet *)GetOutput();}
...
private:
  albaVMEPointSet(const albaVMEPointSet&); // Not implemented
  void operator=(const albaVMEPointSet&); // Not implemented
