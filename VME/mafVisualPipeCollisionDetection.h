...
#ifndef __mafVisualPipeCollisionDetection_H__
#define __mafVisualPipeCollisionDetection_H__
...
// mafPipeSurface :
//----------------------------------------------------------------------------
class MAF_EXPORT mafVisualPipeCollisionDetection : public mafPipe
{
public:
  mafTypeMacro(mafVisualPipeCollisionDetection,mafPipe);

  /** constructor. */
  mafVisualPipeCollisionDetection();
  /** destructor. */
  ~mafVisualPipeCollisionDetection ();
