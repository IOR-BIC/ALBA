/*========================================================================= 
  ...
  Module: $RCSfile: mafPipeVectorField.h,v $ 
  Language: C++ 
  ...
  =========================================================================
*/
#ifndef mafPipeVectorField_h__
#define mafPipeVectorField_h__
...
class MAF_EXPORT mafPipeVectorField : public mafPipe
{
public:
  mafAbstractTypeMacro(mafPipeVectorField, mafPipe);
