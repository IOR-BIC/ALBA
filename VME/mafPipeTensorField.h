/*========================================================================= 
  ...
  Module: $RCSfile: mafPipeTensorField.h,v $ 
  Language: C++ 
  ...
  =========================================================================
*/
#ifndef mafPipeTensorField_h__
#define mafPipeTensorField_h__
...
/** 
class name:  mafPipeTensorField
General class for tensor fields, contains useful stuff 
 */
class MAF_EXPORT mafPipeTensorField : public mafPipe
{
public:
  /** RTTI macro*/
  mafAbstractTypeMacro(mafPipeTensorField, mafPipe);
