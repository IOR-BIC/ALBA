...
=========================================================================*/
#ifndef __mafVMESegmentationVolume_h
#define __mafVMESegmentationVolume_h
...
class mafDataPipeCustomSegmentationVolume;
class mafAttributeSegmentationVolume;

class MAF_EXPORT mafVMESegmentationVolume : public mafVME
{
public:
  mafTypeMacro(mafVMESegmentationVolume, mafVME);
  ...
  /** Clear the parameter 'kframes' because mafVMESegmentationVolume has no timestamp. */
...
protected:
  /** constructor. */
  mafVMESegmentationVolume();
  /** destructor. */
  virtual ~mafVMESegmentationVolume(); 
  ...
  mafAttributeSegmentationVolume *GetVolumeAttribute();

  mafString m_VolumeName;

  mafTransform *m_Transform;

  mafDataPipeCustomSegmentationVolume *m_SegmentingDataPipe;

  mafAttributeSegmentationVolume *m_VolumeAttribute;

private:
  /** Not implemented */
  mafVMESegmentationVolume(const mafVMESegmentationVolume&); 
  /** Operator = Not implemented*/
  void operator=(const mafVMESegmentationVolume&);
};
#endif
