...
=========================================================================*/
#ifndef __mafVMESurfaceEditor_h
#define __mafVMESurfaceEditor_h
...
class MAF_EXPORT mafVMESurfaceEditor : public mafVMESurface
{
public:
	mafTypeMacro(mafVMESurfaceEditor, mafVMESurface);
...
protected:
	mafVMESurfaceEditor();
	virtual ~mafVMESurfaceEditor(); 

	mafString m_VisualPipeName;

private:
	mafVMESurfaceEditor(const mafVMESurfaceEditor&); // Not implemented
	void operator=(const mafVMESurfaceEditor&); // Not implemented
};
#endif
