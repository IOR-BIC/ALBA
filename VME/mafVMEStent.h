/*=========================================================================
Program:   MAF2
Module:    $RCSfile: mafVMEStent.h,v $
Language:  C++
...
#ifndef __mafVMEStent_h 
#define __mafVMEStent_h
...
//-----------------------------------------------------------------------------
class MAF_EXPORT mafVMEStent : public mafVMEGeneric
{
public:
  /// Risk categories
  enum{
  ...
  mafTypeMacro(mafVMEStent, mafVMEGeneric);
