...
#ifndef __albaAttributeSegmentationVolume_H__
#define __albaAttributeSegmentationVolume_H__
...
//----------------------------------------------------------------------------
// albaAttributeSegmentationVolume:
//----------------------------------------------------------------------------
/**  */  
class ALBA_EXPORT albaAttributeSegmentationVolume : public albaAttribute
{
public:
  /** constructor. */
  albaAttributeSegmentationVolume();
  /** destructor. */
  virtual ~albaAttributeSegmentationVolume();

  albaTypeMacro(albaAttributeSegmentationVolume, albaAttribute);
