/*=========================================================================
 ...
 Program: MAF2
 Module: mafPipeVectorFieldMapWithArrows
...
//----------------------------------------------------------------------------
mafPipeVectorFieldMapWithArrows::mafPipeVectorFieldMapWithArrows() : mafPipeVectorField()
//----------------------------------------------------------------------------
{     
...
//----------------------------------------------------------------------------
mafPipeVectorFieldMapWithArrows::~mafPipeVectorFieldMapWithArrows()
//----------------------------------------------------------------------------
{ 
...
//----------------------------------------------------------------------------
mafGUI *mafPipeVectorFieldMapWithArrows::CreateGui()
//----------------------------------------------------------------------------
{ 
...
//----------------------------------------------------------------------------
void mafPipeVectorFieldMapWithArrows::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{			
...
//------------------------------------------------------------------------
void mafPipeVectorFieldMapWithArrows::CreateVTKPipe()
//------------------------------------------------------------------------
{ 
...
void mafPipeVectorFieldMapWithArrows::UpdateVTKPipe()
//------------------------------------------------------------------------
{
  if (!m_Vme->GetOutput()->GetVTKData()) {
    return;
...
//------------------------------------------------------------------------
int mafPipeVectorFieldMapWithArrows::GetNumberOfFields(bool bVectors)
//------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------
const char* mafPipeVectorFieldMapWithArrows::GetFieldName(int nIndex, bool bVectors)
//------------------------------------------------------------------------
{
  vtkPointData* pd = m_Vme->GetOutput()->GetVTKData()->GetPointData();
  vtkCellData* cd = m_Vme->GetOutput()->GetVTKData()->GetCellData();
...
//------------------------------------------------------------------------
int mafPipeVectorFieldMapWithArrows::GetFieldIndex(const char* szName, bool bVectors)
//------------------------------------------------------------------------
{
  vtkPointData* pd = m_Vme->GetOutput()->GetVTKData()->GetPointData();
  vtkCellData* cd = m_Vme->GetOutput()->GetVTKData()->GetCellData();
...
//------------------------------------------------------------------------
void mafPipeVectorFieldMapWithArrows::PopulateCombo(wxComboBox* combo, bool bVectors)
//------------------------------------------------------------------------
{
  vtkPointData* pd = m_Vme->GetOutput()->GetVTKData()->GetPointData();
  vtkCellData* cd = m_Vme->GetOutput()->GetVTKData()->GetCellData();
