/*========================================================================= 
  ...
  Module: $RCSfile: mafPipeTensorFieldGlyphs.h,v $ 
  Language: C++ 
  ...
  =========================================================================
*/
#ifndef mafPipeTensorFieldGlyphs_h__
#define mafPipeTensorFieldGlyphs_h__
...
/** 
class name: mafPipeTensorFieldGlyphs
Class for Volumes with compound pipes which show tensor field using glyphs.
 */
class MAF_EXPORT mafPipeTensorFieldGlyphs : public mafPipeTensorField
{
public:
  /** RTTI macro*/
  mafTypeMacro(mafPipeTensorFieldGlyphs, mafPipeTensorField);
...
public:
  /** constrouctor */
  mafPipeTensorFieldGlyphs();
  /** destructor */
  virtual ~mafPipeTensorFieldGlyphs();
...
#endif // mafPipeTensorFieldGlyphs_h__