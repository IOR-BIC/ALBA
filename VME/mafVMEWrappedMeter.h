...
=========================================================================*/
#ifndef __mafVMEWrappedMeter_h
#define __mafVMEWrappedMeter_h
//----------------------------------------------------------------------------
// Include:
//----------------------------------------------------------------------------
...
/** mafVMEWrappedMeter - 
*/
class MAF_EXPORT mafVMEWrappedMeter : public mafVME
{
public:
  ...
  mafTypeMacro(mafVMEWrappedMeter,mafVME);
  ...
  virtual mafString GetVisualPipe() {return mafString("mafPipeWrappedMeter");};

  /** return the right type of output */  
  mafVMEOutputWrappedMeter *GetWrappedMeterOutput();
  ...
  void SetMeterModeToPointDistance() {this->SetMeterMode(mafVMEWrappedMeter::POINT_DISTANCE);}
 // void SetMeterModeToLineDistance() {this->SetMeterMode(mafVMEWrappedMeter::LINE_DISTANCE);}
 // void SetMeterModeToLineAngle() {this->SetMeterMode(mafVMEWrappedMeter::LINE_ANGLE);}
  ...
  void SetMeterColorModeToOneColor() {this->SetMeterColorMode(mafVMEWrappedMeter::ONE_COLOR);}
  void SetMeterColorModeToRangeColor() {this->SetMeterColorMode(mafVMEWrappedMeter::RANGE_COLOR);}
  ...
  void SetMeterMeasureTypeToAbsolute() {this->SetMeterMeasureType(mafVMEWrappedMeter::ABSOLUTE_MEASURE);}
  void SetMeterMeasureTypeToRelative() {this->SetMeterMeasureType(mafVMEWrappedMeter::RELATIVE_MEASURE);}
  ...
  void SetMeterRepresentationToLine() {this->SetMeterRepresentation(mafVMEWrappedMeter::LINE_REPRESENTATION);}
  void SetMeterRepresentationToTube() {this->SetMeterRepresentation(mafVMEWrappedMeter::TUBE_REPRESENTATION);}
...
private:
  mafVMEWrappedMeter(const mafVMEWrappedMeter&); // Not implemented
  void operator=(const mafVMEWrappedMeter&); // Not implemented
};
#endif
