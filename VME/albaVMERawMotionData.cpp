...
//-------------------------------------------------------------------------
albaCxxTypeMacro(albaVMERawMotionData)
//-------------------------------------------------------------------------

//----------------------------------------------------------------------------
albaVMERawMotionData::albaVMERawMotionData()
//----------------------------------------------------------------------------
{ 
	this->m_Dictionary = 0;
}
...
//----------------------------------------------------------------------------
void albaVMERawMotionData::SetDictionaryFileName(const char *name)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
{
  ...
  double not_used_identifier = -1;
    ...
    std::ifstream v_dictionary(this->m_DictionaryFileName, std::ios::in);
        ...
        albaVMELandmarkCloud *currentDlc;
        currentDlc = albaVMELandmarkCloud::SafeDownCast(this->FindInTreeByName(v_segment_name.c_str()));
			  if (currentDlc == NULL)
			  {
