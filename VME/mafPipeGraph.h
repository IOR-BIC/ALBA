...
#ifndef __mafPipeGraph_H__
#define __mafPipeGraph_H__
...
/** 
class name mafPipeGraph.
Visual pipe to visualize graphs of analog signals. 
*/
class MAF_EXPORT mafPipeGraph : public mafPipe
{
public:
  /** RTTI Macro */
  mafTypeMacro(mafPipeGraph,mafPipe);
  /** Constructor. */
  mafPipeGraph();
  /** Destructor. */
  virtual     ~mafPipeGraph ();
