...
//----------------------------------------------------------------------------
mafCxxAbstractTypeMacro(medPipeTensorField);
//----------------------------------------------------------------------------
...
/*virtual*/ void medPipeTensorField::ComputeDefaultParameters()
//------------------------------------------------------------------------
{
...
int medPipeTensorField::GetFieldIndex(const char* szName, bool bTensors)
//------------------------------------------------------------------------
{
...
int medPipeTensorField::GetNumberOfFields(bool bTensors)
//------------------------------------------------------------------------
{
  vtkPointData* pd = m_Vme->GetOutput()->GetVTKData()->GetPointData();
  if (pd == NULL)
...
const char* medPipeTensorField::GetFieldName(int nIndex, bool bTensors)
//------------------------------------------------------------------------
{
  vtkPointData* pd = m_Vme->GetOutput()->GetVTKData()->GetPointData();
  if (pd == NULL)
...
void medPipeTensorField::PopulateCombo(wxComboBox* combo, bool bTensors)
//------------------------------------------------------------------------
{
  vtkPointData* pd = m_Vme->GetOutput()->GetVTKData()->GetPointData();
  if (pd != NULL)
