...
//----------------------------------------------------------------------------
mmgMaterialChooser::mmgMaterialChooser(wxString dialog_title)
//----------------------------------------------------------------------------
{  
...
//----------------------------------------------------------------------------
mmgMaterialChooser::~mmgMaterialChooser()
//----------------------------------------------------------------------------
{
  ClearList();
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::LoadMaterials_old()
//----------------------------------------------------------------------------
{
	int i;
	std::ifstream f_in;
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::SaveMaterials_old()
//----------------------------------------------------------------------------
{	
	int i = 0;
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::LoadLibraryFromFile()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::StoreLibraryToFile()
//----------------------------------------------------------------------------
{	
	int i = 0;
	if(!m_List.empty()) return;
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::RemoveMaterial()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::ClearList()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::LoadLibraryFromVme(mafVME *vme)
//----------------------------------------------------------------------------
{
  assert(vme);
...
//----------------------------------------------------------------------------
void mmgMaterialChooser::CreateDefaultLibrary()
//----------------------------------------------------------------------------
{
  ClearList();
