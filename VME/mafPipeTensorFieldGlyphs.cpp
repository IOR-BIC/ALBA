/*========================================================================= 
  ...
  Module: $RCSfile: mafPipeTensorFieldGlyphs.cpp,v $ 
  Language: C++ 
...
//----------------------------------------------------------------------------
mafCxxTypeMacro(mafPipeTensorFieldGlyphs);
//----------------------------------------------------------------------------
const  char* mafPipeTensorFieldGlyphs::FILTER_LINK_NAME = "filter-link-tensor";
const  char* mafPipeTensorFieldGlyphs::FILTER_LINK_NAME2 = "filter-link-scale";
int mafPipeTensorFieldGlyphs::count; 

//----------------------------------------------------------------------------
mafPipeTensorFieldGlyphs::mafPipeTensorFieldGlyphs() : mafPipeTensorField()
//----------------------------------------------------------------------------
{    
  ...
  m_ShowAll = 1;//that means do not use filter
   mafPipeTensorFieldGlyphs::count = 0;
}

//----------------------------------------------------------------------------
mafPipeTensorFieldGlyphs::~mafPipeTensorFieldGlyphs()
//----------------------------------------------------------------------------
{  
...
/*virtual*/ void mafPipeTensorFieldGlyphs::ComputeDefaultParameters()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
mafGUI *mafPipeTensorFieldGlyphs::CreateGui()
//----------------------------------------------------------------------------
{
...
void mafPipeTensorFieldGlyphs::InitFilterList(int nScalars){
	//----------------------------------------------------------------------------
...
/*void mafPipeTensorFieldGlyphs::OnShowFilter(int mode){
	//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
//Add a range item
void mafPipeTensorFieldGlyphs::OnAddItem(int idx){
	//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
//Remove a range item
void mafPipeTensorFieldGlyphs::OnRemoveItem(){
	//--------------------------------------------------------------------
	int nIndex = m_RangeCtrl->GetNextItem(-1, wxLIST_NEXT_ALL, wxLIST_STATE_SELECTED); 
	if (nIndex >= 0)
	{
...
//Remove a range item
void mafPipeTensorFieldGlyphs::OnRemoveItem2(){
	//--------------------------------------------------------------------
...
//insert item 
//----------------------------------------------
bool mafPipeTensorFieldGlyphs::AddItem2(){
...
//insert item 
//----------------------------------------------
bool mafPipeTensorFieldGlyphs::AddItem(){
...
void mafPipeTensorFieldGlyphs::CreateAddItemDlg(int idx){
	//-----------------------------------------------------------------------
...
bool mafPipeTensorFieldGlyphs::DoCondition(int mode,double tensorScaleValue,double scaleValue,double *rangeValue1,double *rangeValue2){
	bool rtn = false;
	bool tensorFlag;
	bool scaleFlag;
	if (mode ==1)
...
void mafPipeTensorFieldGlyphs::DoFilter(int mode ,double *rangeValue,double *rangeValue2){
...
//filter begin
//--------------------------------------------------------------------------
/*void mafPipeTensorFieldGlyphs::doFilter(double *rangeValue){
...
*/
//----------------------------------------------------------------------------
void mafPipeTensorFieldGlyphs::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{			
...
/*virtual*/ void mafPipeTensorFieldGlyphs::OnChangeMaterial()
//------------------------------------------------------------------------
{    
...
/*virtual*/ void mafPipeTensorFieldGlyphs::CreateVTKPipe()
//------------------------------------------------------------------------
{
  //build materials  
...
/*virtual*/ void mafPipeTensorFieldGlyphs::UpdateVTKPipe()
//------------------------------------------------------------------------
{
	mafPipeTensorFieldGlyphs::count ++; 
 ...
 */
  ...
  if (mafPipeTensorFieldGlyphs::count==1)
  {
