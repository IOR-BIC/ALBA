...
#ifndef __mafVisualPipePolylineGraph_H__
#define __mafVisualPipePolylineGraph_H__
...
//----------------------------------------------------------------------------
// mafVisualPipePolylineGraph :
//----------------------------------------------------------------------------
class MAF_EXPORT mafVisualPipePolylineGraph : public mafPipe
{
public:
  mafTypeMacro(mafVisualPipePolylineGraph,mafPipe);

  mafVisualPipePolylineGraph();
  virtual     ~mafVisualPipePolylineGraph();
...
#endif // __mafVisualPipePolylineGraph_H__
