...
Module:    $RCSfile: albaPolylineGraph.h,v $
Language:  C++
...
#ifndef __albaPolylineGraph_h
#define __albaPolylineGraph_h
...
albaPolylineGraph provides top-level methods which always leave a self-consistent graph, ie SelfCheck() = true.
...
//----------------------------------------------------------------------------
class ALBA_EXPORT albaPolylineGraph
{
public:  
...
public:
  ...
  // public methods
  //-----------------------------------------------------------------------------
  albaPolylineGraph() ;                       ///< constructor: empty graph
  ~albaPolylineGraph() ;                      ///< destructor
...
private:
  ...
  // and can only be used by methods of albaPolylineGraph.
  //-----------------------------------------------------------------------------
