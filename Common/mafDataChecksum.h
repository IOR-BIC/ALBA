...
//----------------------------------------------------------------------------------
//Computes Adler32 checksum for the given data
inline /*static*/ unsigned long mafDataChecksum::Adler32Checksum(unsigned char* data, int len)
//----------------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------------
//Combines two checksums computed by Adler32Checksum to give a new one */
inline /*static*/unsigned long mafDataChecksum::CombineAdler32Checksums(
