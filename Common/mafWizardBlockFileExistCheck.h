...
#ifndef __mafWizardBlockFileExistCheck_H__
#define __mafWizardBlockFileExistCheck_H__
...
/**
  Class Name: mafWizardTypeFileExistCheck.
  Class for create a file exist check block
*/
class MAF_EXPORT mafWizardBlockFileExistCheck : public mafWizardBlock
{
public:

  /** Default constructor */
  mafWizardBlockFileExistCheck(const char *name);

  /** Default destructor */
  ~mafWizardBlockFileExistCheck();
