...
Module:    $RCSfile: wxWinEventAdapter.cpp,v $
Language:  C++
...
unsigned int wxWinEventAdapter::_s_accumulatedButtonMask = 0;

int wxWinEventAdapter::_s_button = 0;
int wxWinEventAdapter::_s_modKeyMask = 0;
float wxWinEventAdapter::_s_Xmin = 0;
float wxWinEventAdapter::_s_Xmax = 1280;
float wxWinEventAdapter::_s_Ymin = 0;
float wxWinEventAdapter::_s_Ymax = 1024;
float wxWinEventAdapter::_s_mx = 0;
float wxWinEventAdapter::_s_my = 0;

//--------------------------------------------------------------------------------
wxWinEventAdapter::wxWinEventAdapter():
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::copyStaticVariables()
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::setWindowSize(float Xmin, float Ymin, float Xmax, float Ymax)
//--------------------------------------------------------------------------------
{
    _s_Xmin = Xmin;
    _s_Xmax = Xmax;
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::setButtonMask(unsigned int buttonMask)
//--------------------------------------------------------------------------------
{
    _s_accumulatedButtonMask = buttonMask;
}
//--------------------------------------------------------------------------------
void wxWinEventAdapter::adaptResize(double time, float Xmin, float Ymin, float Xmax, float Ymax)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::adaptMouseScroll(double time, ScrollingMotion sm)
//--------------------------------------------------------------------------------
{
    _time = time;
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::adaptButtonPress(double time,float x, float y, unsigned int button)
//--------------------------------------------------------------------------------
{
    _time = time;
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::adaptButtonRelease(double time,float x, float y, unsigned int button)
//--------------------------------------------------------------------------------
{
    _time = time;
...
void wxWinEventAdapter::adaptMouseMotion(double time, float x, float y)
//--------------------------------------------------------------------------------
{
...
void wxWinEventAdapter::adaptKeyPress( double time, KeySymbol key)
//--------------------------------------------------------------------------------
{
    _eventType = KEYDOWN;
    _time = time;
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::adaptKeyRelease( double time, KeySymbol key)
//--------------------------------------------------------------------------------
{
...
//--------------------------------------------------------------------------------
void wxWinEventAdapter::adaptFrame(double time)
{
    _eventType = FRAME;
    _time = time;
    copyStaticVariables();
