...
Module:    $RCSfile: mafOsgCanvasEventAdapter.h,v $
Language:  C++
...
#ifndef __mafOsgCanvasEventAdapter_h__
#define __mafOsgCanvasEventAdapter_h__

#include <osgGA/GUIEventAdapter>

//--------------------------------------------------------------------------------
class mafOsgCanvasEventAdapter : public osgGA::GUIEventAdapter
//--------------------------------------------------------------------------------
{
public:
...
public:
    mafOsgCanvasEventAdapter();
    virtual ~mafOsgCanvasEventAdapter() {}
...
#endif //__mafOsgCanvasEventAdapter_h__
