/*=========================================================================
  ...
  Module:    $RCSfile: mafGUISashPanel.cpp,v $
  Language:  C++
...
// mafGUISashPanel
//----------------------------------------------------------------------------
BEGIN_EVENT_TABLE(mafGUISashPanel,wxSashLayoutWindow)
  EVT_BUTTON (ID_CLOSE_SASH, mafGUISashPanel::OnHide)
END_EVENT_TABLE()

#define mafGUISashPanelStyle wxNO_BORDER|wxSW_3D|wxCLIP_CHILDREN
//----------------------------------------------------------------------------
mafGUISashPanel::mafGUISashPanel (wxWindow* parent,wxWindowID id, wxDirection side , int defaultsize, wxString menu_string, bool sizable ) 
 : wxSashLayoutWindow(parent,id,wxDefaultPosition,wxSize(100, 100), mafGUISashPanelStyle)         
//----------------------------------------------------------------------------
{
  m_CurrentGui = new mafGUIPanel(this,-1);
...
//----------------------------------------------------------------------------
mafGUISashPanel::~mafGUISashPanel( ) 
//----------------------------------------------------------------------------
{
}
//----------------------------------------------------------------------------
void mafGUISashPanel::OnHide( wxCommandEvent &event )
//----------------------------------------------------------------------------
{
  // notify Logic
...
//----------------------------------------------------------------------------
bool mafGUISashPanel::Show(bool show)
//----------------------------------------------------------------------------
{
  // call show/hide
...
//----------------------------------------------------------------------------
bool mafGUISashPanel::Put(wxWindow* win)
//----------------------------------------------------------------------------
{
  assert(m_CurrentGui);
