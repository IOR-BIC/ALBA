...
#ifndef __albaGUISettingsTimeBar_H__
#define __albaGUISettingsTimeBar_H__
...
/**
  class name: albaGUISettingsTimeBar
  Gui class for handling time bar properties inside application settings panel.
*/
class albaGUISettingsTimeBar : public albaGUISettings
{
public:
  /** constructor */
