...
=========================================================================*/
#ifndef __mafGUIWizard_H__
#define __mafGUIWizard_H__
//----------------------------------------------------------------------------
// Include:
//----------------------------------------------------------------------------
...
*/
class MAF_EXPORT mafGUIWizard : public wxWizard, public mafObserver  
{
public:
  /** constructor. */
	mafGUIWizard (const wxString& title, bool testMode = false);
  /** destructor. */
	virtual ~mafGUIWizard (); 
  ...
  /** Message Ids */
	enum ID_MESSAGES
	{
		MAF_WIZARD_CHANGE_PAGE = MINID,
    MAF_WIZARD_CHANGED_PAGE,
		ID_LAST,
	};
