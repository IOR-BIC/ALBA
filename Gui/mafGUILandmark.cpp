...
//----------------------------------------------------------------------------
void mafGUILandmark::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafGUILandmark::CreateTranslateISACompositor()
//----------------------------------------------------------------------------
{
  assert(m_Landmark);
...
//----------------------------------------------------------------------------
void mafGUILandmark::RefSysVmeChanged()
//----------------------------------------------------------------------------
{
...
void mafGUILandmark::OnVmePicked(mafEvent& e)
{ 
...
//----------------------------------------------------------------------------
void mafGUILandmark::OnTranslate(mafEvent &e)
//----------------------------------------------------------------------------
{
...
void mafGUILandmark::SetGUIStatusToDisabled()
{
  m_GUIStatus = DISABLED;
  this->UpdateGuiInternal();
} 
   
 void mafGUILandmark::SetGUIStatusToPick() 
{
  if (m_Landmark)
  { 
...
void mafGUILandmark::SetGUIStatusToEnabled() 
{
  m_GUIStatus = ENABLED;
  if (m_Gui)
  {
...
void mafGUILandmark::UpdateGuiInternal()
{
  assert(m_Gui);  
...
void mafGUILandmark::GetSpawnPointCoordinates(double newPointCoord[3]) 
{   
  vtkIdType pId;
...
void mafGUILandmark::SpawnLandmark()
{    
  // create new landmark   
  int lmNumber = m_LMCloud->GetNumberOfLandmarks();
  wxString  name(m_LandmarkName);
...
void mafGUILandmark::UpdateInteractor()
{ 
  m_IsaTranslateSnap->SetVME(m_Landmark);
  m_IsaTranslateSnap->GetTranslationConstraint()->GetRefSys()->SetTypeToView();
  // set the pivot point
...
//----------------------------------------------------------------------------
void mafGUILandmark::OnRefSysVmeChanged()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafGUILandmark::TextEntriesChanged()
//----------------------------------------------------------------------------
{
  // build the matrix to be applied to vme:
...
//----------------------------------------------------------------------------
void mafGUILandmark::SetGuiAbsPosition(vtkMatrix4x4* absPose, mafTimeStamp timeStamp)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafGUILandmark::SetRefSysVME(mafVME* refSysVME)
//----------------------------------------------------------------------------
{
