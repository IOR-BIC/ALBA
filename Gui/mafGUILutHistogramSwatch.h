...
public:
  /** constructor. */
  mafGUILutHistogramSwatch(wxWindow* parent, wxWindowID id = -1, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(184,18), long style = wxTAB_TRAVERSAL );

  /** constructor. */
  mafGUILutHistogramSwatch::mafGUILutHistogramSwatch(mafGUI *parent, wxWindowID id, wxString name, vtkDataSet *dataSet, mmaVolumeMaterial *material, wxSize size = wxSize(184,18), bool showText=true);
...
protected:
  ...
  /* If Editable run mafGUILutHistogramEditor */
