/*========================================================================= 
  ...
  Module: $RCSfile: mafGUIDynamicVP.h,v $ 
  Language: C++ 
...
#ifndef __mafGUIDynamicVP_H__
#define __mafGUIDynamicVP_H__
...
//----------------------------------------------------------------------------
/**
 mafGUIDynamicVP is a wxPanel with a set of widget to handle dynamic 
...
mafEvent::GetArg). mafGUIDynamicVP can be configured so it does not contain
...
//----------------------------------------------------------------------------
class MAF_EXPORT mafGUIDynamicVP: public mafGUIPanel, public mafObserver
{
public:  
...
public:
  /** constructor */
  mafGUIDynamicVP(wxWindow* parent, wxWindowID id, 
    long GUIstyle =  GS_DEFAULT, 
    const wxPoint& pos = wxDefaultPosition, 
    const wxSize& size = wxDefaultSize, long style = wxTAB_TRAVERSAL);
  /** destructor */
  virtual ~mafGUIDynamicVP();    
