/*========================================================================= 
  ...
  Module: $RCSfile: mafGUIDynamicVP.cpp,v $ 
  Language: C++ 
...
BEGIN_EVENT_TABLE(mafGUIDynamicVP,mafGUIPanel)
  EVT_CUSTOM(wxEVT_DEFERED_DELETE, wxID_ANY, mafGUIDynamicVP::OnDeferedDelete)
END_EVENT_TABLE()
//----------------------------------------------------------------------------

//----------------------------------------------------------------------------
mafGUIDynamicVP::mafGUIDynamicVP( wxWindow* parent, wxWindowID id, long GUIstyle,
...
//----------------------------------------------------------------------------
mafGUIDynamicVP::~mafGUIDynamicVP()
//----------------------------------------------------------------------------
{  
  OnCloseVP();  
}
...
/*virtual*/ wxSizer* mafGUIDynamicVP::CreateGUI(long style)
//------------------------------------------------------------------------
{
  m_ComboVP = NULL;
...
void mafGUIDynamicVP::SetVPipesList(const SUPPORTED_VP_ENTRY* pList)
//------------------------------------------------------------------------
{
  if (m_VPipes != pList)
  {
...
void mafGUIDynamicVP::SetSceneNode(mafSceneNode* node)
//------------------------------------------------------------------------
{
  if (m_SceneNode != node)
  {
...
void mafGUIDynamicVP::SetVPipeIndex(int nNewIndex)
//------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafGUIDynamicVP::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{
...
/*virtual*/ void mafGUIDynamicVP::NotifyListener(long nData)
{
...
/*virtual*/ void mafGUIDynamicVP::OnCreateVP()
//------------------------------------------------------------------------
{
  wxCursor busy;
...
/*virtual*/ void mafGUIDynamicVP::OnCloseVP()
//------------------------------------------------------------------------
{
  //destroy GUI & pipe
  if (m_VPipe != NULL)
...
void mafGUIDynamicVP::OnDeferedDelete(wxEvent& event)
//------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------
//Sets a new style
void mafGUIDynamicVP::SetGUIStyle(long newstyle)
//------------------------------------------------------------------------
{
...
void mafGUIDynamicVP::SetName(const char* szNewName)
//------------------------------------------------------------------------
{  
  m_Name = szNewName;
  m_GUI_This->TransferDataToWindow();
...
/*virtual*/ void mafGUIDynamicVP::CreateVisualPipe(const char* classname)
//------------------------------------------------------------------------
{
  DestroyVisualPipe();
