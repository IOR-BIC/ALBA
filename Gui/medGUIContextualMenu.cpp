...
// Event Table:
//----------------------------------------------------------------------------
BEGIN_EVENT_TABLE(medGUIContextualMenu,wxMenu)
  EVT_MENU_RANGE(CONTEXTUAL_VIEW_MENU_START, CONTEXTUAL_VIEW_MENU_STOP, medGUIContextualMenu::OnContextualViewMenu)
END_EVENT_TABLE()
...
//----------------------------------------------------------------------------
void medGUIContextualMenu::ShowContextualMenu(wxFrame *child, mafView *view, bool vme_menu)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medGUIContextualMenu::OnContextualViewMenu(wxCommandEvent& event)
//----------------------------------------------------------------------------
{
	switch(event.GetId())
	{
