/*=========================================================================
 ...
 Module: albaTransferFunction2DInteractors
...
//------------------------------------------------------------------------
{
  if (m_Dialog->m_SlicePipeStatus != albaGUIDialogTransferFunction2D::PipePlugged)
    return;
...
//------------------------------------------------------------------------
{
  if (this->m_Dialog->m_SlicePipeStatus != albaGUIDialogTransferFunction2D::PipePlugged)
    return;
...
//------------------------------------------------------------------------
void vtkWidgetActor::SetTransferFunction(vtkALBATransferFunction2D *tf) 
//------------------------------------------------------------------------
{
