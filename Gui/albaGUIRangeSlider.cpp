...
BEGIN_EVENT_TABLE(albaGUIRangeSlider, wxControl)
  EVT_LEFT_DOWN(albaGUIRangeSlider::OnMouse)	
  EVT_LEFT_UP(albaGUIRangeSlider::OnMouse)	
  EVT_MOTION(albaGUIRangeSlider::OnMouse)
  EVT_PAINT(albaGUIRangeSlider::OnPaint)
  EVT_COMMAND_RANGE(MINID, MAXID, wxEVT_COMMAND_SLIDER_UPDATED, albaGUIRangeSlider::OnRangeModified)
END_EVENT_TABLE()

int     albaGUIRangeSlider::m_TriangleWidgetRadius = 5;
wxPoint albaGUIRangeSlider::m_TriangleWidgetCenter(0, 5);
wxPoint albaGUIRangeSlider::m_TriangleWidgetPoints[3] = { wxPoint(0, 0), wxPoint(5, 10), wxPoint(-5, 10) };

//----------------------------------------------------------------------------
albaGUIRangeSlider::albaGUIRangeSlider(wxWindow *parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name) : wxControl(parent, id, pos, size, style) 
//----------------------------------------------------------------------------
{ 
  this->Initialize();
...
//----------------------------------------------------------------------------
void albaGUIRangeSlider::SetValue(int i, double value) 
//----------------------------------------------------------------------------
{
  assert(i >= 0 && i < 3);
...
//----------------------------------------------------------------------------
{
  albaEventMacro(albaEvent(this, this->GetId()));
}
