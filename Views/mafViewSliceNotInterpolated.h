...
#ifndef __mafViewSliceNotInterpolated_H__
#define __mafViewSliceNotInterpolated_H__
...
//----------------------------------------------------------------------------
class MAF_EXPORT mafViewSliceNotInterpolated : public mafViewVTK
//----------------------------------------------------------------------------
{
public:
  ...
  /** RTTI Macro */
  mafTypeMacro(mafViewSliceNotInterpolated, mafViewVTK);

  /** ctor */
  mafViewSliceNotInterpolated(wxString label = "View Slice not interpolated", bool show_ruler = false);

  /** dtor */
  ~mafViewSliceNotInterpolated(); 
...
#endif //#ifndef __mafViewSliceNotInterpolated_H__