/*=========================================================================
  ...
  Module:    $RCSfile: medViewOrthoSliceRotatedVolumesDebugger.cpp,v $
  Language:  C++
...
#include "medViewOrthoSliceRotatedVolumesDebugger.h"
...
//----------------------------------------------------------------------------
mafCxxTypeMacro(medViewOrthoSliceRotatedVolumesDebugger);
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
medViewOrthoSliceRotatedVolumesDebugger::medViewOrthoSliceRotatedVolumesDebugger(wxString label)
...
//----------------------------------------------------------------------------
medViewOrthoSliceRotatedVolumesDebugger::~medViewOrthoSliceRotatedVolumesDebugger()
//----------------------------------------------------------------------------
{  

}
//----------------------------------------------------------------------------
mafView *medViewOrthoSliceRotatedVolumesDebugger::Copy(mafObserver *Listener)
//----------------------------------------------------------------------------
{
  medViewOrthoSliceRotatedVolumesDebugger *v = new medViewOrthoSliceRotatedVolumesDebugger(m_Label);
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::VmeShow(mafNode *node, bool show)
//----------------------------------------------------------------------------
{
	...
	else if(node->IsMAFType(mafVMESurface))
	{
		if(show)
		{
			((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_XN_VIEW]))->SetSliceLocalOrigin(m_GizmoHandlePosition);
			((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_YN_VIEW]))->SetSliceLocalOrigin(m_GizmoHandlePosition);
			((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_ZN_VIEW]))->SetSliceLocalOrigin(m_GizmoHandlePosition);
		}
		else
		{
			((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_XN_VIEW]))->UpdateSurfacesList(node);
			((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_YN_VIEW]))->UpdateSurfacesList(node);
			((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_ZN_VIEW]))->UpdateSurfacesList(node);
		}
	}
  else if(((mafVME *)node)->GetOutput()->IsA("mafVMEOutputPolyline"))
  {
    
    mafPipePolyline *pipePolyX = mafPipePolyline::SafeDownCast(((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_XN_VIEW]))->GetNodePipe(node));
    if(pipePolyX)
    {
    ...
    mafPipePolyline *pipePolyY = mafPipePolyline::SafeDownCast(((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_YN_VIEW]))->GetNodePipe(node));
    if(pipePolyY)
    {
      if(node->IsA("mafVMEMeter"))
      {
    ...
    mafPipePolyline *pipePolyZ = mafPipePolyline::SafeDownCast(((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_ZN_VIEW]))->GetNodePipe(node));
    if(pipePolyZ)
    {
      if(node->IsA("mafVMEMeter"))
      {
    ...
    mafPipePolylineSlice *pipeSliceX = mafPipePolylineSlice::SafeDownCast(((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_XN_VIEW]))->GetNodePipe(node));
    if(pipeSliceX) 
    {
      if(node->IsA("mafVMEMeter"))
      {
    ...
    mafPipePolylineSlice *pipeSliceY = mafPipePolylineSlice::SafeDownCast(((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_YN_VIEW]))->GetNodePipe(node));
    if(pipeSliceY) 
    {
      if(node->IsA("mafVMEMeter"))
      {
    ...
    mafPipePolylineSlice *pipeSliceZ = mafPipePolylineSlice::SafeDownCast(((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_ZN_VIEW]))->GetNodePipe(node));
    if(pipeSliceZ) 
    {
      if(node->IsA("mafVMEMeter"))
      {
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::VmeRemove(mafNode *node)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::CreateGuiView()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{
  ...
  /*    case ID_SIDE_ORTHO:
      {          
        if (m_Side == 1)
        {
          ((medViewSliceRotatedVolumesDebugger *)m_ChildViewList[CHILD_XN_VIEW])->CameraSet(CAMERA_RX_RIGHT);
          ((medViewSliceRotatedVolumesDebugger*)m_ChildViewList[CHILD_XN_VIEW])->CameraUpdate();
        }
        else
        {
          ((medViewSliceRotatedVolumesDebugger *)m_ChildViewList[CHILD_XN_VIEW])->CameraSet(CAMERA_RX_LEFT);
          ((medViewSliceRotatedVolumesDebugger*)m_ChildViewList[CHILD_XN_VIEW])->CameraUpdate();
        }
      }
      break;*/
      ...
      case ID_LUT_CHOOSER:
      {
        ...
        for(int i=0; i<m_NumOfChildView; i++)
        {
          mafPipeVolumeSlice_BES *p = (mafPipeVolumeSlice_BES *)((medViewSliceRotatedVolumesDebugger *)m_ChildViewList[i])->GetNodePipe(m_CurrentVolume);
      ...
      {
        if(((medViewSliceRotatedVolumesDebugger *)m_ChildViewList[0])->VolumeIsVisible())
        {
          double low, hi;
...
//-------------------------------------------------------------------------
mafGUI* medViewOrthoSliceRotatedVolumesDebugger::CreateGui()
//-------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::PackageView()
//----------------------------------------------------------------------------
{
  ...
  {
    m_Views[v] = new medViewSliceRotatedVolumesDebugger(viewName[v], cam_pos[v],false,false,false,0,TICKs[v]);
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::EnableWidgets(bool enable)
//----------------------------------------------------------------------------
{
  if (m_Gui)
  {
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::GizmoCreate()
//----------------------------------------------------------------------------
{
  if( m_Gizmo[0] || m_Gizmo[1] || m_Gizmo[2] ) GizmoDelete();
	...
	if(m_CurrentVolume)
	{
		...
		for(gizmoId=GIZMO_XN; gizmoId<GIZMOS_NUMBER; gizmoId++) 
		{
			...
			p = mafPipeVolumeSlice_BES::SafeDownCast(((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[0]))->GetNodePipe(m_CurrentVolume));
      double normal[3];
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::GizmoDelete()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::SetSlicePosition(long activeGizmoId, vtkPoints *p)
//----------------------------------------------------------------------------
{
  ...
  ((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_PERSPECTIVE_VIEW]))->SetSliceLocalOrigin(m_GizmoHandlePosition);
  

  this->CameraUpdate();
}
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::OnEventSetThickness()
//----------------------------------------------------------------------------
{
	if(m_AllSurface)
	{
...
//-------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::Print(std::ostream& os, const int tabs)// const
//-------------------------------------------------------------------------
{
  mafIndent indent(tabs);

  os << indent << "medViewOrthoSliceRotatedVolumesDebugger" << '\t' << this << std::endl;
...
//-------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::CreateOrthoslicesAndGizmos( mafNode * node )
//-------------------------------------------------------------------------
{
  if (node == NULL)
  {
  ...
  double colorsZ[]    = {0,0,1};
	...
	((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_XN_VIEW]))->SetSliceLocalOrigin(m_GizmoHandlePosition);
  ((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_XN_VIEW]))->SetTextColor(colorsX);
	((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_YN_VIEW]))->SetSliceLocalOrigin(m_GizmoHandlePosition);
  ((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_YN_VIEW]))->SetTextColor(colorsY);
	((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_ZN_VIEW]))->SetSliceLocalOrigin(m_GizmoHandlePosition);
  ((medViewSliceRotatedVolumesDebugger *)((mafViewCompound *)m_ChildViewList[CHILD_ZN_VIEW]))->SetTextColor(colorsZ);
	GizmoCreate();
}
//-------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::DestroyOrthoSlicesAndGizmos()
//-------------------------------------------------------------------------
{
	// Destroy Ortho Stuff
  if (m_CurrentVolume == NULL)
...
//-------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::ResetSlicesPosition( mafNode *node )
//-------------------------------------------------------------------------
{
  // workaround... :(
...
//----------------------------------------------------------------------------
void medViewOrthoSliceRotatedVolumesDebugger::SetThicknessForAllSurfaceSlices(mafNode *root)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
bool medViewOrthoSliceRotatedVolumesDebugger::IsPickedSliceView()
//----------------------------------------------------------------------------
{
  ...
  if (rwi)
  {
    for(int i=0; i<m_NumOfChildView; i++)
    {
      ...
      {
        if(((medViewSliceRotatedVolumesDebugger *)m_ChildViewList[i])->GetRWI()==rwi && ((medViewSliceRotatedVolumesDebugger *)m_ChildViewList[i])->GetRWI()->GetCamera()->GetParallelProjection())
          return true;
      }
