...
//----------------------------------------------------------------------------
/** 
mafViewGlobalSlice is a View that visualize volume as slices and 
...
class mafViewGlobalSlice: public mafViewSlice
{
public:
  mafViewGlobalSlice(wxString label = "Slice", int camera_position = CAMERA_CT, bool show_axes = false, bool show_grid = false, bool show_ruler = false, int stereo = 0,bool showTICKs=false);
  virtual ~mafViewGlobalSlice(); 

  mafTypeMacro(mafViewGlobalSlice, mafViewSlice);
