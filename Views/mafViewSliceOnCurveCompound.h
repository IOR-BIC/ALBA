...
Module: $RCSfile: mafViewSliceOnCurveCompound.h,v $ 
Language: C++ 
...
#ifndef __mafViewSliceOnCurveCompound_H__
#define __mafViewSliceOnCurveCompound_H__
...
//----------------------------------------------------------------------------
// mafViewSliceOnCurveCompound :
//----------------------------------------------------------------------------
/** 
This compound view is made of four child views used to analyze different orthogonal slices of the volume*/
class MAF_EXPORT mafViewSliceOnCurveCompound: public mafViewCompoundWindowing
{
public:

  mafViewSliceOnCurveCompound(wxString label = "View Slice on Curve");
  virtual ~mafViewSliceOnCurveCompound(); 

  mafTypeMacro(mafViewSliceOnCurveCompound, mafViewCompoundWindowing);
...
public:
  ...
  inline virtual int GetNumberOfLayouts() {
    return mafViewSliceOnCurveCompound::MAX_LAYOUTS;
  }
