...
//----------------------------------------------------------------------------
void mafViewSliceBlend::GetLutRange(double minMax[2])
{
	if (!m_CurrentVolume)
		return;
...
//----------------------------------------------------------------------------
double* mafViewSliceBlend::GetSlice(int nSlice)
{
	if (nSlice == 0)
		return m_Slice1;
...
//-------------------------------------------------------------------------
void mafViewSliceBlend::SetOpacity(double opacity)
{
	if (m_CurrentVolume)
	{
		if (opacity == 1.0) 
