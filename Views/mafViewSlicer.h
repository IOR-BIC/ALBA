...
#ifndef __mafViewSlicer_H__
#define __mafViewSlicer_H__
...
class MAF_EXPORT mafViewSlicer: public mafViewCompoundWindowing
{
public:
  mafViewSlicer(wxString label = "View Arbitrary Slice", bool show_ruler = false);
  virtual ~mafViewSlicer(); 

  mafTypeMacro(mafViewSlicer, mafViewCompoundWindowing);
