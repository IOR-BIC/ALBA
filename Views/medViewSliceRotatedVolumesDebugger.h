...
=========================================================================*/
#ifndef __medViewSliceRotatedVolumesDebugger_H__
#define __medViewSliceRotatedVolumesDebugger_H__
...
//----------------------------------------------------------------------------
// medViewSliceRotatedVolumesDebugger :
//----------------------------------------------------------------------------
/** 
medViewSliceRotatedVolumesDebugger is a View that visualize volume as slices and 
...
class medViewSliceRotatedVolumesDebugger: public mafViewVTK
{
public:
  medViewSliceRotatedVolumesDebugger(wxString label = "Slice", int camera_position = CAMERA_CT, bool show_axes = false, bool show_grid = false, bool show_ruler = false, int stereo = 0,bool showTICKs=false);
  virtual ~medViewSliceRotatedVolumesDebugger(); 

  mafTypeMacro(medViewSliceRotatedVolumesDebugger, mafViewVTK);
