/*=========================================================================
  ...
  Module:    $RCSfile: medViewOrthoSliceRotatedVolumesDebugger.h,v $
  Language:  C++
...
#ifndef __medViewOrthoSliceRotatedVolumesDebugger_H__
#define __medViewOrthoSliceRotatedVolumesDebugger_H__
...
class medViewSliceRotatedVolumesDebugger;
class mafVMEVolume;
...
//----------------------------------------------------------------------------
// medViewOrthoSliceRotatedVolumesDebugger :
//----------------------------------------------------------------------------
/** 
...
class medViewOrthoSliceRotatedVolumesDebugger: public mafViewCompound
{
public:
  medViewOrthoSliceRotatedVolumesDebugger(wxString label = "View OrthoSlice");
  virtual ~medViewOrthoSliceRotatedVolumesDebugger(); 

  mafTypeMacro(medViewOrthoSliceRotatedVolumesDebugger, mafViewCompound);
...
protected:
  ...
  medViewSliceRotatedVolumesDebugger *m_Views[4]; ///< Child views
