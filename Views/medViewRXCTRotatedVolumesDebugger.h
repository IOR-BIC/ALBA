/*=========================================================================
  ...
  Module:    $RCSfile: medViewRXCTRotatedVolumesDebugger.h,v $
  Language:  C++
...
#ifndef __medViewRXCTRotatedVolumesDebugger_H__
#define __medViewRXCTRotatedVolumesDebugger_H__
...
// forward references :
//----------------------------------------------------------------------------
class medViewRXRotatedVolumesDebugger;
class mafVMEVolume;
...
class medViewRXCTRotatedVolumesDebugger : public mafViewCompound
{
public:
  medViewRXCTRotatedVolumesDebugger(wxString label = "View RXCT Rotated Volumes Debugger");
  virtual ~medViewRXCTRotatedVolumesDebugger(); 

  mafTypeMacro(medViewRXCTRotatedVolumesDebugger, mafViewCompound);
...
protected:
  ...
  medViewRXRotatedVolumesDebugger       *m_ViewsRX[2];
