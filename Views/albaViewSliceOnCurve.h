/*========================================================================= 
  ...
  Module: $RCSfile: albaViewSliceOnCurve.h,v $ 
  Language: C++ 
...
#ifndef __albaViewSliceOnCurve_H__
#define __albaViewSliceOnCurve_H__
...
//----------------------------------------------------------------------------
// albaViewSliceOnCurve :
//----------------------------------------------------------------------------
/** 
This compound view is made of four child views used to analyze different orthogonal slices of the volume*/
class ALBA_EXPORT albaViewSliceOnCurve: public albaViewCompound
{
public:

  albaViewSliceOnCurve(wxString label = "View Slice on Curve");
  virtual ~albaViewSliceOnCurve(); 

  albaTypeMacro(albaViewSliceOnCurve, albaViewCompound);
...
public:
  ...
  inline virtual const VPIPE_ENTRY* GetVolumePipesDesc() {    
    return albaViewSliceOnCurve::m_VolumePipes;
  }  
