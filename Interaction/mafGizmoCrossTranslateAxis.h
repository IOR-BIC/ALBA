...
#ifndef __mafGizmoCrossTranslateAxis_H__
#define __mafGizmoCrossTranslateAxis_H__
...
/** Basic gizmo component used to perform constrained translation on one axis.
  ...
  @sa mafGizmoCrossTranslate 
*/
class mafGizmoCrossTranslateAxis: public mafGizmoInterface 
{
public:
           mafGizmoCrossTranslateAxis(mafVME *input, mafObserver *listener = NULL);
  virtual ~mafGizmoCrossTranslateAxis(); 
