/*=========================================================================
 ...
 Program: MAF2
 Module: mafInteractorConstraint
...
public:
  ...
  virtual ~mafInteractorConstraint();

  /** Copy constructor to allow object copy */
  mafInteractorConstraint(const mafInteractorConstraint& source);
  ...
  */
  ...
  void DeepCopy(const mafInteractorConstraint *source) { *this=*source;}
