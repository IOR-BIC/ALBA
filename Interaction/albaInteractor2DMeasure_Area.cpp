...
Module:    albaInteractor2DMeasure_Area.cpp
Language:  C++
...
#include "albaInteractor2DMeasure_Area.h"
...
//------------------------------------------------------------------------------
albaCxxTypeMacro(albaInteractor2DMeasure_Area)

//----------------------------------------------------------------------------
albaInteractor2DMeasure_Area::albaInteractor2DMeasure_Area() : albaInteractor2DMeasure_Distance()
{
	m_ShowText = false;
	m_TextSide = 1;

	m_MeasureTypeText = "AREA";
...
//----------------------------------------------------------------------------
albaInteractor2DMeasure_Area::~albaInteractor2DMeasure_Area(){}

/// RENDERING ////////////////////////////////////////////////////////////////

//----------------------------------------------------------------------------
void albaInteractor2DMeasure_Area::EditMeasure(int index, double *point)
{
...
/// LOAD/SAVE ////////////////////////////////////////////////////////////////
//---------------------------------------------------------------------------
bool albaInteractor2DMeasure_Area::Load(albaVME *input, wxString tag)
{
...
//---------------------------------------------------------------------------
bool albaInteractor2DMeasure_Area::Save(albaVME *input, wxString tag)
{
	bool result = false;
