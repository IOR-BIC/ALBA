...
//----------------------------------------------------------------------------
void mafInteractorDICOMImporter::SetRWI(mafRWI *rwi)
{
...
//----------------------------------------------------------------------------
void mafInteractorDICOMImporter::CalculateSideDragged(double * pos)
{
	double P1[3], P2[3];
...
//------------------------------------------------------------------------------
void mafInteractorDICOMImporter::OnEvent(mafEventBase *event)
{
	assert(event);
...
//----------------------------------------------------------------------------
void mafInteractorDICOMImporter::GetPlaneBounds(double *bounds)
{
	m_CropPlane->GetOutput()->GetBounds(bounds);
}

//----------------------------------------------------------------------------
void mafInteractorDICOMImporter::SetSliceBounds(double *bounds)
{
...
//----------------------------------------------------------------------------
void mafInteractorDICOMImporter::SetPlaneFromSliceSize()
{
...
//----------------------------------------------------------------------------
void mafInteractorDICOMImporter::PlaneVisibilityOn()
{
...
//----------------------------------------------------------------------------
void mafInteractorDICOMImporter::PlaneVisibilityOff()
{
	m_PlaneVisibility = false;
	m_CropActor->VisibilityOff();
}
