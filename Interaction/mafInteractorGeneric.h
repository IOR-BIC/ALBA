/*=========================================================================
  ...
  Module:    $RCSfile: mafInteractorGeneric.h,v $
  Language:  C++
...
#ifndef __mafInteractorGeneric_h
#define __mafInteractorGeneric_h
...
*/
class mafInteractorGeneric : public mafInteractor
{
public:
  //------------------------------------------------------------------------------
  // Events
  ...
  static mafInteractorGeneric *New();
  vtkTypeMacro(mafInteractorGeneric,mafInteractor);
  ...
  mafInteractorConstraint *GetTranslationConstraint() {return TranslationConstraint;}
  /** 
  ...
  /**
    ...
    allowed constrains are  LOCK, FREE, SNAP_STEP, SNAP_ARRAY. To set the constraint
    retrieve the constrain object and set it.*/
  mafInteractorConstraint *GetRotationConstraint() {return RotationConstraint;}
  /** 
  ...
  /**
    ...
    allowed constrains are  LOCK, FREE, SNAP_STEP, SNAP_ARRAY. To set the constraint
    retrieve the constrain object and set it.*/
  mafInteractorConstraint *GetScaleConstraint() {return ScaleConstraint;}
  /** 
...
protected:
  mafInteractorGeneric();
  virtual ~mafInteractorGeneric();
  
  mafInteractorConstraint  *TranslationConstraint; ///< the constrain for translation
  mafInteractorConstraint  *RotationConstraint;    ///< the constrain for rotation
  mafInteractorConstraint  *ScaleConstraint;       ///< the constrain for scaling
...
private:
  mafInteractorGeneric(const mafInteractorGeneric&);  // Not implemented.
  void operator=(const mafInteractorGeneric&);  // Not implemented.
};
