...
#ifndef __mafInteractorGenericMouse_h
#define __mafInteractorGenericMouse_h
...
/** Constrained interaction with mouse device.
  Use mafInteractorCompositorMouse in order to associate instances of this class
