...
#ifndef __mafGizmoCrossTranslatePlane_H__
#define __mafGizmoCrossTranslatePlane_H__
...
*/
class mafGizmoCrossTranslatePlane: public mafGizmoInterface 
{
public:
           mafGizmoCrossTranslatePlane(mafVME *input, mafObserver *listener = NULL);
  virtual ~mafGizmoCrossTranslatePlane(); 
