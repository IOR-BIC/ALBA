/*=========================================================================
  ...
  Module:    $RCSfile: mafInteractorGenericInterface.h,v $
  Language:  C++
...
#ifndef __mafInteractorGenericInterface_h
#define __mafInteractorGenericInterface_h
...
*/
class MAF_EXPORT mafInteractorGenericInterface : public mafInteractor
{
public:
  //------------------------------------------------------------------------------
  // Events
  ...
  mafAbstractTypeMacro(mafInteractorGenericInterface,mafInteractor);
  ...
  */
  ...
  mafInteractorConstraint *GetTranslationConstraint() {return m_TranslationConstraint;}
 
  /** 
    Set the translation constraint. Notice the constraint is copied and not referenced */
  void SetTranslationConstraint(mafInteractorConstraint *constrain);
      
  /** 
    Get the rotation constraint. To set the constraint retrieve the constrain object and set it.*/
  mafInteractorConstraint *GetRotationConstraint() {return m_RotationConstraint;}
  
  /** 
    Set the rotation constraint. Notice the constraint is copied and not referenced */
  void SetRotationConstraint(mafInteractorConstraint *constrain);

  /**
    Get the scale constraint. To set the constraint retrieve the constrain object and set it.*/
  mafInteractorConstraint *GetScaleConstraint() {return m_ScaleConstraint;}
  /** 
    Set the scaling constraint. Notice the constraint is copied and
    not referenced */
  void SetScaleConstraint(mafInteractorConstraint *constrain);
...
protected:
 ...
 /** Dervived classes should override this methods in order to set internal flags in
  ...
  mafInteractorConstraint  *m_TranslationConstraint; ///< the constrain for translation
  mafInteractorConstraint  *m_RotationConstraint;    ///< the constrain for rotation
  mafInteractorConstraint  *m_ScaleConstraint;       ///< the constrain for scaling
...
private:
  mafInteractorGenericInterface(const mafInteractorGenericInterface&);  // Not implemented.
  void operator=(const mafInteractorGenericInterface&);  // Not implemented.
};
