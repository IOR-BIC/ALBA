...
#ifndef __mafGizmoCrossRotateAxis_H__
#define __mafGizmoCrossRotateAxis_H__
...
*/
class mafGizmoCrossRotateAxis: public mafGizmoInterface
{
public:
           mafGizmoCrossRotateAxis(mafVME *input, mafObserver *listener = NULL);
  virtual ~mafGizmoCrossRotateAxis(); 
