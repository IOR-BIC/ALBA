...
IF (EXISTS "${CRYPTO_SOURCE_DIR}/Src")   
  SET (CRYPTO_SOURCE_PATH "${CRYPTO_SOURCE_DIR}/Src")
ENDIF (EXISTS "${CRYPTO_SOURCE_DIR}/Src")

#look if there is a package for CRYPTO
IF (EXISTS "${CRYPTO_SOURCE_DIR}/Packages")   
  MESSAGE(STATUS "CRYPTO: Found CRYPTO packages")
  # here we should unpack into "${CRYPTO_BINARY_DIR}/Src"
  SET (CRYPTO_PACKAGE_PATH "${CRYPTO_SOURCE_DIR}/Packages")
  ##The macro must run only one time
  SET (CRYPTO_SOURCE_PATH "${CRYPTO_BINARY_DIR}/Src")
  SET (CRYPTO_PATCH_PATH "${CRYPTO_SOURCE_DIR}/Patches")
  IF (NOT EXISTS "${CRYPTO_SOURCE_PATH}")
				FIND_AND_UNPACK_PACKAGE (CRYPTOPP565 ${CRYPTO_PACKAGE_PATH} "${CRYPTO_BINARY_DIR}/Src" ${CRYPTO_SOURCE_PATH})
