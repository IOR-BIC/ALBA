...
IF (EXISTS "${CURL_SOURCE_DIR}/Packages")   
  ...
  SET (CURL_SOURCE_PATH "${CURL_BINARY_DIR}/Src")
  IF (NOT EXISTS "${CURL_SOURCE_PATH}")
    FIND_AND_UNPACK_PACKAGE (curl ${CURL_PACKAGE_PATH} "${CURL_BINARY_DIR}/Src" ${CURL_SOURCE_PATH})
    FIND_AND_UNPACK_PACKAGE (CMake ${CURL_PACKAGE_PATH} "${CURL_BINARY_DIR}/Src" ${CURL_SOURCE_PATH})
...
#          BUILD_WXWIN_LIBRARY
#          ALL
#          ${CMAKE_COMMAND} -E chdir ${CURL_BINARY_DIR}/Src make install
#        )
#    ENDIF(WIN32)
