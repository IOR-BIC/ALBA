...
public:
           mafGUIVMEChooser(mafGUICheckTree *tree, wxString dialog_title="Vme Chooser", void *vme_accept_function = 0, long style = REPRESENTATION_AS_TREE, bool multiSelect = false, mafVME *subTree=NULL);
          ~mafGUIVMEChooser();
