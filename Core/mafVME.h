...
/** mafVME -
  ...
  */
class MAF_EXPORT mafVME : public mafReferenceCounted, public mafStorable, public mafObserver, public mafTimeStamped, public mafServiceClient, public mafEventBroadcaster
{
public:
