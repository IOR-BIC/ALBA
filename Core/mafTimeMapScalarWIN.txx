...
//-------------------------------------------------------------------------
{
  std::pair<mafTimeMapScalar<T>::TimeMapScalars::iterator,mafTimeMapScalar<T>::TimeMapScalars::iterator> range = m_TimeMap.equal_range(t);
