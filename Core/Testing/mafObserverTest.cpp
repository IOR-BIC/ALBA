...
int main()
{
  ...
  // test multiple subjects of other events
  ...
  first_subject.GetEventDummy().AddObserver(second_observer,10); // add high priority observer
  second_observer.SkipNext=true;
  first_subject.GetEventDummy().AddObserver(third_observer);
