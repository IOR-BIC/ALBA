...
#ifndef __mafOpComputeInertialTensor_H__
#define __mafOpComputeInertialTensor_H__
...
/** 
  class name: mafOpComputeInertialTensor
...
*/
class MAF_EXPORT mafOpComputeInertialTensor: public mafOp
{
public:
  /** constructor */
  mafOpComputeInertialTensor(const wxString &label = "ComputeInertialTensor");
  /** destructor */
  ~mafOpComputeInertialTensor();

  /** RTTI macro*/
  mafTypeMacro(mafOpComputeInertialTensor, mafOp);
