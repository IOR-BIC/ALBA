...
#include "mafOpMML3GlobalRegistration.h"
...
enum MML_IDS
{
  ...
  ID_NUSLICES_NUMBER_LAST = ID_NUSLICES_NUMBER_BEGIN + mafOpMML3::m_NumberOfNonUniformSections - 1,
  ID_NUSLICES_TOTAL,
  ID_NUSLICES_OK,
  ID_NUSLICES_CANCEL,
...
//----------------------------------------------------------------------------
// Constructor
mafOpMML3::mafOpMML3(const wxString &label) : mafOp(label)
//----------------------------------------------------------------------------
{
  //
  m_OpType = OPTYPE_OP;
...
//------------------------------------------------------------------------------
bool mafOpMML3::Accept(mafVME* vme)
//------------------------------------------------------------------------------
{ 
...
//----------------------------------------------------------------------------
mafOp* mafOpMML3::Copy() 
//------------------------------------------------------------------------------
{
  return new mafOpMML3(m_Label);
}
...
//----------------------------------------------------------------------------
void mafOpMML3::OpUndo() {}

//----------------------------------------------------------------------------
void mafOpMML3::OpStop(int result) {	mafEventMacro(mafEvent(this,result));}



//----------------------------------------------------------------------------
void mafOpMML3::OpRun()   
//----------------------------------------------------------------------------
{
  //----------------------------------------------------------------------------
...
void mafOpMML3::CreateInputsDlg() 
//----------------------------------------------------------------------------
{
  // create the dialog
  ...
  text_5->SetValidator(mafGUIValidator(this,ID_INPUTS_L1,text_5,&m_L1Name));
  mafGUIButton *b_5       = new mafGUIButton(m_InputsDlg ,ID_INPUTS_L1,"select",wxPoint(0,0), wxSize(50,20));
  ...
  text_6->SetValidator(mafGUIValidator(this,ID_INPUTS_L2,text_6,&m_L2Name));
  mafGUIButton *b_6       = new mafGUIButton(m_InputsDlg ,ID_INPUTS_L2,"select",wxPoint(0,0), wxSize(50,20));
  ...
  text_7->SetValidator(mafGUIValidator(this,ID_INPUTS_L3,text_7,&m_L3Name));
  mafGUIButton *b_7       = new mafGUIButton(m_InputsDlg ,ID_INPUTS_L3,"select",wxPoint(0,0), wxSize(50,20));
  ...
  text_8->SetValidator(mafGUIValidator(this,ID_INPUTS_L4,text_8,&m_L4Name));
  mafGUIButton *b_8       = new mafGUIButton(m_InputsDlg ,ID_INPUTS_L4,"select",wxPoint(0,0), wxSize(50,20));
  ...
  m_Radio_slicexyz->SetValidator(mafGUIValidator(this, ID_INPUTS_SLICEXYZ, m_Radio_slicexyz, &m_Slicexyz));
  ...
  text_axis1->SetValidator(mafGUIValidator(this, ID_INPUTS_AXIS1, text_axis1, &m_Axis1Name));
  mafGUIButton *button_axis1 = new mafGUIButton(m_InputsDlg, ID_INPUTS_AXIS1, "select", wxPoint(0,0), wxSize(50,20));
  ...
  text_axis2->SetValidator(mafGUIValidator(this, ID_INPUTS_AXIS2, text_axis2, &m_Axis2Name));
  mafGUIButton *button_axis2 = new mafGUIButton(m_InputsDlg, ID_INPUTS_AXIS2, "select", wxPoint(0,0), wxSize(50,20));
  ...
  text_axis3->SetValidator(mafGUIValidator(this, ID_INPUTS_AXIS3, text_axis3, &m_Axis3Name));
  mafGUIButton *button_axis3 = new mafGUIButton(m_InputsDlg, ID_INPUTS_AXIS3, "select", wxPoint(0,0), wxSize(50,20));
  ...
  nonUniformCheckBox->SetValidator(mafGUIValidator(this, ID_INPUTS_NONUNIFORM, nonUniformCheckBox, &m_NonUniformSliceSpacing));
  ...
  AxisScalingTxt->SetValidator(mafGUIValidator(this, ID_INPUTS_FAKE, AxisScalingTxt, &m_AxisRangeFactor, 1.0, 2.0)); // min/max values
  ...
  mafGUIButton *b_cancel = new mafGUIButton(m_InputsDlg, ID_INPUTS_CANCEL, "CANCEL", wxPoint(0,0), wxSize(50,20));
...
void mafOpMML3::DeleteInputsDlg() 
//----------------------------------------------------------------------------
{
  delete m_InputsDlg ;
}
...
void mafOpMML3::CreateRegistrationDlg()
//------------------------------------------------------------------------------
{ 
  // create dialog
  wxString Title;
  ...
  // preview button
  m_PreviewButton = new mafGUIButton(m_OpDlg, ID_REG_PREVIEW, "Preview On", wxPoint(0,0), wxSize(75,20));
  ...
  // reset view button
  m_ResetViewButton = new mafGUIButton(m_OpDlg, ID_REG_RESET_VIEW, "Reset View", wxPoint(0,0), wxSize(75,20));
  ...
  // ok button
  m_OkButton = new mafGUIButton(m_OpDlg, ID_REG_OK, "OK", wxPoint(0,0), wxSize(75,20));
  m_OkButton->SetListener(this);

  // cancel button
  m_CancelButton = new mafGUIButton(m_OpDlg, ID_REG_CANCEL, "CANCEL", wxPoint(0,0), wxSize(75,20));
  ...
  //c0->SetValidator( mafGUIValidator(this,ID_REG_DISPLAY_MODE,c0,&m_Show_axes) );
  //CheckBoxHorizontalBoxSizer->Add(c0,0,wxALL, 5);
  //wxCheckBox *c1 = new wxCheckBox(m_Op_dlg,ID_REG_PREVIEW,"show contour");
  //c1->SetValidator( mafGUIValidator(this,ID_REG_PREVIEW,c1,&m_ContourVisibility));
  ...
  m_Model = new mafOpMML3ModelView(m_ModelmafRWI->m_RenderWindow, m_ModelmafRWI->m_RenFront, 
  ...
  mafGUIButton *button_Plus1 = new mafGUIButton(m_OpDlg, ID_REG_PLUS1, ">", wxPoint(0,0), wxSize(30,20)) ; 
  ...
  m_PH = new mafOpMML3ParameterView(m_PHmafRWI->m_RenderWindow, m_PHmafRWI->m_RenFront); 
  m_PV = new mafOpMML3ParameterView(m_PVmafRWI->m_RenderWindow, m_PVmafRWI->m_RenFront);
  m_TH = new mafOpMML3ParameterView(m_THmafRWI->m_RenderWindow, m_THmafRWI->m_RenFront);
  m_TV = new mafOpMML3ParameterView(m_TVmafRWI->m_RenderWindow, m_TVmafRWI->m_RenFront);
  m_RA = new mafOpMML3ParameterView(m_RAmafRWI->m_RenderWindow, m_RAmafRWI->m_RenFront);
  m_SN = new mafOpMML3ParameterView(m_SNmafRWI->m_RenderWindow, m_SNmafRWI->m_RenFront);
  m_SS = new mafOpMML3ParameterView(m_SSmafRWI->m_RenderWindow, m_SSmafRWI->m_RenFront);
  m_SE = new mafOpMML3ParameterView(m_SEmafRWI->m_RenderWindow, m_SEmafRWI->m_RenFront);
  m_SW = new mafOpMML3ParameterView(m_SWmafRWI->m_RenderWindow, m_SWmafRWI->m_RenFront);

  // create mml contour widget
  m_Widget = mafOpMML3ContourWidget::New();
...
void mafOpMML3::DeleteRegistrationDlg()
//------------------------------------------------------------------------------
{ 
...
void mafOpMML3::CreateNonUniformSlicesDlg()
//------------------------------------------------------------------------------
{
  int i, total ;
  ...
  totalSlicesTxt->SetValidator(mafGUIValidator(this, ID_NUSLICES_TOTAL, totalSlicesTxt, &m_NumberOfScans));
  ...
  // ok/cancel buttons
  //----------------------------------------------------------------------------
  mafGUIButton *SliceOk = new mafGUIButton(m_NonUniformSlicesDlg, ID_NUSLICES_OK, "OK", wxPoint(0,0), wxSize(50,20));
  SliceOk->SetListener(this);

  mafGUIButton *b_cancel = new mafGUIButton(m_NonUniformSlicesDlg, ID_NUSLICES_CANCEL, "CANCEL", wxPoint(0,0), wxSize(50,20));
  b_cancel->SetListener(this);
  ...
  // create visual pipe
  //----------------------------------------------------------------------------
  m_NonUniformSlicePipe = new mafOpMML3NonUniformSlicePipe(m_MuscleGlobalReg, m_SectionsViewRWI->m_RenFront, m_NumberOfNonUniformSections) ;
...
void mafOpMML3::DeleteNonUniformSlicesDlg()
//------------------------------------------------------------------------------
{
...
void mafOpMML3::GetVtkInputs()
//------------------------------------------------------------------------------
{
  // get maf gray volume 
  m_VolumeVME = mafVMEVolumeGray::SafeDownCast(m_Input);
...
void mafOpMML3::GetAbsPosOfLandmark(mafVMELandmark *landmark, double point[3])
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
void mafOpMML3::Set2DButtonsEnable(bool enable)
{
...
void mafOpMML3::UpdateNonUniformVisualPipe()
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Event handler
void mafOpMML3::OnEvent(mafEventBase *maf_event) 
//------------------------------------------------------------------------------
{
...
void mafOpMML3::OnTextNumberChange(mafID id)
//------------------------------------------------------------------------------
{
  int i ;

  // update the total number of slices
  for (i = 0, m_NumberOfScans = 0; i < mafOpMML3::m_NumberOfNonUniformSections; i++)
...
void mafOpMML3::OnNonUniformCancel()
//------------------------------------------------------------------------------
{
...
void mafOpMML3::OnNumberOfSlices()
//------------------------------------------------------------------------------
{
  // enable warning if memory threshold exceeded
  double sliceMemory = (double)m_NumberOfScans * (double)(m_ScansGrain*m_ScansGrain) / (1024.0*1024.0) ;
...
void mafOpMML3::OnResolutionOfSlices()
//------------------------------------------------------------------------------
{
  // enable warning if memory threshold exceeded
  double sliceMemory = (double)m_NumberOfScans * (double)(m_ScansGrain*m_ScansGrain) / (1024.0*1024.0) ;
...
void mafOpMML3::OnRegistrationOK() 
//----------------------------------------------------------------------------
{
  // apply deformations
  ...
  // root vme
  mafVME *RootVME = m_Input->GetRoot();
  /*
...
//----------------------------------------------------------------------------
void mafOpMML3::OnRegistrationCANCEL()
//----------------------------------------------------------------------------
{
...
void mafOpMML3::OnMuscleSelection() 
//----------------------------------------------------------------------------
{
  ...
  // get vme surface
  m_SurfaceVME = mafVMESurface::SafeDownCast(vme);
  ...
  if (m_RegistrationStatus == 1)
  {
    ...
    //
    m_SurfaceVME = mafVMESurface::SafeDownCast(MuscleInAtlasSectionVME);
  }
...
//----------------------------------------------------------------------------
void mafOpMML3::OnResetView() 
//----------------------------------------------------------------------------
{
  int n = m_Model->GetRenderer()->GetActors()->GetNumberOfItems() ;
  mafLogMessage("no. of actors = %d", n) ;
  ...
  /* std::fstream thing ;
  thing.open("C:/Documents and Settings/Nigel/My Documents/Visual Studio Projects/MAF2/MML3/thing.txt", thing.out | thing.app) ;
...
//----------------------------------------------------------------------------
void mafOpMML3::OnLandmark1AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
  ...
  // patient - landmark 1
  // get parent node
  mafVME *L1PatientParentVME =root->FindInTreeByName(m_PatientMSFSectionName);
  ...
  // get landmark node
  mafVME *L1PatientVME = L1PatientParentVME->FindInTreeByName(vme->GetName());
...
//----------------------------------------------------------------------------
void mafOpMML3::OnLandmark2AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
  ...
  // patient - landmark 2
  // get parent node
  mafVME *L2PatientParentVME = root->FindInTreeByName(m_PatientMSFSectionName);
  ...
  // get landmark node
  mafVME *L2PatientVME = L2PatientParentVME->FindInTreeByName(vme->GetName());
...
//----------------------------------------------------------------------------
void mafOpMML3::OnLandmark3AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
  ...
  // patient - landmark 3
  // get parent node
  mafVME *L3PatientParentVME = root->FindInTreeByName(m_PatientMSFSectionName);
  ...
  // get landmark node
	mafVME *L3PatientVME = L3PatientParentVME->FindInTreeByName(vme->GetName());
...
//----------------------------------------------------------------------------
void mafOpMML3::OnLandmark4AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
...
void mafOpMML3::OnLandmarkAxis1AtlasSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
...
void mafOpMML3::OnLandmarkAxis2AtlasSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
...
void mafOpMML3::OnLandmarkAxis3AtlasSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
...
void mafOpMML3::CreateDefaultRegistrationLandmarks() 
//----------------------------------------------------------------------------
{
  assert(m_Input);
...
void mafOpMML3::CreateDefaultAxisLandmarks() 
//----------------------------------------------------------------------------
{
  assert(m_Input);
...
void mafOpMML3::ApplyAxisRangeFactor()
//------------------------------------------------------------------------------
{
  int i ;
...
void mafOpMML3::CalculateSlicePositionsAlongAxis(double *alpha) const
//------------------------------------------------------------------------------
{
...
bool mafOpMML3::SetUpParameterViews() 
//------------------------------------------------------------------------------
{
...
bool mafOpMML3::SetUpContourWidget()
//------------------------------------------------------------------------------
{
...
// All the allocated objects will be deleted with the output mafRWI.
mafRWI* mafOpMML3::CreateParameterViewmafRWI(vtkTextSource *ts, wxString lab, float r, float g, float b)
//----------------------------------------------------------------------------
{ 
...
void mafOpMML3::SetUpLandmarks1(wxString AtlasSectionVMEName, wxString PatientSectionVMEName)
//----------------------------------------------------------------------------
{
  int i;
  ...
  mafVME *AtlasSectionVME = RootVME->FindInTreeByName(AtlasSectionVMEName);
  ...
  mafVME *PatientSectionVME = RootVME->FindInTreeByName(PatientSectionVMEName);
  ...
  // atlas - landmark 1
  // get landmark node
  mafVME *Landmark1AtlasVME = AtlasSectionVME->FindInTreeByName(Landmark1VMEName);
  ...
  // atlas - landmark 2
  // get landmark node
  mafVME *Landmark2AtlasVME = AtlasSectionVME->FindInTreeByName(Landmark2VMEName);
  ...
  // atlas - landmark 3
  // get landmark node
  mafVME *Landmark3AtlasVME = AtlasSectionVME->FindInTreeByName(Landmark3VMEName);
  ...
  // atlas - landmark 4
  // get landmark node
  mafVME *Landmark4AtlasVME = AtlasSectionVME->FindInTreeByName(Landmark4VMEName);
  ...
  // patient - landmark 1
  // get landmark node
  mafVME *Landmark1PatientVME = PatientSectionVME->FindInTreeByName(Landmark1VMEName);
  ...
  // patient - landmark 2
  // get landmark node
  mafVME *Landmark2PatientVME = PatientSectionVME->FindInTreeByName(Landmark2VMEName);
  ...
  // patient - landmark 3
  // get landmark node
  mafVME *Landmark3PatientVME = PatientSectionVME->FindInTreeByName(Landmark3VMEName);
  ...
  // patient - landmark 4
  // get landmark node
  mafVME *Landmark4PatientVME = PatientSectionVME->FindInTreeByName(Landmark4VMEName);
...
//----------------------------------------------------------------------------
// Set up a specific set of landmarks
void mafOpMML3::SetUpLandmarks2(wxString AtlasSectionVMEName, wxString PatientSectionVMEName)
//----------------------------------------------------------------------------
{
  // landmarks (names)
...
//----------------------------------------------------------------------------
void mafOpMML3::OnPOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void mafOpMML3::OnTOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void mafOpMML3::OnROperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void mafOpMML3::OnSOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
  ...
  // is set to true, mafOpMML3ContourWidget::OnLeftButtonUp
...
void mafOpMML3::ApplyGlobalRegistration()
//----------------------------------------------------------------------------
{
  mafOpMML3GlobalRegistration *glob = new mafOpMML3GlobalRegistration() ;
