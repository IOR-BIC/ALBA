...
#ifndef __albaOpMatrixVectorMath_h
#define __albaOpMatrixVectorMath_h
...
//------------------------------------------------------------------------------
class ALBA_EXPORT albaOpMatrixVectorMath{
public:
  /// Constructor.
  albaOpMatrixVectorMath(bool homogeneous = false) : m_Homogeneous(homogeneous) {}
