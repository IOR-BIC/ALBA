...
#ifndef __mafOpMML3ContourWidget_h
#define __mafOpMML3ContourWidget_h
...
//------------------------------------------------------------------------------
class mafOpMML3ContourWidget : public vtkPolyDataSourceWidget
{
public:
  /// Instantiate the object.
  static mafOpMML3ContourWidget *New();

  vtkTypeRevisionMacro(mafOpMML3ContourWidget,vtkPolyDataSourceWidget);
  ...
  //----------------------------------------------------------------------------
  void SetPH(mafOpMML3ParameterView* PH) {m_PH = PH ;} ///< set the place horizontal parameter view
	void SetPV(mafOpMML3ParameterView* PV) {m_PV = PV ;} ///< set the place vertical parameter view
	void SetTH(mafOpMML3ParameterView* TH) {m_TH = TH ;} ///< set the translate horizontal parameter view
	void SetTV(mafOpMML3ParameterView* TV) {m_TV = TV ;} ///< set the translate vertical parameter view
	void SetRA(mafOpMML3ParameterView* RA) {m_RA = RA ;} ///< set the rotate parameter view
	void SetSN(mafOpMML3ParameterView* SN) {m_SN = SN ;} ///< set the scale north parameter view
	void SetSS(mafOpMML3ParameterView* SS) {m_SS = SS ;} ///< set the scale south parameter view
	void SetSE(mafOpMML3ParameterView* SE) {m_SE = SE ;} ///< set the scale east parameter view
	void SetSW(mafOpMML3ParameterView* SW) {m_SW = SW ;} ///< set the scale west parameter view

  void SetModel(mafOpMML3ModelView* Model) {m_Model = Model ;} ///< Set the model view
...
*/
  ...
  // Member variables
  //----------------------------------------------------------------------------
  mafOpMML3ModelView *m_Model; ///< model

  mafOpMML3ParameterView *m_PH; ///< horizontal place center
  mafOpMML3ParameterView *m_PV; ///< vertical place center
  mafOpMML3ParameterView *m_RA; ///< rotation
  mafOpMML3ParameterView *m_TH; ///< horizontal translation
  mafOpMML3ParameterView *m_TV; ///< vertical translation
  mafOpMML3ParameterView *m_SN; ///< north scaling
  mafOpMML3ParameterView *m_SS; ///< south scaling
  mafOpMML3ParameterView *m_SE; ///< east scaling
  mafOpMML3ParameterView *m_SW; ///< west scaling
...
private:
  mafOpMML3ContourWidget(const mafOpMML3ContourWidget&);  //Not implemented
  void operator=(const mafOpMML3ContourWidget&);  //Not implemented
