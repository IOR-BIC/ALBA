...
#ifndef __albaOpMMLModelView_H__
#define __albaOpMMLModelView_H__
...
{
public:
  albaOpMMLModelView(vtkRenderWindow *rw, vtkRenderer *ren, vtkPolyData *muscle, vtkDataSet* volume);
  virtual ~albaOpMMLModelView();
