/*=========================================================================
 ...
 Program: MAF2
 Module: mafOpMML3ModelView3DPipe
...
// Constructor
//------------------------------------------------------------------------------
mafOpMML3ModelView3DPipe::mafOpMML3ModelView3DPipe
...
//------------------------------------------------------------------------------
// Set visibility
void mafOpMML3ModelView3DPipe::SetVisibility(int visibility)
//------------------------------------------------------------------------------
{
...
void mafOpMML3ModelView3DPipe::Update()
//------------------------------------------------------------------------------
{
...
void mafOpMML3ModelView3DPipe::UpdateAllSlices()
//------------------------------------------------------------------------------
{
  for (int i = 0 ;  i < m_NumberOfSlices ;  i++){
...
void mafOpMML3ModelView3DPipe::SetCurrentSliceId(int i)
//------------------------------------------------------------------------------
{
  m_CurrentSliceId = i ;
  SetVisibility(m_CurrentVisibility) ;
...
void mafOpMML3ModelView3DPipe::SetSliceTransform(int i, vtkMatrix4x4 *mat)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// add a landmark
void mafOpMML3ModelView3DPipe::AddLandmark(double *pos)
//------------------------------------------------------------------------------
{
...
void mafOpMML3ModelView3DPipe::AddAxisLandmark(double *pos)
//------------------------------------------------------------------------------
{
...
void mafOpMML3ModelView3DPipe::SetSliceResolution(int resX, int resY)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Set size of slices
void mafOpMML3ModelView3DPipe::SetSliceSize(double sizeX, double sizeY)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// set landmark size
void mafOpMML3ModelView3DPipe::SetLandmarkRadius(double r)
//------------------------------------------------------------------------------
{
  m_LandmarkSize = r ;
...
void mafOpMML3ModelView3DPipe::SetTubeRadius(double r)
//------------------------------------------------------------------------------
{
  m_TubeSize = r ;
...
void mafOpMML3ModelView3DPipe::GetContourBounds(double *bounds)
//------------------------------------------------------------------------------
{
...
void mafOpMML3ModelView3DPipe::GetContourCenter(double *center)
//------------------------------------------------------------------------------
{
  m_ContourCutter[m_CurrentSliceId]->GetOutput()->Update() ;
...
//------------------------------------------------------------------------------
// set lut range
void mafOpMML3ModelView3DPipe::SetLutRange(double scalarMin, double scalarMax)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Print self
void mafOpMML3ModelView3DPipe::PrintSelf(ostream& os, int indent)
//------------------------------------------------------------------------------
{
  Update() ;
