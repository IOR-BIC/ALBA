...
#ifndef __mafOpSmoothSurfaceCells_H__
#define __mafOpSmoothSurfaceCells_H__
...
*/
class MAF_EXPORT mafOpSmoothSurfaceCells: public mafOp
{
public:

	mafOpSmoothSurfaceCells(wxString label = "Smooth Cells");
	~mafOpSmoothSurfaceCells(); 

	mafTypeMacro(mafOpSmoothSurfaceCells, mafOp);
