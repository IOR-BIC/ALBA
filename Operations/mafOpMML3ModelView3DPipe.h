...
#ifndef __mafOpMML3ModelView3DPipe_H__
#define __mafOpMML3ModelView3DPipe_H__
...
//------------------------------------------------------------------------------
class mafOpMML3ModelView3DPipe
{
public:
  /// Constructor
  mafOpMML3ModelView3DPipe(vtkRenderer *ren, vtkPolyData *muscle, vtkDataSet* volume, int numberOfSlices) ;
