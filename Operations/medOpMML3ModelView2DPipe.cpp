...
//------------------------------------------------------------------------------
// Destructor
medOpMML3ModelView2DPipe::~medOpMML3ModelView2DPipe()
//------------------------------------------------------------------------------
{
  // look up table
  m_Lut->Delete() ;
...
//------------------------------------------------------------------------------
// Set visibility
void medOpMML3ModelView2DPipe::SetVisibility(int visibility)
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::SetCurrentSliceId(int i)
//------------------------------------------------------------------------------
{
  m_CurrentSliceId = i ;
  SetVisibility(m_CurrentVisibility) ;
...
void medOpMML3ModelView2DPipe::SetSliceTransform(int i, vtkMatrix4x4 *mat)
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::SetTubeRadius(double r)
//------------------------------------------------------------------------------
{
  m_TubeSize = r ;
...
//------------------------------------------------------------------------------
// set x text
void medOpMML3ModelView2DPipe::SetTextXVisibility(int visibility)
//------------------------------------------------------------------------------
{
  m_TextXOn = true ;
...
//------------------------------------------------------------------------------
// set y text
void medOpMML3ModelView2DPipe::SetTextYVisibility(int visibility)
//------------------------------------------------------------------------------
{
  m_TextYOn = true ;
...
//------------------------------------------------------------------------------
// set lut range
void medOpMML3ModelView2DPipe::SetLutRange(double scalarMin, double scalarMax)
//------------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
// set up contour axes
void medOpMML3ModelView2DPipe::SetUpContourCoordinateAxes()
//----------------------------------------------------------------------------
{
  // east
...
//----------------------------------------------------------------------------
// set up global axes
void medOpMML3ModelView2DPipe::SetUpGlobalCoordinateAxes()
//----------------------------------------------------------------------------
{
  // east
...
void medOpMML3ModelView2DPipe::SetSliceResolution(int resX, int resY)
//------------------------------------------------------------------------------
{
  m_ResX = resX ;
  m_ResY = resY ;
...
void medOpMML3ModelView2DPipe::SetSliceSize(double sizeX, double sizeY)
//------------------------------------------------------------------------------
{
  m_SizeX = sizeX ;
  m_SizeY = sizeY ;
...
void medOpMML3ModelView2DPipe::SetContourAxesVisibility(int visibility)
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::SetGlobalAxesVisibility(int visibility)
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::TransformPointToPatient(double *p)
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::SetContourAxesTransform(vtkTransform *transform)
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::SetGlobalAxesTransform(vtkTransform *transform)
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::GetOriginalSegmentBoundsNE(double *bounds) 
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Get the bounds of the contour quadrant
void medOpMML3ModelView2DPipe::GetOriginalSegmentBoundsNW(double *bounds) 
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Get the bounds of the contour quadrant
void medOpMML3ModelView2DPipe::GetOriginalSegmentBoundsSE(double *bounds) 
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Get the bounds of the contour quadrant
void medOpMML3ModelView2DPipe::GetOriginalSegmentBoundsSW(double *bounds) 
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::GetOriginalSegmentCenterNE(double *center) 
//------------------------------------------------------------------------------
{
  double bounds[6] ;
...
//------------------------------------------------------------------------------
// Get center of contour quadrant after clipping, before transform
void medOpMML3ModelView2DPipe::GetOriginalSegmentCenterNW(double *center) 
//------------------------------------------------------------------------------
{
  double bounds[6] ;
...
//------------------------------------------------------------------------------
// Get center of contour quadrant after clipping, before transform
void medOpMML3ModelView2DPipe::GetOriginalSegmentCenterSE(double *center) 
//------------------------------------------------------------------------------
{
  double bounds[6] ;
...
//------------------------------------------------------------------------------
// Get center of contour quadrant after clipping, before transform
void medOpMML3ModelView2DPipe::GetOriginalSegmentCenterSW(double *center) 
//------------------------------------------------------------------------------
{
  double bounds[6] ;
...
void medOpMML3ModelView2DPipe::GetCurrentContourBounds(double *bounds) 
//------------------------------------------------------------------------------
{
...
void medOpMML3ModelView2DPipe::GetCurrentContourCenter(double *center) 
//------------------------------------------------------------------------------
{
  double bounds[6] ;
...
void medOpMML3ModelView2DPipe::SetCuttingPlanesTransform(vtkTransform *transform)
//------------------------------------------------------------------------------
{
...
// This is the method which applies the effect of the widget to the contour
void medOpMML3ModelView2DPipe::SetNEContourTransform(vtkTransform *transform)
//------------------------------------------------------------------------------
{
...
// Set the transform of the contour quadrant
// This is the method which applies the effect of the widget to the contour
void medOpMML3ModelView2DPipe::SetSEContourTransform(vtkTransform *transform)
//------------------------------------------------------------------------------
{
...
// Set the transform of the contour quadrant
// This is the method which applies the effect of the widget to the contour
void medOpMML3ModelView2DPipe::SetNWContourTransform(vtkTransform *transform)
//------------------------------------------------------------------------------
{
...
// Set the transform of the contour quadrant
// This is the method which applies the effect of the widget to the contour
void medOpMML3ModelView2DPipe::SetSWContourTransform(vtkTransform *transform)
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// Print self
void medOpMML3ModelView2DPipe::PrintSelf(ostream& os, int indent)
//------------------------------------------------------------------------------
{
  Update() ;
