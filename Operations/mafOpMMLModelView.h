...
#ifndef __mafOpMMLModelView_H__
#define __mafOpMMLModelView_H__
...
{
public:
  mafOpMMLModelView(vtkRenderWindow *rw, vtkRenderer *ren, vtkPolyData *muscle, vtkDataSet* volume);
  virtual ~mafOpMMLModelView();
