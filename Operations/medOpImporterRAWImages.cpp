...
bool medOpImporterRAWImages::IsVolumeLarge()
{  
  int VOI[6];  
...
bool medOpImporterRAWImages::VolumeLargeCheck()
{ 
  int VOI[6];  
  VOI[4] = 0; VOI[5] = m_Dimension[2] - 1;
...
/*virtual*/ void medOpImporterRAWImages::SetDataLayout(vtkMAFLargeImageReader* r, 
