...
#ifndef __albaOpMMLParameterView_H__
#define __albaOpMMLParameterView_H__
...
public:
	...
	albaOpMMLParameterView( vtkRenderWindow *rw, vtkRenderer *ren );
	virtual ~albaOpMMLParameterView();
