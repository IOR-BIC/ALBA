...
Program: MAF2
Module: mafOpExporterAnsysCDBFile.cpp
...
//----------------------------------------------------------------------------
mafCxxTypeMacro(mafOpExporterAnsysCDBFile);
//----------------------------------------------------------------------------

#define max(a,b)  (((a) > (b)) ? (a) : (b))

//----------------------------------------------------------------------------
mafOpExporterAnsysCDBFile::mafOpExporterAnsysCDBFile(const wxString &label) :
mafOpExporterAnsysCommon(label)
{

}
//----------------------------------------------------------------------------
mafOpExporterAnsysCDBFile::~mafOpExporterAnsysCDBFile()
{

}

//----------------------------------------------------------------------------
mafOp* mafOpExporterAnsysCDBFile::Copy()   
{
  mafOpExporterAnsysCDBFile *cp = new mafOpExporterAnsysCDBFile(m_Label);
  return cp;
}

//----------------------------------------------------------------------------
mafString mafOpExporterAnsysCDBFile::GetWildcard()
{
  return "cdb files (*.cdb)|*.cdb|All Files (*.*)|*.*";
}

//---------------------------------------------------------------------------
int mafOpExporterAnsysCDBFile::Write()
{
  FILE *outFile;
...
//---------------------------------------------------------------------------
int mafOpExporterAnsysCDBFile::WriteHeaderFile(FILE *file)
{
  time_t rawtime;
...
//---------------------------------------------------------------------------
int mafOpExporterAnsysCDBFile::WriteNodesFile(FILE *file)
{
  mafVMEMesh *input = mafVMEMesh::SafeDownCast(m_Input);
  assert(input);
...
//---------------------------------------------------------------------------
int mafOpExporterAnsysCDBFile::WriteMaterialsFile(FILE *file)
{
  mafVMEMesh *input = mafVMEMesh::SafeDownCast(m_Input);
  assert(input);
...
//---------------------------------------------------------------------------
int mafOpExporterAnsysCDBFile::WriteElementsFile(FILE *file)
{
  mafVMEMesh *input = mafVMEMesh::SafeDownCast(m_Input);
  assert(input);
