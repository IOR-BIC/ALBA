...
#ifndef __mafOpMove_H__
#define __mafOpMove_H__
...
class MAF_EXPORT mafOpMove : public mafOpTransformInterface
{
public:
  mafOpMove(const wxString &label = "Move\tCtrl+T");
 ~mafOpMove(); 
  virtual void OnEvent(mafEventBase *maf_event);
  
  mafTypeMacro(mafOpMove, mafOp);
