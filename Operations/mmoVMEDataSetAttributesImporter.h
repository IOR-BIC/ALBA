/*=========================================================================
  ...
  Module:    $RCSfile: mmoVMEDataSetAttributesImporter.h,v $
  Language:  C++
...
#ifndef __mmoVMEDataSetAttributesImporter_H__
#define __mmoVMEDataSetAttributesImporter_H__
...
//----------------------------------------------------------------------------
// mmoVMEDataSetAttributesImporter :
//----------------------------------------------------------------------------
/** 
...
for mafVMEDataSetAttributesImporter utility class. 
  ...
  @sa mmoVMEDataSetAttributesImporterTest mafVMEDataSetAttributesImporter mafVMEDataSetAttributesImporterTest

*/
class mmoVMEDataSetAttributesImporter: public mafOp
{
public:

	mmoVMEDataSetAttributesImporter(const wxString &label = "mmoVMEDataSetAttributesImporter");
	~mmoVMEDataSetAttributesImporter(); 
	
  mafTypeMacro(mmoVMEDataSetAttributesImporter, mafOp);
