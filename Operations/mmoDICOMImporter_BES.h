...
#ifndef __mmoDICOMImporter_BES_H__
#define __mmoDICOMImporter_BES_H__
...
WX_DECLARE_LIST(mmoDICOMImporter_BESListElement, ListDicomFiles);
//----------------------------------------------------------------------------
// mmoDICOMImporter_BES :
//----------------------------------------------------------------------------

class mmoDICOMImporter_BES: public mafOp
{
public:
            	 mmoDICOMImporter_BES(wxString label = "DICOMImporter");
	virtual     ~mmoDICOMImporter_BES();
	virtual void OnEvent(mafEventBase *maf_event);
	
  mafTypeMacro(mmoDICOMImporter_BES, mafOp);
...
{
public:
	mmoDICOMImporter_BESListElement() {m_SliceFilename = ""; m_SlicePosition[0] = 0.0;m_SlicePosition[1] = 0.0;m_SlicePosition[2] = 0.0;};
	mmoDICOMImporter_BESListElement(const char *filename, double coord[3]) {m_SliceFilename = filename; m_SlicePosition[0] = coord[0];m_SlicePosition[1] = coord[1];m_SlicePosition[2] = coord[2];};
	~mmoDICOMImporter_BESListElement() {m_SliceFilename = ""; m_SlicePosition[0] = 0.0;m_SlicePosition[1] = 0.0;m_SlicePosition[2] = 0.0;};
...
{
public:
	mmoDICOMImporter_BESListElement() 
  {
    m_SliceFilename = "";
    m_Pos[0] = -9999;
    m_Pos[1] = -9999;
	...
	mmoDICOMImporter_BESListElement(mafString filename,double coord[3], int imageNumber=-1, int cardNumImages=-1, double trigTime=-1.0)  
  {
