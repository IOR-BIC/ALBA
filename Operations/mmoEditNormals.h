...
Module:    $RCSfile: mmoEditNormals.h,v $
Language:  C++
...
#ifndef __mmoEditNormals_H__
#define __mmoEditNormals_H__
...
//----------------------------------------------------------------------------
/** */
class mmoEditNormals: public mafOp
{
public:
	mmoEditNormals(const wxString &label = "Edit Normals");
	~mmoEditNormals(); 
	virtual void OnEvent(mafEventBase *maf_event);

	mafTypeMacro(mmoEditNormals, mafOp);
