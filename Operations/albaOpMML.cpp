...
//----------------------------------------------------------------------------
albaOpMML::albaOpMML(const wxString &label) : albaOp(label)
//----------------------------------------------------------------------------
{
  //
  m_OpType = OPTYPE_OP;
...
//----------------------------------------------------------------------------
bool albaOpMML::InternalAccept(albaVME* vme)
{ 
  return vme != NULL && vme->IsALBAType(albaVMEVolumeGray);
}

//----------------------------------------------------------------------------
albaOp* albaOpMML::Copy() {return new albaOpMML(m_Label);}

//----------------------------------------------------------------------------
void albaOpMML::OpDo()  {}

//----------------------------------------------------------------------------
void albaOpMML::OpUndo() {}

//----------------------------------------------------------------------------
void albaOpMML::OpStop(int result) {	albaEventMacro(albaEvent(this,result));}

//----------------------------------------------------------------------------
void albaOpMML::OpRun()   
//----------------------------------------------------------------------------
{
  //inputs dialog
  if(!CreateInputsDlg())    
...
//----------------------------------------------------------------------------
void albaOpMML::OnEvent(albaEventBase *alba_event) 
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaOpMML::OnRegistrationOK() 
//----------------------------------------------------------------------------
{
  // deform
  ...
  // vme item
  vme->SetData(deformedpd->GetOutput(), m_Input->GetTimeStamp()) ;
...
//----------------------------------------------------------------------------
void albaOpMML::OnRegistrationCANCEL()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaOpMML::OnMuscleSelection() 
//----------------------------------------------------------------------------
{
  ...
  // get vme surface
  m_Surface = albaVMESurface::SafeDownCast(vme);
  ...
  if(vme->GetTagArray()->IsTagPresent("STATUS_TAG"))
  {
    ...
    m_ScansNumberTxt->SetValidator(albaGUIValidator(this,ID_CHOOSE_FAKE,m_ScansNumberTxt,&m_ScansNumber2,3,100)); // min/max values
    ...
    albaTagItem *XYScalingFactorsTag;
    ...
    m_RegistrationXYSxalingFactorTxt->SetValidator(albaGUIValidator(this,ID_CHOOSE_FAKE,m_RegistrationXYSxalingFactorTxt,&m_RegistrationXYScalingFactor2,0.01,2.0)); // min/max values
  ...
  if (m_RegistrationStatus == 1)
  {
    ...
    //
    m_Surface = albaVMESurface::SafeDownCast(MuscleInAtlasSectionVME);
  }
    ...
    if (m_State == 1) // translate
    {
      ...
      if (m_State == 2) // rotate
      {
        ...
        if (m_State == 3) // scale
        {
          ...
          // is set to true, albaOpMMLContourWidget::OnLeftButtonUp
        }
        else
...
//----------------------------------------------------------------------------
void albaOpMML::OnContourLineAxesVisibility() 
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaOpMML::OnContourVisibility() 
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaOpMML::OnLandmark1AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_Surface == NULL)
...
//----------------------------------------------------------------------------
void albaOpMML::OnLandmark2AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_Surface == NULL)
...
//----------------------------------------------------------------------------
void albaOpMML::OnLandmark3AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_Surface == NULL)
...
//----------------------------------------------------------------------------
void albaOpMML::OnLandmark4AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_Surface == NULL)
...
//----------------------------------------------------------------------------
bool albaOpMML::CreateInputsDlg() 
//----------------------------------------------------------------------------
{
  // create the dialog
  m_ChooseDlg = new albaGUIDialog("SetUp"); 
  ...
  text_1->SetValidator(albaGUIValidator(this, ID_CHOOSE_SURFACE, text_1, &m_SurfaceName));
  albaGUIButton    *b_1    = new albaGUIButton(m_ChooseDlg , ID_CHOOSE_SURFACE, "select", wxPoint(0,0), wxSize(50,20));
  ...
  text_5->SetValidator(albaGUIValidator(this,ID_CHOOSE_L1,text_5,&m_l1_name));
  albaGUIButton *b_5       = new albaGUIButton(m_choose_dlg ,ID_CHOOSE_L1,"select",wxPoint(0,0), wxSize(50,20));
  ...
  text_6->SetValidator(albaGUIValidator(this,ID_CHOOSE_L2,text_6,&m_l2_name));
  albaGUIButton *b_6       = new albaGUIButton(m_choose_dlg ,ID_CHOOSE_L2,"select",wxPoint(0,0), wxSize(50,20));
  ...
  text_7->SetValidator(albaGUIValidator(this,ID_CHOOSE_L3,text_7,&m_l3_name));
  albaGUIButton *b_7       = new albaGUIButton(m_choose_dlg ,ID_CHOOSE_L3,"select",wxPoint(0,0), wxSize(50,20));
  ...
  text_8->SetValidator(albaGUIValidator(this,ID_CHOOSE_L4,text_8,&m_l4_name));
  albaGUIButton *b_8       = new albaGUIButton(m_choose_dlg ,ID_CHOOSE_L4,"select",wxPoint(0,0), wxSize(50,20));
  ...
  RegistrationXYSxalingFactorTxt->SetValidator(albaGUIValidator(this,ID_CHOOSE_FAKE,RegistrationXYSxalingFactorTxt,&m_RegistrationXYScalingFactor,0.01,2.0)); // min/max values
  ...
  ScansDistanceTxt->SetValidator(albaGUIValidator(this,ID_FAKE,ScansDistanceTxt,&m_ScansDistance,0.1,100)); // min/max values
  ...
  */
  ...
  m_ScansNumberTxt->SetValidator(albaGUIValidator(this,ID_CHOOSE_FAKE,m_ScansNumberTxt,&m_ScansNumber,3,100)); // min/max values
  ...
  ScansSizeTxt1->SetValidator(albaGUIValidator(this,ID_FAKE,ScansSizeTxt1,&m_ScansSize[0],1,128)); //min/max values
  wxTextCtrl   *ScansSizeTxt2 = new wxTextCtrl(m_choose_dlg ,  -1, "",        wxPoint(0,0), wxSize(75,20),wxNO_BORDER );
  ScansSizeTxt2->SetValidator(albaGUIValidator(this,ID_FAKE,ScansSizeTxt2,&m_ScansSize[1],1,128)); // min/max values
  ...
  */
  ...
  ScansGrainTxt1->SetValidator(albaGUIValidator(this,ID_CHOOSE_FAKE,ScansGrainTxt1,&m_ScansGrain,1,5));
  ...
  flagTxt1->SetValidator(albaGUIValidator(this,ID_CHOOSE_FAKE,flagTxt1,&m_Flag3D,0,1));
  ...
  LandmarksflagTxt1->SetValidator(albaGUIValidator(this,ID_CHOOSE_FAKE,LandmarksflagTxt1,&m_Landmarksflag,0,1));
  ...
  */
  ...
  ScansResolutionTxt1->SetValidator(albaGUIValidator(this,ID_FAKE,ScansResolutionTxt1,&m_ScansResolution[0],8,256));
  wxTextCtrl   *ScansResolutionTxt2 = new wxTextCtrl(m_choose_dlg ,  -1, "",        wxPoint(0,0), wxSize(75,20),wxNO_BORDER );
  ScansResolutionTxt2->SetValidator(albaGUIValidator(this,ID_FAKE,ScansResolutionTxt2,&m_ScansResolution[1],8,256));
  ...
  */
  ...
  // ok/cancel button
  m_ChooseOk = new albaGUIButton(m_ChooseDlg, ID_CHOOSE_OK, "OK", wxPoint(0,0), wxSize(50,20));
  m_ChooseOk->SetListener(this);
  m_ChooseOk->Enable(false);
  albaGUIButton *b_cancel = new albaGUIButton(m_ChooseDlg, ID_CHOOSE_CANCEL, "CANCEL", wxPoint(0,0), wxSize(50,20));
...
//----------------------------------------------------------------------------
void albaOpMML::CreateRegistrationDlg()
//----------------------------------------------------------------------------
{ 
  ...
  m_OpDlg = new albaGUIDialog(Title); 
  ...
  // axes on/off button
  m_AxesOnOffButton = new albaGUIButton(m_OpDlg, ID_SHOW_AXES, "Axes Off", wxPoint(0,0), wxSize(75,20));
  m_AxesOnOffButton->SetListener(this);
  TopHorizontalBoxSizer->Add(m_AxesOnOffButton,0,wxALL, 5);

  // contour on/off buton
  m_ContourOnOffButton = new albaGUIButton(m_OpDlg, ID_SHOW_CONTOUR, "Contour Off", wxPoint(0,0), wxSize(75,20));
  m_ContourOnOffButton->SetListener(this);
  TopHorizontalBoxSizer->Add(m_ContourOnOffButton,0,wxALL, 5);

  // reset view button
  m_ResetViewButton = new albaGUIButton(m_OpDlg, ID_RESET_VIEW, "Reset View", wxPoint(0,0), wxSize(75,20));
  m_ResetViewButton->SetListener(this);
  TopHorizontalBoxSizer->Add(m_ResetViewButton,0,wxALL, 5);

  // ok button
  m_OkButton = new albaGUIButton(m_OpDlg, ID_OK, "OK", wxPoint(0,0), wxSize(75,20));
  m_OkButton->SetListener(this);
  TopHorizontalBoxSizer->Add(m_OkButton,0,wxALL, 5);

  // cancel button
  m_CancelButton = new albaGUIButton(m_OpDlg, ID_CANCEL, "CANCEL", wxPoint(0,0), wxSize(75,20));
  ...
  //c0->SetValidator( albaGUIValidator(this,ID_SHOW_AXES,c0,&m_show_axes) );
  //CheckBoxHorizontalBoxSizer->Add(c0,0,wxALL, 5);
  //wxCheckBox *c1 = new wxCheckBox(m_op_dlg,ID_SHOW_CONTOUR,"show contour");
  //c1->SetValidator( albaGUIValidator(this,ID_SHOW_CONTOUR,c1,&m_ContourVisibility));
  ...
  m_PlaceOpButton = new albaGUIButton(m_OpDlg, ID_P_OPERATION, "P", wxPoint(0,0), wxSize(75,20));
  m_PlaceOpButton->SetListener(this);
  OperationHorizontalBoxSizer->Add(m_PlaceOpButton,0,wxALL, 5);

  m_TranslateOpButton = new albaGUIButton(m_OpDlg, ID_T_OPERATION,"T", wxPoint(0,0), wxSize(75,20));
  m_TranslateOpButton->SetListener(this);
  OperationHorizontalBoxSizer->Add(m_TranslateOpButton,0,wxALL, 5);

  m_RotateOpButton = new albaGUIButton(m_OpDlg, ID_R_OPERATION, "R", wxPoint(0,0), wxSize(75,20));
  m_RotateOpButton->SetListener(this);
  OperationHorizontalBoxSizer->Add(m_RotateOpButton,0,wxALL, 5);

  m_ScaleOpButton = new albaGUIButton(m_OpDlg, ID_S_OPERATION, "S", wxPoint(0,0), wxSize(75,20));
  m_ScaleOpButton->SetListener(this);
  OperationHorizontalBoxSizer->Add(m_ScaleOpButton,0,wxALL, 5);

  // undo button
  m_UndoButton = new albaGUIButton(m_OpDlg, ID_UNDO, "Undo", wxPoint(0,0), wxSize(75,20));
  ...
  //((vtkRenderWindow*)(m_ModelalbaRWI->m_RenderWindow))->SetSize(420,420);
  //m_ModelalbaRWI->m_RwiBase->Show();
  ...
  m_Vol = albaVMEVolumeGray::SafeDownCast(m_Input);
  assert(!(m_Vol == NULL));
  ...
  // mml model view
  // create
  m_Model = new albaOpMMLModelView(m_ModelalbaRWI->m_RenderWindow, m_ModelalbaRWI->m_RenFront, m_Muscle, m_Volume);
  // initialise
  CreateFakeLandmarks();
  SetUpInputs();
  ...
  sli->SetValidator(albaGUIValidator(this,ID_SLICE,(wxSlider*)sli,&m_Slice,text));
  //RightVerticalBoxSizer->Add(sli,0);
  RightVerticalBoxSizer->Add(sli, 0, wxLEFT, -9);

  // alba parameter views RWIs
  m_PHalbaRWI = CreateParameterViewalbaRWI("P-H", 1,1,1); // white
  m_PValbaRWI = CreateParameterViewalbaRWI("P-V", 1,1,1); // white
  m_THalbaRWI = CreateParameterViewalbaRWI("T-H", 1,1,1); // white
  m_TValbaRWI = CreateParameterViewalbaRWI("T-V", 1,1,1); // white
  m_RAalbaRWI = CreateParameterViewalbaRWI("R-A", 1,1,1); // white
  m_SNalbaRWI = CreateParameterViewalbaRWI("S-N", 1,0,0); // red
  m_SSalbaRWI = CreateParameterViewalbaRWI("S-S", 0,1,0); // green
  m_SEalbaRWI = CreateParameterViewalbaRWI("S-E", 0,0,1); // blue
  m_SWalbaRWI = CreateParameterViewalbaRWI("S-W", 1,0,1); // magenta

  // add to box sizer
  RightVerticalBoxSizer->Add(m_PHalbaRWI->m_RwiBase, 0, wxTOP, 10);
  RightVerticalBoxSizer->Add(m_PValbaRWI->m_RwiBase, 0, wxTOP, 3);
  RightVerticalBoxSizer->Add(m_THalbaRWI->m_RwiBase, 0, wxTOP, 3);
  RightVerticalBoxSizer->Add(m_TValbaRWI->m_RwiBase, 0, wxTOP, 3);
  RightVerticalBoxSizer->Add(m_RAalbaRWI->m_RwiBase, 0, wxTOP, 3);
  RightVerticalBoxSizer->Add(m_SNalbaRWI->m_RwiBase, 0, wxTOP, 3);
  RightVerticalBoxSizer->Add(m_SSalbaRWI->m_RwiBase, 0, wxTOP, 3);
  RightVerticalBoxSizer->Add(m_SEalbaRWI->m_RwiBase, 0, wxTOP, 3);
  RightVerticalBoxSizer->Add(m_SWalbaRWI->m_RwiBase, 0, wxTOP, 3);
  ...
  // mml parameter views
  // create
  m_PH = new albaOpMMLParameterView(m_PHalbaRWI->m_RenderWindow, m_PHalbaRWI->m_RenFront); 
  m_PV = new albaOpMMLParameterView(m_PValbaRWI->m_RenderWindow, m_PValbaRWI->m_RenFront);
  m_TH = new albaOpMMLParameterView(m_THalbaRWI->m_RenderWindow, m_THalbaRWI->m_RenFront);
  m_TV = new albaOpMMLParameterView(m_TValbaRWI->m_RenderWindow, m_TValbaRWI->m_RenFront);
  m_RA = new albaOpMMLParameterView(m_RAalbaRWI->m_RenderWindow, m_RAalbaRWI->m_RenFront);
  m_SN = new albaOpMMLParameterView(m_SNalbaRWI->m_RenderWindow, m_SNalbaRWI->m_RenFront);
  m_SS = new albaOpMMLParameterView(m_SSalbaRWI->m_RenderWindow, m_SSalbaRWI->m_RenFront);
  m_SE = new albaOpMMLParameterView(m_SEalbaRWI->m_RenderWindow, m_SEalbaRWI->m_RenFront);
  m_SW = new albaOpMMLParameterView(m_SWalbaRWI->m_RenderWindow, m_SWalbaRWI->m_RenFront);


  // mml contour widget
  // create
  m_Widget = albaOpMMLContourWidget::New();
  ...
  SetUpParameterViews();
  //
  albaEventMacro(albaEvent(this, ID_T_OPERATION));
  //
...
//----------------------------------------------------------------------------
bool albaOpMML::SetUpParameterViews() 
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
{
  ...
  // initalise lut slider (called after void albaOpMMLModelView::SetUpSyntheticScans()
...
//----------------------------------------------------------------------------
albaRWI* albaOpMML::CreateParameterViewalbaRWI(wxString lab, float r, float g, float b)
//----------------------------------------------------------------------------
{ 
...
//----------------------------------------------------------------------------
void albaOpMML::SetUpLandmarks(wxString AtlasSectionVMEName, wxString PatientSectionVMEName)
//----------------------------------------------------------------------------
{
  int i;
...
//----------------------------------------------------------------------------
void albaOpMML::OnPOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void albaOpMML::OnTOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void albaOpMML::OnROperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void albaOpMML::OnSOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
void albaOpMML::ApplyRegistrationOps()
//----------------------------------------------------------------------------
{
  int i;
  int n;
...
//----------------------------------------------------------------------------
void albaOpMML::ApplyInverseRegistrationOps()
//----------------------------------------------------------------------------
{

}

void albaOpMML::CreateFakeLandmarks() 
{
