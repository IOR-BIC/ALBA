...
#ifndef __albaOpMMLContourWidget_h
#define __albaOpMMLContourWidget_h
...
//----------------------------------------------------------------------------
// albaOpMMLContourWidget  :
//----------------------------------------------------------------------------
class albaOpMMLContourWidget : public vtkPolyDataSourceWidget
{
public:
	void SetPH(albaOpMMLParameterView* PH);
	void SetPV(albaOpMMLParameterView* PV);
	void SetTH(albaOpMMLParameterView* TH);
	void SetTV(albaOpMMLParameterView* TV);
	void SetRA(albaOpMMLParameterView* RA);
	void SetSN(albaOpMMLParameterView* SN);
	void SetSS(albaOpMMLParameterView* SS);
	void SetSE(albaOpMMLParameterView* SE);
	void SetSW(albaOpMMLParameterView* SW);
	void SetModel(albaOpMMLModelView* Model);
...
//   vtkGetObjectMacro(SelectedHandleProperty,vtkProperty);
  ...
  // MK BEGIN
  albaOpMMLModelView *m_M; // model
  
  albaOpMMLParameterView *m_CH; // center horizontal translation
  albaOpMMLParameterView *m_CV; // center vertical translation
  albaOpMMLParameterView *m_T; // twist
  albaOpMMLParameterView *m_H; // horizontal translation
  albaOpMMLParameterView *m_V; // vertical translation
  albaOpMMLParameterView *m_N; // north scaling
  albaOpMMLParameterView *m_S; // south scaling
  albaOpMMLParameterView *m_E; // east scaling
  albaOpMMLParameterView *m_W; // west scaling
  // MK END
...
private:
  albaOpMMLContourWidget(const albaOpMMLContourWidget&);  //Not implemented
  void operator=(const albaOpMMLContourWidget&);  //Not implemented
};
