...
#ifndef __mafOpMML3ModelView_H__
#define __mafOpMML3ModelView_H__
...
//
//------------------------------------------------------------------------------
class mafOpMML3ModelView
{
public:
  //----------------------------------------------------------------------------
  // constructor and destructor
  //----------------------------------------------------------------------------
  mafOpMML3ModelView(vtkRenderWindow *rw, vtkRenderer *ren, vtkPolyData *muscleIn, vtkPolyData *muscleOut,
    vtkDataSet* volume, int numberOfScans) ; ///< constructor
  virtual ~mafOpMML3ModelView(); ///< destructor
  ...
  mafOpMML3ModelView2DPipe* GetVisualPipe2D() {return m_VisualPipe2D ;} ///< return the 2d visual pipe
  mafOpMML3ModelView3DPipe* GetVisualPipe3D() {return m_VisualPipe3D ;} ///< return the 3d visual pipe
  mafOpMML3ModelView3DPipe* GetVisualPipePreview() {return m_VisualPipePreview ;} ///< return the preview visual pipe
...
protected:
  ...
  mafOpMML3ModelView2DPipe *m_VisualPipe2D ;
  mafOpMML3ModelView3DPipe *m_VisualPipe3D ;
  mafOpMML3ModelView3DPipe *m_VisualPipePreview ;
