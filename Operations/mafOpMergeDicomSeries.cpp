...
//----------------------------------------------------------------------------
mafCxxTypeMacro(mafOpMergeDicomSeries);
//----------------------------------------------------------------------------


mafOpMergeDicomSeries::mafOpMergeDicomSeries(wxString label):
mafOp(label)
//----------------------------------------------------------------------------
{
	m_OpType = OPTYPE_OP;
...
//----------------------------------------------------------------------------
mafOpMergeDicomSeries::~mafOpMergeDicomSeries()
//----------------------------------------------------------------------------
{

}
//----------------------------------------------------------------------------
mafOp *mafOpMergeDicomSeries::Copy()
//----------------------------------------------------------------------------
{
  // returns a copy of this operation
	mafOpMergeDicomSeries *op = new mafOpMergeDicomSeries(m_Label);
	return op;
}
//----------------------------------------------------------------------------
void mafOpMergeDicomSeries::OpRun()
//----------------------------------------------------------------------------
{
  bool result = true;
	do 
...
//----------------------------------------------------------------------------
bool mafOpMergeDicomSeries::RanameSeriesAndManufacturer(const char *dicomDirABSPath, int dicomSeriesUID)
//----------------------------------------------------------------------------
{
