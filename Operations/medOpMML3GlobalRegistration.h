...
Module:    $RCSfile: medOpMML3GlobalRegistration.h,v $
Language:  C++
...
#ifndef __medOpMML3GlobalRegistration_H__
#define __medOpMML3GlobalRegistration_H__
...
//------------------------------------------------------------------------------
class medOpMML3GlobalRegistration
{
public:
  /// constructor
  medOpMML3GlobalRegistration() ;
