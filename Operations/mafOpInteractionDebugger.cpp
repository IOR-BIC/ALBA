...
mafCxxTypeMacro(mafOpInteractionDebugger);


mafOpInteractionDebugger::mafOpInteractionDebugger(const wxString &label) :
mafOp(label)
{
  m_OpType  = OPTYPE_OP;
  m_Canundo = true;
...
mafOpInteractionDebugger::~mafOpInteractionDebugger()
{
...
mafOp* mafOpInteractionDebugger::Copy()   

{
  mafOpInteractionDebugger *cp = new mafOpInteractionDebugger(m_Label);
  return cp;
}

void mafOpInteractionDebugger::OpRun()   
{
  CreateGui();
  ShowGui();
}
...
void mafOpInteractionDebugger::OnEvent(mafEventBase *maf_event) 
{
...
void mafOpInteractionDebugger::BuildPolyline1(vtkPoints *in_points)
{
  double point[3];
  // point 1
  point[0] = 0.0;
...
void mafOpInteractionDebugger::BuildPolyline2(vtkPoints *in_points)
{
  /** 
...
void mafOpInteractionDebugger::BuildVMEPolyline( vtkPoints * in_points, mafVMEPolyline *polyline )
{
...
void mafOpInteractionDebugger::BuildPolyline3(vtkPoints *in_points)
{
  double point[3];
  // point 1
  point[0] = 0.0;
...
void mafOpInteractionDebugger::AddMAFVMEPolylineTestConstrain1ToTree()
{
...
void mafOpInteractionDebugger::AddMAFVMEPolylineTestConstrain2ToTree()
{
  vtkMAFSmartPointer<vtkPoints> in_points;
  mafVMEPolyline *polyline;
  mafNEW(polyline);
...
void mafOpInteractionDebugger::AddMAFVMEPolylineTestConstrain3ToTree()
{
  vtkMAFSmartPointer<vtkPoints> in_points;
  mafVMEPolyline *polyline;
  mafNEW(polyline);
...
//----------------------------------------------------------------------------
void mafOpInteractionDebugger::OpDo()
//----------------------------------------------------------------------------
{
  cppDEL(m_GizmoDebugger);
