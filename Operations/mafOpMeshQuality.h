...
#ifndef __mafOpMeshQuality_H__
#define __mafOpMeshQuality_H__
 ...
 */
class MAF_EXPORT mafOpMeshQuality: public mafOp
{
public:
	mafOpMeshQuality(const wxString &label = "Check Mesh Quality");
	~mafOpMeshQuality(); 

	virtual void OnEvent(mafEventBase *maf_event);

	mafTypeMacro(mafOpMeshQuality, mafOp);
