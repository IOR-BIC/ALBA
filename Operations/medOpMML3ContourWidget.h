...
public:
  ...
  //----------------------------------------------------------------------------
  void SetPH(medOpMML3ParameterView* PH) {m_PH = PH ;} ///< set the place horizontal parameter view
	void SetPV(medOpMML3ParameterView* PV) {m_PV = PV ;} ///< set the place vertical parameter view
	void SetTH(medOpMML3ParameterView* TH) {m_TH = TH ;} ///< set the translate horizontal parameter view
	void SetTV(medOpMML3ParameterView* TV) {m_TV = TV ;} ///< set the translate vertical parameter view
	void SetRA(medOpMML3ParameterView* RA) {m_RA = RA ;} ///< set the rotate parameter view
	void SetSN(medOpMML3ParameterView* SN) {m_SN = SN ;} ///< set the scale north parameter view
	void SetSS(medOpMML3ParameterView* SS) {m_SS = SS ;} ///< set the scale south parameter view
	void SetSE(medOpMML3ParameterView* SE) {m_SE = SE ;} ///< set the scale east parameter view
	void SetSW(medOpMML3ParameterView* SW) {m_SW = SW ;} ///< set the scale west parameter view

  void SetModel(medOpMML3ModelView* Model) {m_Model = Model ;} ///< Set the model view
...
*/
  ...
  medOpMML3ParameterView *m_PH; ///< horizontal place center
  medOpMML3ParameterView *m_PV; ///< vertical place center
  medOpMML3ParameterView *m_RA; ///< rotation
  medOpMML3ParameterView *m_TH; ///< horizontal translation
  medOpMML3ParameterView *m_TV; ///< vertical translation
  medOpMML3ParameterView *m_SN; ///< north scaling
  medOpMML3ParameterView *m_SS; ///< south scaling
  medOpMML3ParameterView *m_SE; ///< east scaling
  medOpMML3ParameterView *m_SW; ///< west scaling
