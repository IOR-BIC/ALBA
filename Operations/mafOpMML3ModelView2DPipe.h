...
#ifndef __mafOpMML3ModelView2DPipe_H__
#define __mafOpMML3ModelView2DPipe_H__
...
//------------------------------------------------------------------------------
class mafOpMML3ModelView2DPipe
{
public:
  /// Constructor
  mafOpMML3ModelView2DPipe(vtkRenderer *ren, vtkPolyData *muscle, vtkDataSet* volume, int numberOfSlices) ;
