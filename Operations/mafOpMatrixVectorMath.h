...
#ifndef __mafOpMatrixVectorMath_h
#define __mafOpMatrixVectorMath_h
...
//------------------------------------------------------------------------------
class MAF_EXPORT mafOpMatrixVectorMath{
public:
  /// Constructor.
  mafOpMatrixVectorMath(bool homogeneous = false) : m_Homogeneous(homogeneous) {}
