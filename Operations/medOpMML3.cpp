...
//------------------------------------------------------------------------------
bool medOpMML3::Accept(mafNode* vme)
//------------------------------------------------------------------------------
{ 
...
void medOpMML3::CreateInputsDlg() 
//----------------------------------------------------------------------------
{
  // create the dialog
...
void medOpMML3::DeleteInputsDlg() 
//----------------------------------------------------------------------------
{
  delete m_InputsDlg ;
}
...
void medOpMML3::CreateRegistrationDlg()
//------------------------------------------------------------------------------
{ 
  // create dialog
  wxString Title;
  ...
  m_Model = new medOpMML3ModelView(m_ModelmafRWI->m_RenderWindow, m_ModelmafRWI->m_RenFront, 
  ...
  m_PH = new medOpMML3ParameterView(m_PHmafRWI->m_RenderWindow, m_PHmafRWI->m_RenFront); 
  m_PV = new medOpMML3ParameterView(m_PVmafRWI->m_RenderWindow, m_PVmafRWI->m_RenFront);
  m_TH = new medOpMML3ParameterView(m_THmafRWI->m_RenderWindow, m_THmafRWI->m_RenFront);
  m_TV = new medOpMML3ParameterView(m_TVmafRWI->m_RenderWindow, m_TVmafRWI->m_RenFront);
  m_RA = new medOpMML3ParameterView(m_RAmafRWI->m_RenderWindow, m_RAmafRWI->m_RenFront);
  m_SN = new medOpMML3ParameterView(m_SNmafRWI->m_RenderWindow, m_SNmafRWI->m_RenFront);
  m_SS = new medOpMML3ParameterView(m_SSmafRWI->m_RenderWindow, m_SSmafRWI->m_RenFront);
  m_SE = new medOpMML3ParameterView(m_SEmafRWI->m_RenderWindow, m_SEmafRWI->m_RenFront);
  m_SW = new medOpMML3ParameterView(m_SWmafRWI->m_RenderWindow, m_SWmafRWI->m_RenFront);
...
void medOpMML3::DeleteRegistrationDlg()
//------------------------------------------------------------------------------
{ 
...
//------------------------------------------------------------------------------
void medOpMML3::Set2DButtonsEnable(bool enable)
{
...
void medOpMML3::OnTextNumberChange(mafID id)
//------------------------------------------------------------------------------
{
  int i ;
...
void medOpMML3::OnRegistrationOK() 
//----------------------------------------------------------------------------
{
  // apply deformations
...
//----------------------------------------------------------------------------
void medOpMML3::OnRegistrationCANCEL()
//----------------------------------------------------------------------------
{
...
void medOpMML3::OnMuscleSelection() 
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medOpMML3::OnLandmark1AtlasPatientSelection() 
//----------------------------------------------------------------------------
{
  //
  if(m_SurfaceVME == NULL)
...
bool medOpMML3::SetUpContourWidget()
//------------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void medOpMML3::OnPOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void medOpMML3::OnTOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void medOpMML3::OnROperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
//----------------------------------------------------------------------------
void medOpMML3::OnSOperationButton()
//----------------------------------------------------------------------------
{
  // render parameter views
  m_PH->Render();
...
void medOpMML3::ApplyGlobalRegistration()
//----------------------------------------------------------------------------
{
  medOpMML3GlobalRegistration *glob = new medOpMML3GlobalRegistration() ;
