...
#ifndef __mafOpInteractiveClipSurface_H__
#define __mafOpInteractiveClipSurface_H__
...
//----------------------------------------------------------------------------
// mafOpInteractiveClipSurface :
//----------------------------------------------------------------------------
/** */
class MAF_EXPORT mafOpInteractiveClipSurface: public mafOp
{
public:
  mafOpInteractiveClipSurface(const wxString &label = "mafOpInteractiveClipSurface");
  ~mafOpInteractiveClipSurface(); 
	virtual void OnEvent(mafEventBase *maf_event);

  mafTypeMacro(mafOpInteractiveClipSurface, mafOp);
