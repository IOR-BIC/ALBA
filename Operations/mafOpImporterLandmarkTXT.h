...
#ifndef __mafOpImporterLandmarkTXT_H__
#define __mafOpImporterLandmarkTXT_H__
...
class mafEvent;
//----------------------------------------------------------------------------
// mafOpImporterLandmarkTXT :
//----------------------------------------------------------------------------
/** 
class name : mafOpImporterLandmarkTXT
...
*/
class MAF_EXPORT mafOpImporterLandmarkTXT : public mafOp
{
public:
  /** object constructor */
	mafOpImporterLandmarkTXT(wxString label);
  /** object destructor */
	~mafOpImporterLandmarkTXT();
