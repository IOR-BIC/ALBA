...
#ifndef __mafOpFlipNormals_H__
#define __mafOpFlipNormals_H__
...
*/
class MAF_EXPORT mafOpFlipNormals: public mafOp
{
public:

  /** constructor. */
	mafOpFlipNormals(wxString label = "Flip Normals");

  /** destructor. */
	~mafOpFlipNormals(); 

  /** RTTI macro */
	mafTypeMacro(mafOpFlipNormals, mafOp);
...
protected:
  ...
  friend class mafOpFlipNormalsTest;
