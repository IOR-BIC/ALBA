...
//----------------------------------------------------------------------------
{
  ...
  parameter.Append(albaString::Format("%f", m_MaxBoundX));
  parameter.Append("\n");
  parameter.Append("m_MaxBoundY = ");
  parameter.Append(albaString::Format("%f", m_MaxBoundY));
  parameter.Append("\n");
  parameter.Append("m_MaxBoundZ = ");
  parameter.Append(albaString::Format("%f", m_MaxBoundZ));
  parameter.Append("\n");
  parameter.Append("m_ROIPosition[0] = ");
  parameter.Append(albaString::Format("%f", m_ROIPosition[0]));
  parameter.Append("\n");
  parameter.Append("m_ROIPosition[1] = ");
  parameter.Append(albaString::Format("%f", m_ROIPosition[1]));
  parameter.Append("\n");
  parameter.Append("m_ROIPosition[2] = ");
  parameter.Append(albaString::Format("%f", m_ROIPosition[2]));
  parameter.Append("\n");
  parameter.Append("m_ROIOrientation[0] = ");
  parameter.Append(albaString::Format("%f", m_ROIOrientation[0]));
  parameter.Append("\n");
  parameter.Append("m_ROIOrientation[1] = ");
  parameter.Append(albaString::Format("%f", m_ROIOrientation[1]));
  parameter.Append("\n");
  parameter.Append("m_ROIOrientation[2] = ");
  parameter.Append(albaString::Format("%f", m_ROIOrientation[2]));
  parameter.Append("\n");
  parameter.Append("m_NewVolumePosition[0] = ");
  parameter.Append(albaString::Format("%f", m_NewVolumePosition[0]));
  parameter.Append("\n");
  parameter.Append("m_NewVolumePosition[1] = ");
  parameter.Append(albaString::Format("%f", m_NewVolumePosition[1]));
  parameter.Append("\n");
  parameter.Append("m_NewVolumePosition[2] = ");
  parameter.Append(albaString::Format("%f", m_NewVolumePosition[2]));
  parameter.Append("\n");
  parameter.Append("m_VolumeBounds[0] = ");
  parameter.Append(albaString::Format("%f", m_VolumeBounds[0]));
  parameter.Append("\n");
  parameter.Append("m_VolumeBounds[1] = ");
  parameter.Append(albaString::Format("%f", m_VolumeBounds[1]));
  parameter.Append("\n");
  parameter.Append("m_VolumeBounds[2] = ");
  parameter.Append(albaString::Format("%f", m_VolumeBounds[2]));
  parameter.Append("\n");
  parameter.Append("m_VolumeBounds[3] = ");
  parameter.Append(albaString::Format("%f", m_VolumeBounds[3]));
  parameter.Append("\n");
  parameter.Append("m_VolumeBounds[4] = ");
  parameter.Append(albaString::Format("%f", m_VolumeBounds[4]));
  parameter.Append("\n");
  parameter.Append("m_VolumeBounds[5] = ");
  parameter.Append("\n");
  parameter.Append(albaString::Format("%f", m_VolumeBounds[5]));
  parameter.Append("\n");
  parameter.Append("m_VolumeSpacing[0] = ");
  parameter.Append(albaString::Format("%f", m_VolumeSpacing[0]));
  parameter.Append("\n");
  parameter.Append("m_VolumeSpacing[1] = ");
  parameter.Append(albaString::Format("%f", m_VolumeSpacing[1]));
  parameter.Append("\n");
  parameter.Append("m_VolumeSpacing[2] = ");
  parameter.Append(albaString::Format("%f", m_VolumeSpacing[2]));
  parameter.Append("\n");
  parameter.Append("m_VolumePosition[0] = ");
  parameter.Append(albaString::Format("%f", m_VolumePosition[0]));
  parameter.Append("\n");
  parameter.Append("m_VolumePosition[1] = ");
  parameter.Append(albaString::Format("%f", m_VolumePosition[1]));
  parameter.Append("\n");
  parameter.Append("m_VolumePosition[2] = ");
  parameter.Append(albaString::Format("%f",m_VolumePosition[2]));
  parameter.Append("\n");
  parameter.Append("m_VolumeOrientation[0] = ");
  parameter.Append(albaString::Format("%f", m_VolumeOrientation[0]));
  parameter.Append("\n");
  parameter.Append("m_VolumeOrientation[1] = ");
  parameter.Append(albaString::Format("%f", m_VolumeOrientation[1]));
  parameter.Append("\n");
  parameter.Append("m_VolumeOrientation[2] = ");
  parameter.Append(albaString::Format("%f",m_VolumeOrientation[2]));

  parameter.Append("\n");
  parameter.Append("m_ZeroPadValue = ");
  parameter.Append(albaString::Format("%f", m_ZeroPadValue));
