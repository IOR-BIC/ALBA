...
#ifndef __mafOpExporterLandmark_H__
#define __mafOpExporterLandmark_H__
...
class MAF_EXPORT mafOpExporterLandmark: public mafOp
{
public:
	mafOpExporterLandmark(const wxString &label = "Landmark Exporter");
	~mafOpExporterLandmark(); 
	mafOp* Copy();
