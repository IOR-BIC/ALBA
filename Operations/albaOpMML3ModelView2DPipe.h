...
#ifndef __albaOpMML3ModelView2DPipe_H__
#define __albaOpMML3ModelView2DPipe_H__
...
//------------------------------------------------------------------------------
class albaOpMML3ModelView2DPipe
{
public:
  /// Constructor
  albaOpMML3ModelView2DPipe(vtkRenderer *ren, vtkPolyData *muscle, vtkDataSet* volume, int numberOfSlices) ;
