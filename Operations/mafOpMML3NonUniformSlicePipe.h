...
#ifndef __mafOpMML3NonUniformSlicePipe_H__
#define __mafOpMML3NonUniformSlicePipe_H__
...
//------------------------------------------------------------------------------
/// mafOpMML3NonUniformSlicePipe. \n
/// Helper class for mafOpMML3. \n
/// Visual pipe for selecting distribution of non uniform slices
//------------------------------------------------------------------------------
class mafOpMML3NonUniformSlicePipe
{
public:
  /// constructor
  mafOpMML3NonUniformSlicePipe(vtkPolyData *surface, vtkRenderer *renderer, int numberOfSections) ;

  ~mafOpMML3NonUniformSlicePipe() ; ///< destructor
