...
#ifndef __mafOpSmoothSurface_H__
#define __mafOpSmoothSurface_H__
...
//----------------------------------------------------------------------------
/** 
class name:  mafOpSmoothSurface.
Class which supplies the possibility to smooth a surface, giving a number of iteration of smooth, clear the result or
preview the output.
*/
class MAF_EXPORT mafOpSmoothSurface: public mafOp
{
public:
  /** object constructor */
	mafOpSmoothSurface(const wxString &label = "FilterSurface");
  /** object destructor */  
	~mafOpSmoothSurface();
  /** method for catch the dispatched events */
	virtual void OnEvent(mafEventBase *maf_event);
  /** RTTI macro */
	mafTypeMacro(mafOpSmoothSurface, mafOp);
