...
#ifndef __mafOpSegmentationRegionGrowingConnectedThreshold_H__
#define __mafOpSegmentationRegionGrowingConnectedThreshold_H__
...
//----------------------------------------------------------------------------
// mafOpSegmentationRegionGrowingConnectedThreshold :
//----------------------------------------------------------------------------
/** */
class MAF_EXPORT mafOpSegmentationRegionGrowingConnectedThreshold: public mafOp
{
public:
  mafOpSegmentationRegionGrowingConnectedThreshold(wxString label = "Connected Threshold");
  ~mafOpSegmentationRegionGrowingConnectedThreshold();
