/*=========================================================================
 ...
 Program: MAF2
 Module: mafOpMML3NonUniformSlicePipe
...
//------------------------------------------------------------------------------
// constructor
mafOpMML3NonUniformSlicePipe::mafOpMML3NonUniformSlicePipe(vtkPolyData *surface, vtkRenderer *renderer, int numberOfSections)
...
//------------------------------------------------------------------------------
// deconstructor
mafOpMML3NonUniformSlicePipe::~mafOpMML3NonUniformSlicePipe()
//------------------------------------------------------------------------------
{
  m_Math->Delete() ;
...
void mafOpMML3NonUniformSlicePipe::SetEndsOfAxis(double *x0, double *x1)
//------------------------------------------------------------------------------
{
  for (int i = 0 ;  i < 3 ;  i++){
    m_AxisStart[i] = x0[i] ;
...
void mafOpMML3NonUniformSlicePipe::CalculateAxisVector(double *u)
//------------------------------------------------------------------------------
{
...
double mafOpMML3NonUniformSlicePipe::CalculateAxisLength()
//------------------------------------------------------------------------------
{
  double u[3], length ;
...
void mafOpMML3NonUniformSlicePipe::CalculateAxisMidPoint(double *midPoint)
//------------------------------------------------------------------------------
{
...
void mafOpMML3NonUniformSlicePipe::CalculateAxisNormals(double *v,  double *w)
//------------------------------------------------------------------------------
{
...
void mafOpMML3NonUniformSlicePipe::SetSlicePositions(int numberOfSlices, double *alpha)
//------------------------------------------------------------------------------
{
  m_Alpha.clear() ;
...
void mafOpMML3NonUniformSlicePipe::UpdateTransform()
//------------------------------------------------------------------------------
{
...
void mafOpMML3NonUniformSlicePipe::UpdateSpheres()
//------------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------------
// update slice lines
void mafOpMML3NonUniformSlicePipe::UpdateSliceLines()
//------------------------------------------------------------------------------
{
...
void mafOpMML3NonUniformSlicePipe::Update()
//------------------------------------------------------------------------------
{
  UpdateTransform() ;
  UpdateSpheres() ;
