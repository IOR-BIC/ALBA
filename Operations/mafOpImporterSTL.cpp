/*=========================================================================
  ...
  Module:    $RCSfile: mafOpImporterSTL.cpp,v $
  Language:  C++
...
//----------------------------------------------------------------------------
mafCxxTypeMacro(mafOpImporterSTL);
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
void mafOpImporterSTL::ImportSTL()
//----------------------------------------------------------------------------
{
  if (!m_TestMode)
  {
...
//----------------------------------------------------------------------------
void mafOpImporterSTL::Swap_Four(unsigned int *value)
//----------------------------------------------------------------------------
{ 
	unsigned int r; 
	r =  *value;
...
//----------------------------------------------------------------------------
bool mafOpImporterSTL::IsFileBinary(const char *name_file)
...
//----------------------------------------------------------------------------
void mafOpImporterSTL::SetFileName(const char *file_name)
//----------------------------------------------------------------------------
{
  m_Files.resize(1);
  m_Files[0] = file_name;
