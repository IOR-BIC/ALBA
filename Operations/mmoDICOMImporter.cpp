...
/*virtual*/ bool mmoDICOMImporter::IsVolumeLarge(int nSlices)
//------------------------------------------------------------------------
{
...
bool mmoDICOMImporter::VolumeLargeCheck(int nSlices)
//------------------------------------------------------------------------
{ 
  //m_SliceTexture must exist and contain valid slice
...
bool mmoDICOMImporter::ImportLargeRAWFile(const char* lpszFileName, vtkDoubleArray* pSCoords)
//------------------------------------------------------------------------
{
...
vtkImageData* mmoDICOMImporter::GetImageData(vtkRectilinearGrid* pInput)
//------------------------------------------------------------------------
{
  if (m_BuildRLG != 0)
...
bool mmoDICOMImporter::DetectSpacing(vtkDoubleArray* pCoords, double* pOutSpacing)
//------------------------------------------------------------------------
{
