...
Module:    $RCSfile: vtkMEDLandmarkCloudPolydataFilter.cxx,v $
Language:  C++
...
vtkStandardNewMacro(vtkMEDLandmarkCloudPolydataFilter);
...
// Constructor 
//------------------------------------------------------------------------------
vtkMEDLandmarkCloudPolydataFilter::vtkMEDLandmarkCloudPolydataFilter()
...
// Execute method
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::Execute()
{
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::Clear()
{
...
//------------------------------------------------------------------------------
int vtkMEDLandmarkCloudPolydataFilter::AddLandmark(int ptId)
{
  double x[3] = {0,0,0} ;
  ...
  vtkMEDAddScalarsFilter* addScalars = vtkMEDAddScalarsFilter::New() ;
...
// Add single point from polydata
//------------------------------------------------------------------------------
int vtkMEDLandmarkCloudPolydataFilter::AddLandmark(int ptId, double col[3])
{
...
// Add single point from polydata
//------------------------------------------------------------------------------
int vtkMEDLandmarkCloudPolydataFilter::AddLandmark(int ptId, double r, double g, double b)
{
  int i = AddLandmark(ptId) ;
  SetColor(i,r,g,b); 
  return i ;
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::AddLandmarks(vtkIdList* ptIds)
{
...
// Add list of points from polydata
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::AddLandmarks(vtkIdList* ptIds, double col[3])
{
  for (int i = 0 ;  i < ptIds->GetNumberOfIds() ;  i++){
    int id = ptIds->GetId(i) ;
...
// Add list of points from polydata
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::AddLandmarks(vtkIdList* ptIds, double r, double g, double b)
{
  for (int i = 0 ;  i < ptIds->GetNumberOfIds() ;  i++){
    int id = ptIds->GetId(i) ;
    int j = AddLandmark(id) ;
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::DeleteLastLandmark()
{
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetThetaPhiResolution(int thetaRes, int phiRes)
{
  m_ThetaRes = thetaRes ;
  m_PhiRes = phiRes ;
...
// Set radius
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetRadius(double r)
{
  m_Radius = r ;
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::MultiplyRadius(double f)
{
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetRadiusAuto(vtkPolyData* polydata)
{
...
// Get radius
//------------------------------------------------------------------------------
double vtkMEDLandmarkCloudPolydataFilter::GetRadius() const
{
  return m_Radius ;
}
...
// Set color of all landmarks
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetColor(double r, double g, double b)
{
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetColor(int i, double r, double g, double b)
{    
...
// Set color of landmark i
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetColor(int i, double col[3])
{    
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetPosition(int i, double x[3])
{
...
// Set position of landmark i
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::SetPosition(int i, double x, double y, double z)
{
...
//------------------------------------------------------------------------------
void vtkMEDLandmarkCloudPolydataFilter::GetPosition(int i, double x[3]) const
{
...
// Get position of landmark i
//------------------------------------------------------------------------------
const double* vtkMEDLandmarkCloudPolydataFilter::GetPosition(int i) const
{
...
//------------------------------------------------------------------------------
bool vtkMEDLandmarkCloudPolydataFilter::GetBounds(double b[6]) const
{
  int n = GetNumberOfLandmarks() ;
  if (n == 0)
    return false ;
...
//------------------------------------------------------------------------------
bool vtkMEDLandmarkCloudPolydataFilter::GetCenter(double x[3]) const
{
  double b[6] ;
  bool ok = GetBounds(b) ;
  if (!ok)
...
//------------------------------------------------------------------------------
bool vtkMEDLandmarkCloudPolydataFilter::GetCentroid(double x[3]) const
{
  int n = GetNumberOfLandmarks() ;
  if (n == 0)
    return false ;
