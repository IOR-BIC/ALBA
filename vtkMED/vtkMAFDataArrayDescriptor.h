...
#ifndef __vtkMAFDataArrayDescriptor_h
#define __vtkMAFDataArrayDescriptor_h
...
private:
	vtkMAFDataArrayDescriptor(const vtkMAFDataArrayDescriptor&);  // Not implemented.
	void operator=(const vtkMAFDataArrayDescriptor&);  // Not implemented.
};
