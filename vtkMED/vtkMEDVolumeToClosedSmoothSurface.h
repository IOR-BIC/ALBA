...
/** vtkMEDVolumeToClosedSmoothSurface: This filter is an extension of vtkMAFContourVolumeMapper
...
*/
//---------------------------------------------------------------------------
class VTK_vtkMED_EXPORT vtkMEDVolumeToClosedSmoothSurface : public vtkMAFContourVolumeMapper
//---------------------------------------------------------------------------
{
public:
