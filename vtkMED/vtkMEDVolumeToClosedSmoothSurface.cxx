...
vtkCxxRevisionMacro(vtkMEDVolumeToClosedSmoothSurface, "$Revision: 1.1.2.6 $");
vtkStandardNewMacro(vtkMEDVolumeToClosedSmoothSurface);


//----------------------------------------------------------------------------
vtkMEDVolumeToClosedSmoothSurface::vtkMEDVolumeToClosedSmoothSurface()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void vtkMEDVolumeToClosedSmoothSurface::GetTransformFactor( int toUnity,double *bounds, double *scale, double *traslation )
//----------------------------------------------------------------------------
{
  double size[3];
...
//----------------------------------------------------------------------------
vtkPolyData * vtkMEDVolumeToClosedSmoothSurface::GetOutput( int level /*= 0*/, vtkPolyData *data /*= NULL*/ )
//----------------------------------------------------------------------------
{
...
//-------------------------------------------------------------------
void vtkMEDVolumeToClosedSmoothSurface::Update()
//------------------------------------------------------------------------------
{
