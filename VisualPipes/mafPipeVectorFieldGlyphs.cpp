/*========================================================================= 
  ...
  Module: $RCSfile: mafPipeVectorFieldGlyphs.cpp,v $ 
  Language: C++ 
...
//----------------------------------------------------------------------------
mafCxxTypeMacro(mafPipeVectorFieldGlyphs);
//----------------------------------------------------------------------------
const  char* mafPipeVectorFieldGlyphs::FILTER_LINK_NAME = "filter-link-vector";
const  char* mafPipeVectorFieldGlyphs::FILTER_LINK_NAME2 = "filter-link-scale";
int mafPipeVectorFieldGlyphs::count;
//----------------------------------------------------------------------------
mafPipeVectorFieldGlyphs::mafPipeVectorFieldGlyphs() : mafPipeVectorField()
//----------------------------------------------------------------------------
{
  //default constructor
  ...
  m_AndOr = 0;
  mafPipeVectorFieldGlyphs::count = 0;
}

//----------------------------------------------------------------------------
mafPipeVectorFieldGlyphs::~mafPipeVectorFieldGlyphs()
//----------------------------------------------------------------------------
{ 
  // default destructor
...
//----------------------------------------------------------------------------
/*virtual*/ void mafPipeVectorFieldGlyphs::ComputeDefaultParameters()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
mafGUI *mafPipeVectorFieldGlyphs::CreateGui()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::InitFilterList(int nScalars)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::StoreFilterLinks()
//-----------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::StoreFilterLinks2()
//-----------------------------------------------------------------------
{
  //Store Filter values into link 
	mafVME::mafLinksMap* pLinks = m_Vme->GetLinks(); 
...
//-----------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::OnShowFilter(int mode)
//-----------------------------------------------------------------------
{
...
//-----------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::OnAddItem(int idx)
//-----------------------------------------------------------------------
{
  //Add a range item
...
//-----------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::OnRemoveItem()
//--------------------------------------------------------------------
{
  //Remove a range item
...
//--------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::OnRemoveItem2()
//--------------------------------------------------------------------
{
  //Remove a range item
...
//----------------------------------------------
bool mafPipeVectorFieldGlyphs::AddItem2()
//----------------------------------------------
{
  //insert item 
	double dValue1,dValue2;
...
bool mafPipeVectorFieldGlyphs::AddItem()
{	
	double dValue1,dValue2;
	bool rtn = false;
	m_FilterValue1.ToDouble(&dValue1);
...
//-----------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::CreateAddItemDlg(int idx)
//-----------------------------------------------------------------------
{
  //create dialog
...
//------------------------------------------------------------------------
/*virtual*/ void mafPipeVectorFieldGlyphs::OnChangeMaterial()
//------------------------------------------------------------------------
{
...
bool mafPipeVectorFieldGlyphs::DoCondition(int mode,double vectorValue,double scaleValue,double *rangeValue1,double *rangeValue2)
{
	bool rtn = false;
	bool vectorFlag;
	bool scaleFlag;
...
//--------------------------------------------------------------------------
void mafPipeVectorFieldGlyphs::DoFilter(int mode ,double *rangeValue,double *rangeValue2)
//--------------------------------------------------------------------------
{	
  //filter begin
...
vtkImageData* mafPipeVectorFieldGlyphs::GetImageData(vtkRectilinearGrid* pInput)
//------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------
bool mafPipeVectorFieldGlyphs::DetectSpacing(vtkFloatArray* pCoords, double* pOutSpacing)
//------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------
/*virtual*/ void mafPipeVectorFieldGlyphs::CreateVTKPipe()
//------------------------------------------------------------------------
{
...
//------------------------------------------------------------------------
/*virtual*/ void mafPipeVectorFieldGlyphs::UpdateVTKPipe()
//------------------------------------------------------------------------
{
  //Updates VTK pipeline
  //(setting radius and other parmeters). 
  mafPipeVectorFieldGlyphs::count ++; 
...
//  int nPoints = allPoints->GetScalars()->GetSize();
  ...
  if (da!=NULL)
  {
	  if (mafPipeVectorFieldGlyphs::count==1)
	  {
