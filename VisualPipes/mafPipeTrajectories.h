...
#ifndef __mafPipeTrajectories_H__
#define __mafPipeTrajectories_H__
...
// mafPipeTrajectories :
//----------------------------------------------------------------------------
class MAF_EXPORT mafPipeTrajectories : public mafPipe
{
public:
  mafTypeMacro(mafPipeTrajectories,mafPipe);

  mafPipeTrajectories();
  virtual     ~mafPipeTrajectories ();
