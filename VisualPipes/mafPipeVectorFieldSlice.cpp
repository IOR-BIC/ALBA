/*========================================================================= 
  ...
  Module: $RCSfile: mafPipeVectorFieldSlice.cpp,v $ 
  Language: C++ 
...
//----------------------------------------------------------------------------
mafCxxTypeMacro(mafPipeVectorFieldSlice);
//----------------------------------------------------------------------------

//----------------------------------------------------------------------------
mafPipeVectorFieldSlice::mafPipeVectorFieldSlice() : mafPipeVectorFieldSurface()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
mafPipeVectorFieldSlice::~mafPipeVectorFieldSlice()
//----------------------------------------------------------------------------
{  
  vtkDEL(m_CutPlane);
...
//----------------------------------------------------------------------------
mafGUI *mafPipeVectorFieldSlice::CreateGui()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void mafPipeVectorFieldSlice::OnEvent(mafEventBase *maf_event)
//----------------------------------------------------------------------------
{			
...
/*virtual*/ void mafPipeVectorFieldSlice::UpdateSlicePosRange()
//------------------------------------------------------------------------
{
  double bounds[6]; 
...
/*virtual*/ void mafPipeVectorFieldSlice::CreateVTKPipe()
//------------------------------------------------------------------------
{  
...
/*virtual*/ void mafPipeVectorFieldSlice::UpdateVTKPipe()
//------------------------------------------------------------------------
{
  //update cutter  
  double bounds[6];
