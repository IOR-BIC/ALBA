...
#ifndef mafPipeVectorFieldMapWithArrows_h__
#define mafPipeVectorFieldMapWithArrows_h__
...
*/
class MAF_EXPORT mafPipeVectorFieldMapWithArrows : public mafPipeVectorField
{
public:
  mafTypeMacro(mafPipeVectorFieldMapWithArrows, mafPipeVectorField);
...
public:	
  mafPipeVectorFieldMapWithArrows();
  virtual ~mafPipeVectorFieldMapWithArrows();
