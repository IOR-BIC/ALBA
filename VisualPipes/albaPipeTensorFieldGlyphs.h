/*========================================================================= 
  ...
  Module: $RCSfile: albaPipeTensorFieldGlyphs.h,v $ 
  Language: C++ 
  ...
  =========================================================================
*/
#ifndef albaPipeTensorFieldGlyphs_h__
#define albaPipeTensorFieldGlyphs_h__
...
/** 
class name: albaPipeTensorFieldGlyphs
Class for Volumes with compound pipes which show tensor field using glyphs.
 */
class ALBA_EXPORT albaPipeTensorFieldGlyphs : public albaPipeTensorField
{
public:
  /** RTTI macro*/
  albaTypeMacro(albaPipeTensorFieldGlyphs, albaPipeTensorField);
...
public:
  /** constrouctor */
  albaPipeTensorFieldGlyphs();
  /** destructor */
  virtual ~albaPipeTensorFieldGlyphs();
...
#endif // albaPipeTensorFieldGlyphs_h__