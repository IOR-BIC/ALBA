...
#ifndef __mafPipeVolumeDRR_H__
#define __mafPipeVolumeDRR_H__
...
/**
className: mafPipeVolumeDRR
Pipe which uses BES vtkXRayVolumeMapper.
*/
class MAF_EXPORT mafPipeVolumeDRR : public mafPipe
{
public:
  /** RTTI macro*/
  mafTypeMacro(mafPipeVolumeDRR,mafPipe);
  /** constructor*/
           mafPipeVolumeDRR();
  /** destructor */
  virtual ~mafPipeVolumeDRR();
