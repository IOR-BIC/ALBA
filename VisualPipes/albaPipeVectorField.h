/*========================================================================= 
  ...
  Module: $RCSfile: albaPipeVectorField.h,v $ 
  Language: C++ 
  ...
  =========================================================================
*/
#ifndef albaPipeVectorField_h__
#define albaPipeVectorField_h__
...
class ALBA_EXPORT albaPipeVectorField : public albaPipe
{
public:
  albaAbstractTypeMacro(albaPipeVectorField, albaPipe);
