...
//----------------------------------------------------------------------------
albaCxxTypeMacro(albaPipeGraph);
//----------------------------------------------------------------------------

//----------------------------------------------------------------------------
albaPipeGraph::albaPipeGraph()
:albaPipe()
//----------------------------------------------------------------------------
{
  m_PlotActor	= NULL;
...
//----------------------------------------------------------------------------
void albaPipeGraph::Create(albaSceneNode *n)
//----------------------------------------------------------------------------
{
  double timeData;
  int counter = 0;
  ...
  m_LegendBoxTimeLine_Actor = m_PlotTimeLineActor->GetLegendActor();
  ...
  m_LegendBox_Actor = m_PlotActor->GetLegendActor();
  ...
  albaTagItem *tag_Signals = m_Vme->GetTagArray()->GetTag("SIGNALS_COLOR");
  ...
  albaTagItem *tagAxisTile = m_Vme->GetTagArray()->GetTag("AXIS_TITLE");
...
//----------------------------------------------------------------------------
void albaPipeGraph::UpdateGraph()
//----------------------------------------------------------------------------
{
  double scalarData = 0;
  int counter_array = 0;
...
//----------------------------------------------------------------------------
void albaPipeGraph::ChangeItemName()
//----------------------------------------------------------------------------
{
  m_CheckBox->SetItemLabel(m_ItemId, (wxString)m_ItemName);
  albaTagItem *t = m_Vme->GetTagArray()->GetTag("SIGNALS_NAME");
  t->SetValue(m_ItemName, m_ItemId);
  m_CheckBox->Update();
}

//----------------------------------------------------------------------------
void albaPipeGraph::ChangeAxisTitle()
//----------------------------------------------------------------------------
{
  albaTagItem *t = m_Vme->GetTagArray()->GetTag("AXIS_TITLE");
  t->SetValue(m_TitileX, 0);
  t->SetValue(m_TitileY, 1);
}

//----------------------------------------------------------------------------
void albaPipeGraph::ChangeSignalColor()
//----------------------------------------------------------------------------
{
  m_PlotActor->SetPlotColor(m_ItemId, m_ColorRGB);
  albaTagItem *t = m_Vme->GetTagArray()->GetTag("SIGNALS_COLOR");
...
//----------------------------------------------------------------------------
albaGUI* albaPipeGraph::CreateGui()
//----------------------------------------------------------------------------
{
  if(m_Gui == NULL) 
  ...
  albaTagItem *tag_Signals = m_Vme->GetTagArray()->GetTag("SIGNALS_NAME");
    ...
    case ID_RANGE_Y:
      {
        ...
        {
          albaErrorMessage("Invalid plot range!");
          return;
        }
        m_PlotActor->RemoveAllDataSetInputConnections();
        UpdateGraph();
...
//----------------------------------------------------------------------------
void albaPipeGraph::SetSignalToPlot(int index,bool plot)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaPipeGraph::SetTitleX(albaString title)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaPipeGraph::SetTitleY(albaString title)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void albaPipeGraph::SetTitle(albaString title)
//----------------------------------------------------------------------------
{
