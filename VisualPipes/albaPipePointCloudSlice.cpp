...
//----------------------------------------------------------------------------
albaCxxTypeMacro(albaPipePointCloudSlice);
...
//----------------------------------------------------------------------------
vtkAlgorithmOutput* albaPipePointCloudSlice::GetPolyDataOutputPort()
{
...
//----------------------------------------------------------------------------
/*virtual*/ void albaPipePointCloudSlice::SetSlice(double *Origin, double *Normal)
{
  if (Origin != NULL)
  {
    m_Origin[0] = Origin[0];
