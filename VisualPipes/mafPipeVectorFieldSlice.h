/*========================================================================= 
  ...
  Module: $RCSfile: mafPipeVectorFieldSlice.h,v $ 
  Language: C++ 
  ...
  =========================================================================
*/
#ifndef mafPipeVectorFieldSlice_h__
#define mafPipeVectorFieldSlice_h__
...
class MAF_EXPORT mafPipeVectorFieldSlice : public mafPipeVectorFieldSurface
{
public:
  mafTypeMacro(mafPipeVectorFieldSlice, mafPipeVectorFieldSurface);
...
public:	
  mafPipeVectorFieldSlice();
  virtual ~mafPipeVectorFieldSlice();
...
#endif // mafPipeVectorFieldSlice_h__