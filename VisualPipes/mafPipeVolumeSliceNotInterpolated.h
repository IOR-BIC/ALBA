...
#ifndef __mafPipeVolumeSliceNotInterpolated_H__
#define __mafPipeVolumeSliceNotInterpolated_H__
...
//----------------------------------------------------------------------------
class MAF_EXPORT mafPipeVolumeSliceNotInterpolated : public mafPipeSlice
//----------------------------------------------------------------------------
{
public:
  ...
  /** RTTI Macro */
  mafTypeMacro(mafPipeVolumeSliceNotInterpolated,mafPipeSlice);

  /** ctor */
  mafPipeVolumeSliceNotInterpolated();
...
#endif //#ifndef __mafPipeVolumeSliceNotInterpolated_H__