/*========================================================================= 
  ...
  Module: $RCSfile: albaPipeTensorField.h,v $ 
  Language: C++ 
  ...
  =========================================================================
*/
#ifndef albaPipeTensorField_h__
#define albaPipeTensorField_h__
...
/** 
class name:  albaPipeTensorField
General class for tensor fields, contains useful stuff 
 */
class ALBA_EXPORT albaPipeTensorField : public albaPipe
{
public:
  /** RTTI macro*/
  albaAbstractTypeMacro(albaPipeTensorField, albaPipe);
